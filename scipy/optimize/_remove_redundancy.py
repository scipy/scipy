...
# There seems to be a bug in deterministic ID
# TODO: change default for randomized to False when bug is fixed
def _remove_redundancy_id(A, rhs, rank=None, randomized=True):
    ...
    if rank is None:
        ...
        # can algorithm for ID recognize when it's up to full rank?
