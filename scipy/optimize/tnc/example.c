...
int main(int argc, char **argv) {
    ...
    double fopt = 1.0, f, g[2], x[2] = {-7.0, 3.0}, xopt[2] = {0.0, 1.0}, low[2], up[2], eta = -1.0, stepmx = -1.0,
           accuracy = -1.0, fmin = 0.0, ftol = -1.0, xtol = -1.0, pgtol = -1.0, rescale = -1.0;
    ...
    rc =
        tnc(2, x, &f, g, function, NULL, low, up, NULL, NULL, TNC_MSG_ALL, maxCGit, maxnfeval, eta, stepmx, accuracy,
            fmin, ftol, xtol, pgtol, rescale, &nfeval, NULL);

    printf("After %d function evaluations, TNC returned:\n%s\n", nfeval, tnc_rc_string[rc - TNC_MINRC]);
