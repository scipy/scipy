...
def _linprog_highs_doc(c, A_ub=None, b_ub=None, A_eq=None, b_eq=None,
    ...
    simplex_update_limit : int (default: ``5000``)
        ...
        is reached. See [14]_  Secture 2.4 for more information about
...
def _linprog_rs_doc(c, A_ub=None, b_ub=None, A_eq=None, b_eq=None,
                    bounds=None, method='interior-point', callback=None,
                    x0=None, maxiter=5000, tol=1e-12, disp=False,
                    maxupdate=10, mast=False, pivot="mrc", **unknown_options):
    r"""
    Linear programming: minimize a linear objective function subject to linear
    equality and inequality constraints using the revised simplex method of
    [4]_.
    ...
    res : OptimizeResult
        ...
        status : int
            ...
            ``6`` : The guess does not appear to represent a basic
                    feasible solution
