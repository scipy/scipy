...
class TestProjectCG(TestCase):
    ...
    # by maximum iterations (infeasible iteration).
    ...
    # because it hits boundary (without infeasible iteration).
    ...
    # The box constraints are active and the termination is
    # because it hits boundary (infeasible iteration).
    ...
    # The box constraints are active and the termination is
    # because it hits boundary (no infeasible iteration).
