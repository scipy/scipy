...
def test_performance():
    ...
    table_1 = [
        ...
        dict(
            F=F_6, x0=x0_6, n=100, nit=6, nfev=6
        ),  # Results from dfsane.f; papers list nit=3, nfev=3
        dict(
            F=F_7, x0=x0_7, n=99, nit=23, nfev=29
        ),  # Must have n%3==0, typo in papers?
        dict(
            F=F_7, x0=x0_7, n=999, nit=23, nfev=29
        ),  # Must have n%3==0, typo in papers?
        dict(
            F=F_9, x0=x0_9, n=100, nit=12, nfev=18
        ),  # Results from dfsane.f; papers list nit=nfev=6?
        dict(F=F_9, x0=x0_9, n=1000, nit=12, nfev=18),
        dict(
            F=F_10, x0=x0_10, n=1000, nit=5, nfev=5
    ...
    for xscale, yscale, line_search in itertools.product(
        ...
        for problem in table_1:
            ...
            assert_(
                sol.nfev <= problem["nfev"] + 1, err_msg
