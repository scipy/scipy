...
class TestIsotonicRegression:
    ...
    def test_empty_input(self, weights, increasing, monkeypatch):
        def fail_pava(*args):
            pytest.fail("pava must not be called for empty inputs")

        monkeypatch.setattr("scipy.optimize._isotonic.pava", fail_pava)
