/* Generated by Cython 0.13 on Sun Oct  2 00:15:27 2011 */
...
#endif
#include <math.h>
#define __PYX_HAVE_API__scipy__optimize___qrsolv
#include "alloca.h"
#include "string.h"
#include "math.h"
#include "stdio.h"
...
/* Module declarations from scipy.optimize._qrsolv */

static void __pyx_f_5scipy_8optimize_7_qrsolv_qrsolv_float(PyArrayObject *, PyArrayObject *); /*proto*/
static void __pyx_f_5scipy_8optimize_7_qrsolv_qrsolv_double(PyArrayObject *, PyArrayObject *); /*proto*/
...
#define __Pyx_MODULE_NAME "scipy.optimize._qrsolv"
int __pyx_module_is_main_scipy__optimize___qrsolv = 0;

/* Implementation of scipy.optimize._qrsolv */
static PyObject *__pyx_builtin_NotImplementedError;
static PyObject *__pyx_builtin_ValueError;
static PyObject *__pyx_builtin_range;
static PyObject *__pyx_builtin_RuntimeError;
static char __pyx_k_1[] = "qrsolv is only implemented for float23 and float64";
...
static char __pyx_k_9[] = "qrsolv (line 95)";
...
static char __pyx_k__qrsolv[] = "qrsolv";
...
static PyObject *__pyx_n_s__qrsolv;
...
/* "/home/martin/scipy/scipy/optimize/_qrsolv.pyx":21
...
static  void __pyx_f_5scipy_8optimize_7_qrsolv_qrsolv_float(PyArrayObject *__pyx_v_s, PyArrayObject *__pyx_v_diag) {
  ...
  float __pyx_v_tmp;
  float *__pyx_v_ta;
  Py_buffer __pyx_bstruct_diag;
  Py_ssize_t __pyx_bstride_0_diag = 0;
  Py_ssize_t __pyx_bshape_0_diag = 0;
  ...
  __pyx_bstruct_diag.buf = NULL;
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_bstruct_s, (PyObject*)__pyx_v_s, &__Pyx_TypeInfo_float, PyBUF_FORMAT| PyBUF_STRIDES| PyBUF_WRITABLE, 2, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 21; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_bstruct_diag, (PyObject*)__pyx_v_diag, &__Pyx_TypeInfo_float, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 21; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  __pyx_bstride_0_diag = __pyx_bstruct_diag.strides[0];
  __pyx_bshape_0_diag = __pyx_bstruct_diag.shape[0];

  /* "/home/martin/scipy/scipy/optimize/_qrsolv.pyx":35
 *     cdef float *ta
 * 
 *     N = diag.shape[0]             # <<<<<<<<<<<<<<
 ...
 * 
 */
  __pyx_v_N = (__pyx_v_diag->dimensions[0]);

  /* "/home/martin/scipy/scipy/optimize/_qrsolv.pyx":36
 * 
 *     N = diag.shape[0]
 *     ta = <float *> alloca((N + 1) * sizeof(float))             # <<<<<<<<<<<<<<
 * 
 *     for 0 <= j < N:
 */
  __pyx_v_ta = ((float *)alloca(((__pyx_v_N + 1) * (sizeof(float)))));

  /* "/home/martin/scipy/scipy/optimize/_qrsolv.pyx":38
 *     ta = <float *> alloca((N + 1) * sizeof(float))
 * 
 *     for 0 <= j < N:             # <<<<<<<<<<<<<<
 *         if diag[j] != 0:
 ...
 */
  ...
  for (__pyx_v_j = 0; __pyx_v_j < __pyx_t_1; __pyx_v_j++) {
    ...
    /* "/home/martin/scipy/scipy/optimize/_qrsolv.pyx":39
 * 
 *     for 0 <= j < N:
 *         if diag[j] != 0:             # <<<<<<<<<<<<<<
 *             memset(ta, 0, (N + 1) * sizeof(float))
 ...
 */
    __pyx_t_2 = __pyx_v_j;
    __pyx_t_3 = ((*__Pyx_BufPtrStrided1d(float *, __pyx_bstruct_diag.buf, __pyx_t_2, __pyx_bstride_0_diag)) != 0.0);
    if (__pyx_t_3) {

      /* "/home/martin/scipy/scipy/optimize/_qrsolv.pyx":40
 *     for 0 <= j < N:
 *         if diag[j] != 0:
 *             memset(ta, 0, (N + 1) * sizeof(float))             # <<<<<<<<<<<<<<
 *             ta[j] = diag[j]
 *             for j <= k < N:
 */
      memset(__pyx_v_ta, 0, ((__pyx_v_N + 1) * (sizeof(float))));

      /* "/home/martin/scipy/scipy/optimize/_qrsolv.pyx":41
 *         if diag[j] != 0:
 *             memset(ta, 0, (N + 1) * sizeof(float))
 *             ta[j] = diag[j]             # <<<<<<<<<<<<<<
 *             for j <= k < N:
 ...
 */
      __pyx_t_4 = __pyx_v_j;
      (__pyx_v_ta[__pyx_v_j]) = (*__Pyx_BufPtrStrided1d(float *, __pyx_bstruct_diag.buf, __pyx_t_4, __pyx_bstride_0_diag));

      /* "/home/martin/scipy/scipy/optimize/_qrsolv.pyx":42
 *             memset(ta, 0, (N + 1) * sizeof(float))
 *             ta[j] = diag[j]
 *             for j <= k < N:             # <<<<<<<<<<<<<<
 *                 if ta[k] != 0:
 ...
 */
      ...
      for (__pyx_v_k = __pyx_v_j; __pyx_v_k < __pyx_t_5; __pyx_v_k++) {
        ...
        /* "/home/martin/scipy/scipy/optimize/_qrsolv.pyx":43
 *             ta[j] = diag[j]
 *             for j <= k < N:
 *                 if ta[k] != 0:             # <<<<<<<<<<<<<<
 *                     if fabs(s[k, k]) > fabs(ta[k]):
 *                         tan = ta[k] / s[k, k]
 */
        __pyx_t_3 = ((__pyx_v_ta[__pyx_v_k]) != 0.0);
        if (__pyx_t_3) {

          /* "/home/martin/scipy/scipy/optimize/_qrsolv.pyx":44
 *             for j <= k < N:
 *                 if ta[k] != 0:
 *                     if fabs(s[k, k]) > fabs(ta[k]):             # <<<<<<<<<<<<<<
 *                         tan = ta[k] / s[k, k]
 ...
 */
          __pyx_t_6 = __pyx_v_k;
          __pyx_t_7 = __pyx_v_k;
          __pyx_t_3 = (fabs((*__Pyx_BufPtrStrided2d(float *, __pyx_bstruct_s.buf, __pyx_t_6, __pyx_bstride_0_s, __pyx_t_7, __pyx_bstride_1_s))) > fabs((__pyx_v_ta[__pyx_v_k])));
          if (__pyx_t_3) {

            /* "/home/martin/scipy/scipy/optimize/_qrsolv.pyx":45
 *                 if ta[k] != 0:
 *                     if fabs(s[k, k]) > fabs(ta[k]):
 *                         tan = ta[k] / s[k, k]             # <<<<<<<<<<<<<<
 *                         cos = 1 / sqrt(1 + tan * tan)
 ...
 */
            __pyx_t_8 = __pyx_v_k;
            __pyx_t_9 = __pyx_v_k;
            __pyx_v_tan = ((__pyx_v_ta[__pyx_v_k]) / (*__Pyx_BufPtrStrided2d(float *, __pyx_bstruct_s.buf, __pyx_t_8, __pyx_bstride_0_s, __pyx_t_9, __pyx_bstride_1_s)));

            /* "/home/martin/scipy/scipy/optimize/_qrsolv.pyx":46
 *                     if fabs(s[k, k]) > fabs(ta[k]):
 *                         tan = ta[k] / s[k, k]
 *                         cos = 1 / sqrt(1 + tan * tan)             # <<<<<<<<<<<<<<
 *                         sin = cos * tan
 *                     else:
 */
            __pyx_v_cos = (1.0 / sqrt((1.0 + (__pyx_v_tan * __pyx_v_tan))));

            /* "/home/martin/scipy/scipy/optimize/_qrsolv.pyx":47
 *                         tan = ta[k] / s[k, k]
 *                         cos = 1 / sqrt(1 + tan * tan)
 *                         sin = cos * tan             # <<<<<<<<<<<<<<
 *                     else:
 *                         cotan = s[k, k] / ta[k]
 */
            __pyx_v_sin = (__pyx_v_cos * __pyx_v_tan);
            goto __pyx_L9;
          }
          /*else*/ {

            /* "/home/martin/scipy/scipy/optimize/_qrsolv.pyx":49
 *                         sin = cos * tan
 *                     else:
 *                         cotan = s[k, k] / ta[k]             # <<<<<<<<<<<<<<
 ...
 */
            ...
            __pyx_v_cotan = ((*__Pyx_BufPtrStrided2d(float *, __pyx_bstruct_s.buf, __pyx_t_10, __pyx_bstride_0_s, __pyx_t_11, __pyx_bstride_1_s)) / (__pyx_v_ta[__pyx_v_k]));

            /* "/home/martin/scipy/scipy/optimize/_qrsolv.pyx":50
 *                     else:
 *                         cotan = s[k, k] / ta[k]
 *                         sin = 1 / sqrt(1 + cotan * cotan)             # <<<<<<<<<<<<<<
 *                         cos = sin * cotan
 *                     for k <= l <= N:
 */
            __pyx_v_sin = (1.0 / sqrt((1.0 + (__pyx_v_cotan * __pyx_v_cotan))));

            /* "/home/martin/scipy/scipy/optimize/_qrsolv.pyx":51
 *                         cotan = s[k, k] / ta[k]
 *                         sin = 1 / sqrt(1 + cotan * cotan)
 *                         cos = sin * cotan             # <<<<<<<<<<<<<<
 *                     for k <= l <= N:
 *                         tmp = s[k, l]
 */
            __pyx_v_cos = (__pyx_v_sin * __pyx_v_cotan);
          }
          __pyx_L9:;

          /* "/home/martin/scipy/scipy/optimize/_qrsolv.pyx":52
 *                         sin = 1 / sqrt(1 + cotan * cotan)
 *                         cos = sin * cotan
 *                     for k <= l <= N:             # <<<<<<<<<<<<<<
 *                         tmp = s[k, l]
 ...
 */
          ...
          for (__pyx_v_l = __pyx_v_k; __pyx_v_l <= __pyx_t_12; __pyx_v_l++) {

            /* "/home/martin/scipy/scipy/optimize/_qrsolv.pyx":53
 *                         cos = sin * cotan
 *                     for k <= l <= N:
 *                         tmp = s[k, l]             # <<<<<<<<<<<<<<
 *                         s[k, l] = cos * tmp + sin * ta[l]
 ...
 */
            ...
            __pyx_v_tmp = (*__Pyx_BufPtrStrided2d(float *, __pyx_bstruct_s.buf, __pyx_t_13, __pyx_bstride_0_s, __pyx_t_14, __pyx_bstride_1_s));

            /* "/home/martin/scipy/scipy/optimize/_qrsolv.pyx":54
 *                     for k <= l <= N:
 *                         tmp = s[k, l]
 *                         s[k, l] = cos * tmp + sin * ta[l]             # <<<<<<<<<<<<<<
 *                         ta[l] = -sin * tmp + cos * ta[l]
 ...
 */
            ...
            *__Pyx_BufPtrStrided2d(float *, __pyx_bstruct_s.buf, __pyx_t_15, __pyx_bstride_0_s, __pyx_t_16, __pyx_bstride_1_s) = ((__pyx_v_cos * __pyx_v_tmp) + (__pyx_v_sin * (__pyx_v_ta[__pyx_v_l])));

            /* "/home/martin/scipy/scipy/optimize/_qrsolv.pyx":55
 *                         tmp = s[k, l]
 *                         s[k, l] = cos * tmp + sin * ta[l]
 *                         ta[l] = -sin * tmp + cos * ta[l]             # <<<<<<<<<<<<<<
 * 
 * @cython.boundscheck(False)
 */
            (__pyx_v_ta[__pyx_v_l]) = (((-__pyx_v_sin) * __pyx_v_tmp) + (__pyx_v_cos * (__pyx_v_ta[__pyx_v_l])));
          }
          goto __pyx_L8;
        }
        __pyx_L8:;
  ...
  { PyObject *__pyx_type, *__pyx_value, *__pyx_tb;
    ...
    __Pyx_SafeReleaseBuffer(&__pyx_bstruct_diag);
    __Pyx_SafeReleaseBuffer(&__pyx_bstruct_s);
  __Pyx_ErrRestore(__pyx_type, __pyx_value, __pyx_tb);}
  __Pyx_WriteUnraisable("scipy.optimize._qrsolv.qrsolv_float");
  goto __pyx_L2;
  __pyx_L0:;
  __Pyx_SafeReleaseBuffer(&__pyx_bstruct_diag);
  __Pyx_SafeReleaseBuffer(&__pyx_bstruct_s);
...
/* "/home/martin/scipy/scipy/optimize/_qrsolv.pyx":59
 * @cython.boundscheck(False)
 * @cython.cdivision(True)
...
static  void __pyx_f_5scipy_8optimize_7_qrsolv_qrsolv_double(PyArrayObject *__pyx_v_s, PyArrayObject *__pyx_v_diag) {
  unsigned int __pyx_v_N;
  unsigned int __pyx_v_j;
  unsigned int __pyx_v_k;
  unsigned int __pyx_v_l;
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_bstruct_s, (PyObject*)__pyx_v_s, &__Pyx_TypeInfo_double, PyBUF_FORMAT| PyBUF_STRIDES| PyBUF_WRITABLE, 2, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 59; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  __pyx_bstride_0_s = __pyx_bstruct_s.strides[0]; __pyx_bstride_1_s = __pyx_bstruct_s.strides[1];
  __pyx_bshape_0_s = __pyx_bstruct_s.shape[0]; __pyx_bshape_1_s = __pyx_bstruct_s.shape[1];
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_bstruct_diag, (PyObject*)__pyx_v_diag, &__Pyx_TypeInfo_double, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 59; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  __pyx_bstride_0_diag = __pyx_bstruct_diag.strides[0];
  __pyx_bshape_0_diag = __pyx_bstruct_diag.shape[0];

  /* "/home/martin/scipy/scipy/optimize/_qrsolv.pyx":73
 *     cdef double *ta
 * 
 *     N = diag.shape[0]             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "/home/martin/scipy/scipy/optimize/_qrsolv.pyx":74
 * 
 *     N = diag.shape[0]
 *     ta = <double *> alloca((N + 1) * sizeof(double))             # <<<<<<<<<<<<<<
 * 
 *     for 0 <= j < N:
 */
  __pyx_v_ta = ((double *)alloca(((__pyx_v_N + 1) * (sizeof(double)))));

  /* "/home/martin/scipy/scipy/optimize/_qrsolv.pyx":76
 *     ta = <double *> alloca((N + 1) * sizeof(double))
 * 
 *     for 0 <= j < N:             # <<<<<<<<<<<<<<
 *         if diag[j] != 0:
 ...
 */
  ...
  for (__pyx_v_j = 0; __pyx_v_j < __pyx_t_1; __pyx_v_j++) {
    ...
    /* "/home/martin/scipy/scipy/optimize/_qrsolv.pyx":77
 * 
 *     for 0 <= j < N:
 *         if diag[j] != 0:             # <<<<<<<<<<<<<<
 *             memset(ta, 0, (N + 1) * sizeof(double))
 ...
 */
    __pyx_t_2 = __pyx_v_j;
    __pyx_t_3 = ((*__Pyx_BufPtrStrided1d(double *, __pyx_bstruct_diag.buf, __pyx_t_2, __pyx_bstride_0_diag)) != 0.0);
    if (__pyx_t_3) {

      /* "/home/martin/scipy/scipy/optimize/_qrsolv.pyx":78
 *     for 0 <= j < N:
 *         if diag[j] != 0:
 *             memset(ta, 0, (N + 1) * sizeof(double))             # <<<<<<<<<<<<<<
 *             ta[j] = diag[j]
 *             for j <= k < N:
 */
      memset(__pyx_v_ta, 0, ((__pyx_v_N + 1) * (sizeof(double))));

      /* "/home/martin/scipy/scipy/optimize/_qrsolv.pyx":79
 *         if diag[j] != 0:
 *             memset(ta, 0, (N + 1) * sizeof(double))
 *             ta[j] = diag[j]             # <<<<<<<<<<<<<<
 *             for j <= k < N:
 ...
 */
      __pyx_t_4 = __pyx_v_j;
      (__pyx_v_ta[__pyx_v_j]) = (*__Pyx_BufPtrStrided1d(double *, __pyx_bstruct_diag.buf, __pyx_t_4, __pyx_bstride_0_diag));

      /* "/home/martin/scipy/scipy/optimize/_qrsolv.pyx":80
 *             memset(ta, 0, (N + 1) * sizeof(double))
 *             ta[j] = diag[j]
 *             for j <= k < N:             # <<<<<<<<<<<<<<
 *                 if ta[k] != 0:
 ...
 */
      ...
      for (__pyx_v_k = __pyx_v_j; __pyx_v_k < __pyx_t_5; __pyx_v_k++) {
        ...
        /* "/home/martin/scipy/scipy/optimize/_qrsolv.pyx":81
 *             ta[j] = diag[j]
 *             for j <= k < N:
 *                 if ta[k] != 0:             # <<<<<<<<<<<<<<
 *                     if fabs(s[k, k]) > fabs(ta[k]):
 ...
 */
        ...
        if (__pyx_t_3) {
          ...
          /* "/home/martin/scipy/scipy/optimize/_qrsolv.pyx":82
 *             for j <= k < N:
 *                 if ta[k] != 0:
 *                     if fabs(s[k, k]) > fabs(ta[k]):             # <<<<<<<<<<<<<<
 *                         tan = ta[k] / s[k, k]
 ...
 */
          __pyx_t_6 = __pyx_v_k;
          __pyx_t_7 = __pyx_v_k;
          __pyx_t_3 = (fabs((*__Pyx_BufPtrStrided2d(double *, __pyx_bstruct_s.buf, __pyx_t_6, __pyx_bstride_0_s, __pyx_t_7, __pyx_bstride_1_s))) > fabs((__pyx_v_ta[__pyx_v_k])));
          if (__pyx_t_3) {

            /* "/home/martin/scipy/scipy/optimize/_qrsolv.pyx":83
 *                 if ta[k] != 0:
 *                     if fabs(s[k, k]) > fabs(ta[k]):
 *                         tan = ta[k] / s[k, k]             # <<<<<<<<<<<<<<
 *                         cos = 1 / sqrt(1 + tan * tan)
 ...
 */
            __pyx_t_8 = __pyx_v_k;
            __pyx_t_9 = __pyx_v_k;
            __pyx_v_tan = ((__pyx_v_ta[__pyx_v_k]) / (*__Pyx_BufPtrStrided2d(double *, __pyx_bstruct_s.buf, __pyx_t_8, __pyx_bstride_0_s, __pyx_t_9, __pyx_bstride_1_s)));

            /* "/home/martin/scipy/scipy/optimize/_qrsolv.pyx":84
 *                     if fabs(s[k, k]) > fabs(ta[k]):
 *                         tan = ta[k] / s[k, k]
 *                         cos = 1 / sqrt(1 + tan * tan)             # <<<<<<<<<<<<<<
 *                         sin = cos * tan
 ...
 */
            ...
            /* "/home/martin/scipy/scipy/optimize/_qrsolv.pyx":85
 *                         tan = ta[k] / s[k, k]
 *                         cos = 1 / sqrt(1 + tan * tan)
 *                         sin = cos * tan             # <<<<<<<<<<<<<<
 *                     else:
 ...
 */
          ...
          /*else*/ {
            ...
            /* "/home/martin/scipy/scipy/optimize/_qrsolv.pyx":87
 *                         sin = cos * tan
 *                     else:
 *                         cotan = s[k, k] / ta[k]             # <<<<<<<<<<<<<<
 *                         sin = 1 / sqrt(1 + cotan * cotan)
 ...
 */
            __pyx_t_10 = __pyx_v_k;
            __pyx_t_11 = __pyx_v_k;
            __pyx_v_cotan = ((*__Pyx_BufPtrStrided2d(double *, __pyx_bstruct_s.buf, __pyx_t_10, __pyx_bstride_0_s, __pyx_t_11, __pyx_bstride_1_s)) / (__pyx_v_ta[__pyx_v_k]));

            /* "/home/martin/scipy/scipy/optimize/_qrsolv.pyx":88
 *                     else:
 *                         cotan = s[k, k] / ta[k]
 *                         sin = 1 / sqrt(1 + cotan * cotan)             # <<<<<<<<<<<<<<
 *                         cos = sin * cotan
 ...
 */
            ...
            /* "/home/martin/scipy/scipy/optimize/_qrsolv.pyx":89
 *                         cotan = s[k, k] / ta[k]
 *                         sin = 1 / sqrt(1 + cotan * cotan)
 *                         cos = sin * cotan             # <<<<<<<<<<<<<<
 *                     for k <= l <= N:
 ...
 */
          ...
          /* "/home/martin/scipy/scipy/optimize/_qrsolv.pyx":90
 *                         sin = 1 / sqrt(1 + cotan * cotan)
 *                         cos = sin * cotan
 *                     for k <= l <= N:             # <<<<<<<<<<<<<<
 *                         tmp = s[k, l]
 ...
 */
          ...
          for (__pyx_v_l = __pyx_v_k; __pyx_v_l <= __pyx_t_12; __pyx_v_l++) {
            ...
            /* "/home/martin/scipy/scipy/optimize/_qrsolv.pyx":91
 *                         cos = sin * cotan
 *                     for k <= l <= N:
 *                         tmp = s[k, l]             # <<<<<<<<<<<<<<
 *                         s[k, l] = cos * tmp + sin * ta[l]
 ...
 */
            __pyx_t_13 = __pyx_v_k;
            __pyx_t_14 = __pyx_v_l;
            __pyx_v_tmp = (*__Pyx_BufPtrStrided2d(double *, __pyx_bstruct_s.buf, __pyx_t_13, __pyx_bstride_0_s, __pyx_t_14, __pyx_bstride_1_s));

            /* "/home/martin/scipy/scipy/optimize/_qrsolv.pyx":92
 *                     for k <= l <= N:
 *                         tmp = s[k, l]
 *                         s[k, l] = cos * tmp + sin * ta[l]             # <<<<<<<<<<<<<<
 *                         ta[l] = -sin * tmp + cos * ta[l]
 ...
 */
            __pyx_t_15 = __pyx_v_k;
            __pyx_t_16 = __pyx_v_l;
            *__Pyx_BufPtrStrided2d(double *, __pyx_bstruct_s.buf, __pyx_t_15, __pyx_bstride_0_s, __pyx_t_16, __pyx_bstride_1_s) = ((__pyx_v_cos * __pyx_v_tmp) + (__pyx_v_sin * (__pyx_v_ta[__pyx_v_l])));

            /* "/home/martin/scipy/scipy/optimize/_qrsolv.pyx":93
 *                         tmp = s[k, l]
 *                         s[k, l] = cos * tmp + sin * ta[l]
 *                         ta[l] = -sin * tmp + cos * ta[l]             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  { PyObject *__pyx_type, *__pyx_value, *__pyx_tb;
    ...
    __Pyx_SafeReleaseBuffer(&__pyx_bstruct_s);
  __Pyx_ErrRestore(__pyx_type, __pyx_value, __pyx_tb);}
  __Pyx_WriteUnraisable("scipy.optimize._qrsolv.qrsolv_double");
  goto __pyx_L2;
  __pyx_L0:;
  __Pyx_SafeReleaseBuffer(&__pyx_bstruct_diag);
  __Pyx_SafeReleaseBuffer(&__pyx_bstruct_s);
...
/* "/home/martin/scipy/scipy/optimize/_qrsolv.pyx":95
 *                         ta[l] = -sin * tmp + cos * ta[l]
 * 
 * def qrsolv(numpy.ndarray s, numpy.ndarray diag):             # <<<<<<<<<<<<<<
...
static PyObject *__pyx_pf_5scipy_8optimize_7_qrsolv_qrsolv(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static char __pyx_doc_5scipy_8optimize_7_qrsolv_qrsolv[] = "Inner-loop of lmfit.Fit._qrsolv. This is an internal function only.\n\n    This function eliminates the diagonal matrix diag using a Givens rotation,\n    in order to meet the goals of lmfit.Fit._qrsolv. ";
static PyObject *__pyx_pf_5scipy_8optimize_7_qrsolv_qrsolv(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  int __pyx_t_4;
  static PyObject **__pyx_pyargnames[] = {&__pyx_n_s__s,&__pyx_n_s__diag,0};
  __Pyx_RefNannySetupContext("qrsolv");
  ...
  if (unlikely(__pyx_kwds)) {
    ...
    switch (PyTuple_GET_SIZE(__pyx_args)) {
      ...
      case  1:
      values[1] = PyDict_GetItem(__pyx_kwds, __pyx_n_s__diag);
      if (likely(values[1])) kw_args--;
      else {
        __Pyx_RaiseArgtupleInvalid("qrsolv", 1, 2, 2, 1); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 95; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
      }
    }
    if (unlikely(kw_args > 0)) {
      if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, PyTuple_GET_SIZE(__pyx_args), "qrsolv") < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 95; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    }
    __pyx_v_s = ((PyArrayObject *)values[0]);
    __pyx_v_diag = ((PyArrayObject *)values[1]);
  } else if (PyTuple_GET_SIZE(__pyx_args) != 2) {
    goto __pyx_L5_argtuple_error;
  } else {
    __pyx_v_s = ((PyArrayObject *)PyTuple_GET_ITEM(__pyx_args, 0));
    __pyx_v_diag = ((PyArrayObject *)PyTuple_GET_ITEM(__pyx_args, 1));
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("qrsolv", 1, 2, 2, PyTuple_GET_SIZE(__pyx_args)); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 95; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  __pyx_L3_error:;
  __Pyx_AddTraceback("scipy.optimize._qrsolv.qrsolv");
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_s), __pyx_ptype_5numpy_ndarray, 1, "s", 0))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 95; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_diag), __pyx_ptype_5numpy_ndarray, 1, "diag", 0))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 95; __pyx_clineno = __LINE__; goto __pyx_L1_error;}

  /* "/home/martin/scipy/scipy/optimize/_qrsolv.pyx":100
 *     This function eliminates the diagonal matrix diag using a Givens rotation,
 *     in order to meet the goals of lmfit.Fit._qrsolv. """
 ...
 */
  __pyx_t_1 = PyObject_GetAttr(((PyObject *)__pyx_v_s), __pyx_n_s__dtype); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 100; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  ...
  __pyx_t_3 = PyObject_GetAttr(__pyx_t_2, __pyx_n_s__float64); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 100; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_2 = PyObject_RichCompare(__pyx_t_1, __pyx_t_3, Py_EQ); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 100; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  ...
  if (__pyx_t_4) {
    ...
    /* "/home/martin/scipy/scipy/optimize/_qrsolv.pyx":101
 *     in order to meet the goals of lmfit.Fit._qrsolv. """
 *     if s.dtype == numpy.float64:
 *         qrsolv_double(s, diag)             # <<<<<<<<<<<<<<
 *     elif s.dtype == numpy.float32:
 *         qrsolv_float(s, diag)
 */
    __pyx_f_5scipy_8optimize_7_qrsolv_qrsolv_double(((PyArrayObject *)__pyx_v_s), ((PyArrayObject *)__pyx_v_diag));
    goto __pyx_L6;
  }

  /* "/home/martin/scipy/scipy/optimize/_qrsolv.pyx":102
 *     if s.dtype == numpy.float64:
 *         qrsolv_double(s, diag)
 *     elif s.dtype == numpy.float32:             # <<<<<<<<<<<<<<
 *         qrsolv_float(s, diag)
 *     else:
 */
  __pyx_t_2 = PyObject_GetAttr(((PyObject *)__pyx_v_s), __pyx_n_s__dtype); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 102; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  ...
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_1 = PyObject_GetAttr(__pyx_t_3, __pyx_n_s__float32); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 102; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_t_3 = PyObject_RichCompare(__pyx_t_2, __pyx_t_1, Py_EQ); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 102; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  ...
  if (__pyx_t_4) {
    ...
    /* "/home/martin/scipy/scipy/optimize/_qrsolv.pyx":103
 *         qrsolv_double(s, diag)
 *     elif s.dtype == numpy.float32:
 *         qrsolv_float(s, diag)             # <<<<<<<<<<<<<<
 *     else:
 ...
 */
    __pyx_f_5scipy_8optimize_7_qrsolv_qrsolv_float(((PyArrayObject *)__pyx_v_s), ((PyArrayObject *)__pyx_v_diag));
    goto __pyx_L6;
  }
  /*else*/ {

    /* "/home/martin/scipy/scipy/optimize/_qrsolv.pyx":105
 *         qrsolv_float(s, diag)
 *     else:
 *         raise NotImplementedError(             # <<<<<<<<<<<<<<
 ...
 */
    ...
    __pyx_t_1 = PyObject_Call(__pyx_builtin_NotImplementedError, __pyx_t_3, NULL); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 105; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_1);
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  ...
  /* "/home/martin/scipy/scipy/optimize/_qrsolv.pyx":107
 *         raise NotImplementedError(
 *             "qrsolv is only implemented for float23 and float64")
 *     return s             # <<<<<<<<<<<<<<
 */
...
static PyMethodDef __pyx_methods[] = {
  {__Pyx_NAMESTR("qrsolv"), (PyCFunction)__pyx_pf_5scipy_8optimize_7_qrsolv_qrsolv, METH_VARARGS|METH_KEYWORDS, __Pyx_DOCSTR(__pyx_doc_5scipy_8optimize_7_qrsolv_qrsolv)},
  {0, 0, 0, 0}
};
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s__qrsolv, __pyx_k__qrsolv, sizeof(__pyx_k__qrsolv), 0, 0, 1, 1},
...
static int __Pyx_InitCachedBuiltins(void) {
  __pyx_builtin_NotImplementedError = __Pyx_GetName(__pyx_b, __pyx_n_s__NotImplementedError); if (!__pyx_builtin_NotImplementedError) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 105; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC init_qrsolv(void); /*proto*/
PyMODINIT_FUNC init_qrsolv(void)
#else
PyMODINIT_FUNC PyInit__qrsolv(void); /*proto*/
PyMODINIT_FUNC PyInit__qrsolv(void)
#endif
{
  PyObject *__pyx_t_1 = NULL;
  PyObject *__pyx_t_2 = NULL;
  ...
  __pyx_refnanny = __Pyx_RefNanny->SetupContext("PyMODINIT_FUNC PyInit__qrsolv(void)", __LINE__, __FILE__);
  #endif
  ...
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4(__Pyx_NAMESTR("_qrsolv"), __pyx_methods, __Pyx_DOCSTR(__pyx_k_8), 0, PYTHON_API_VERSION);
  #else
  ...
  if (__pyx_module_is_main_scipy__optimize___qrsolv) {
  ...
  /* "/home/martin/scipy/scipy/optimize/_qrsolv.pyx":17
 * cimport numpy
 * cimport cython
 * import numpy             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "/home/martin/scipy/scipy/optimize/_qrsolv.pyx":1
 * """             # <<<<<<<<<<<<<<
 * This is an internal module only, containing the inner loops
 * for lmfit.py.
 */
  ...
  __pyx_t_2 = PyObject_GetAttr(__pyx_m, __pyx_n_s__qrsolv); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
 ...
 */
  ...
  __Pyx_XDECREF(__pyx_t_3);
  if (__pyx_m) {
    __Pyx_AddTraceback("init scipy.optimize._qrsolv");
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init scipy.optimize._qrsolv");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if PY_MAJOR_VERSION < 3
