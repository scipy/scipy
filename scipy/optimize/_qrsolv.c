/* Generated by Cython 0.13 on Sat Oct  1 22:50:19 2011 */
...
/* "/home/martin/scipy/scipy/optimize/_qrsolv.pyx":19
...
static  void __pyx_f_5scipy_8optimize_7_qrsolv_qrsolv_float(PyArrayObject *__pyx_v_s, PyArrayObject *__pyx_v_diag) {
  ...
  __pyx_bstruct_diag.buf = NULL;
  {
    ...
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_bstruct_s, (PyObject*)__pyx_v_s, &__Pyx_TypeInfo_float, PyBUF_FORMAT| PyBUF_STRIDES| PyBUF_WRITABLE, 2, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 19; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_bstruct_diag, (PyObject*)__pyx_v_diag, &__Pyx_TypeInfo_float, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 19; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  __pyx_bstride_0_diag = __pyx_bstruct_diag.strides[0];
  __pyx_bshape_0_diag = __pyx_bstruct_diag.shape[0];

  /* "/home/martin/scipy/scipy/optimize/_qrsolv.pyx":32
 *     cdef float *ta
 * 
 *     N = diag.shape[0]             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "/home/martin/scipy/scipy/optimize/_qrsolv.pyx":33
 * 
 *     N = diag.shape[0]
 *     ta = <float *> alloca((N + 1) * sizeof(float))             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    if (__pyx_t_3) {
      ...
      /* "/home/martin/scipy/scipy/optimize/_qrsolv.pyx":37
 *     for 0 <= j < N:
 *         if diag[j] != 0:
 *             memset(ta, 0, (N + 1) * sizeof(float))             # <<<<<<<<<<<<<<
 *             ta[j] = diag[j]
 ...
 */
          __pyx_t_6 = __pyx_v_k;
          __pyx_t_7 = __pyx_v_k;
          __pyx_t_3 = (fabsf((*__Pyx_BufPtrStrided2d(float *, __pyx_bstruct_s.buf, __pyx_t_6, __pyx_bstride_0_s, __pyx_t_7, __pyx_bstride_1_s))) > fabsf((__pyx_v_ta[__pyx_v_k])));
          if (__pyx_t_3) {
 ...
 *                     else:
 */
            __pyx_v_cos = (1.0 / sqrtf((1.0 + (__pyx_v_tan * __pyx_v_tan))));
 ...
 *                     for k <= l <= N:
 */
            __pyx_v_sin = (1.0 / sqrtf((1.0 + (__pyx_v_cotan * __pyx_v_cotan))));

            /* "/home/martin/scipy/scipy/optimize/_qrsolv.pyx":48
 *                         cotan = s[k, k] / ta[k]
 *                         sin = 1 / sqrtf(1 + cotan * cotan)
 *                         cos = sin * cotan             # <<<<<<<<<<<<<<
 *                     for k <= l <= N:
...
/* "/home/martin/scipy/scipy/optimize/_qrsolv.pyx":56
 * @cython.boundscheck(False)
 * @cython.cdivision(True)
...
static  void __pyx_f_5scipy_8optimize_7_qrsolv_qrsolv_double(PyArrayObject *__pyx_v_s, PyArrayObject *__pyx_v_diag) {
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_bstruct_s, (PyObject*)__pyx_v_s, &__Pyx_TypeInfo_double, PyBUF_FORMAT| PyBUF_STRIDES| PyBUF_WRITABLE, 2, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 56; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  __pyx_bstride_0_s = __pyx_bstruct_s.strides[0]; __pyx_bstride_1_s = __pyx_bstruct_s.strides[1];
  __pyx_bshape_0_s = __pyx_bstruct_s.shape[0]; __pyx_bshape_1_s = __pyx_bstruct_s.shape[1];
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_bstruct_diag, (PyObject*)__pyx_v_diag, &__Pyx_TypeInfo_double, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 56; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  __pyx_bstride_0_diag = __pyx_bstruct_diag.strides[0];
  __pyx_bshape_0_diag = __pyx_bstruct_diag.shape[0];

  /* "/home/martin/scipy/scipy/optimize/_qrsolv.pyx":69
 *     cdef double *ta
 * 
 *     N = diag.shape[0]             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "/home/martin/scipy/scipy/optimize/_qrsolv.pyx":70
 * 
 *     N = diag.shape[0]
 *     ta = <double *> alloca((N + 1) * sizeof(double))             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "/home/martin/scipy/scipy/optimize/_qrsolv.pyx":72
 *     ta = <double *> alloca((N + 1) * sizeof(double))
 * 
 *     for 0 <= j < N:             # <<<<<<<<<<<<<<
 *         if diag[j] != 0:
 ...
 */
      ...
      /* "/home/martin/scipy/scipy/optimize/_qrsolv.pyx":75
 *         if diag[j] != 0:
 *             memset(ta, 0, (N + 1) * sizeof(double))
 *             ta[j] = diag[j]             # <<<<<<<<<<<<<<
 *             for j <= k < N:
 ...
 */
          ...
          /* "/home/martin/scipy/scipy/optimize/_qrsolv.pyx":86
 *                         sin = 1 / sqrt(1 + cotan * cotan)
 *                         cos = sin * cotan
 *                     for k <= l <= N:             # <<<<<<<<<<<<<<
 *                         tmp = s[k, l]
...
static PyObject *__pyx_pf_5scipy_8optimize_7_qrsolv_qrsolv(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  if (unlikely(__pyx_kwds)) {
    ...
    switch (PyTuple_GET_SIZE(__pyx_args)) {
      ...
      if (likely(values[1])) kw_args--;
        ...
        __Pyx_RaiseArgtupleInvalid("qrsolv", 1, 2, 2, 1); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 91; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
      }
    }
    if (unlikely(kw_args > 0)) {
      if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, PyTuple_GET_SIZE(__pyx_args), "qrsolv") < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 91; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    }
  ...
  __Pyx_RaiseArgtupleInvalid("qrsolv", 1, 2, 2, PyTuple_GET_SIZE(__pyx_args)); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 91; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  __pyx_L3_error:;
  ...
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_diag), __pyx_ptype_5numpy_ndarray, 1, "diag", 0))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 91; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 */
  __pyx_t_1 = PyObject_GetAttr(((PyObject *)__pyx_v_s), __pyx_n_s__dtype); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 92; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_2 = __Pyx_GetName(__pyx_m, __pyx_n_s__numpy); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 92; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_3 = PyObject_GetAttr(__pyx_t_2, __pyx_n_s__float64); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 92; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_2 = PyObject_RichCompare(__pyx_t_1, __pyx_t_3, Py_EQ); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 92; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
 ...
 */
  ...
  /* "/home/martin/scipy/scipy/optimize/_qrsolv.pyx":94
 *     if s.dtype == numpy.float64:
 *         qrsolv_double(s, diag)
 *     elif s.dtype == numpy.float32:             # <<<<<<<<<<<<<<
 *         qrsolv_float(s, diag)
 *     else:
 */
  __pyx_t_2 = PyObject_GetAttr(((PyObject *)__pyx_v_s), __pyx_n_s__dtype); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 94; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  ...
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_1 = PyObject_GetAttr(__pyx_t_3, __pyx_n_s__float32); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 94; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_t_3 = PyObject_RichCompare(__pyx_t_2, __pyx_t_1, Py_EQ); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 94; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
 ...
 */
  ...
  /*else*/ {
    ...
    /* "/home/martin/scipy/scipy/optimize/_qrsolv.pyx":97
 *         qrsolv_float(s, diag)
 *     else:
 *         raise NotImplementedError(             # <<<<<<<<<<<<<<
 ...
 */
    ...
    __pyx_t_1 = PyObject_Call(__pyx_builtin_NotImplementedError, __pyx_t_3, NULL); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 97; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_1);
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  ...
  /* "/home/martin/scipy/scipy/optimize/_qrsolv.pyx":99
 *         raise NotImplementedError(
 *             "qrsolv is only implemented for float23 and float64")
 *     return s             # <<<<<<<<<<<<<<
 */
...
static PyMethodDef __pyx_methods[] = {
  {__Pyx_NAMESTR("qrsolv"), (PyCFunction)__pyx_pf_5scipy_8optimize_7_qrsolv_qrsolv, METH_VARARGS|METH_KEYWORDS, __Pyx_DOCSTR(0)},
  {0, 0, 0, 0}
};
...
static int __Pyx_InitCachedBuiltins(void) {
  __pyx_builtin_NotImplementedError = __Pyx_GetName(__pyx_b, __pyx_n_s__NotImplementedError); if (!__pyx_builtin_NotImplementedError) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 97; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
...
#endif
{
  ...
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4(__Pyx_NAMESTR("_qrsolv"), __pyx_methods, 0, 0, PYTHON_API_VERSION);
  #else
  ...
  /* "/home/martin/scipy/scipy/optimize/_qrsolv.pyx":15
 * cimport numpy
 * cimport cython
 * import numpy             # <<<<<<<<<<<<<<
 * 
 * @cython.boundscheck(False)
 */
  __pyx_t_1 = __Pyx_Import(((PyObject *)__pyx_n_s__numpy), 0); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 15; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
