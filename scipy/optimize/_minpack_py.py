...
def curve_fit(f, xdata, ydata, p0=None, sigma=None, absolute_sigma=False,
    ...
    **kwargs
    ...
    if method == 'lm':
        ...
        if ier == 5:
            # `errmsg` may have a period at the end.
            message = (f"Optimal parameters not found: {errmsg.strip('.')}. "
                       "The number of iterations can be specified using "
                       "keyword argument `maxfev`.")
            warnings.warn(message, category=OptimizeWarning, stacklevel=2)
