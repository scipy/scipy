...
_py_vq_dep_msg = (
    ...
    "and will be removed in SciPy 2.1.0, use `scipy.cluster.vq.vq` instead."
)
...
def kmeans(obs, k_or_guess, iter=20, thresh=1e-5, check_finite=True,
    ...
    >>> kmeans(whitened, book, rng=rng)
    (array([[ 2.3110306 ,  2.86287398],    # random
           [ 0.93218041,  1.24398691]]), 0.85684700941625547)

    >>> codes = 3
    >>> kmeans(whitened, codes, rng=rng)
    (array([[ 2.3110306 ,  2.86287398],    # random
    ...
    >>> codebook, distortion = kmeans(whitened, 2, rng=rng)
...
def kmeans2(data, k, iter=10, thresh=1e-5, minit='random',
    ...
    >>> centroid, label = kmeans2(z, 3, minit='points', rng=rng)
    >>> centroid
