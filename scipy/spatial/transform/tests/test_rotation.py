...
def test_from_rotvec_small_angle():
    ...
    assert_allclose(
            quat[1, :3],
            np.array([
                0.098796039321534656925304764958285802128222305393864012037,
                0.148194058982301985387957147437428703192333458090796018055,
                0.197592078643069313850609529916571604256444610787728024074
                ]))
