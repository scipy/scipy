...
class Rotation:
    ...
    def rotation_to(self, other: Rotation) -> Rotation: ...
    def magnitude(self) -> np.ndarray | float: ...
    def angle_to(self, other: Rotation) -> np.ndarray | float: ...
    def approx_equal(self, other: Rotation, atol: float | None) -> np.ndarray | bool: ...
