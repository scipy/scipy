...
class Rotation:
    ...
    @classmethod
    def from_davenport(cls, axes: npt.ArrayLike, angles: Union[float, npt.ArrayLike], extrinsic: bool, degrees: bool = ...) -> Rotation: ...
    @classmethod
    ...
    def as_davenport(self, axes: npt.ArrayLike, extrinsic: bool, degrees: bool, correct_set: bool = ...) -> np.ndarray: ...
