...
// $ cython ckdtree.pyx
//
// Unless you add fields to cKDTree or pykdtreenode there
// will be no change in these structs. The fields are layed
...
struct ckdtree {
    PyObject_HEAD
    // vtab pointer is present as long as cKDTree 
    // has cdef methods
    const void          *vtab; 
    // tree structure
