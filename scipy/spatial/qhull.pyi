...
class _Qhull:
    def __init__(self, points: ArrayLike, furthest_site: bool = ...,
                 incremental: bool = ..., qhull_options=...): ...
...
def _get_barycentric_transforms(points: np.ndarray, simplices: np.ndarray,
                                eps: float) -> np.ndarray: ...

class _QhullUser:
    def close(self) -> None: ...
    def _update(self, qhull: _Qhull) -> None: ...
    def _add_points(self, points: ArrayLike, restart: bool = ...,
                    interior_point: ArrayLike = ...) -> None: ...
...
class Delaunay(_QhullUser):
    ...
    def find_simplex(self, xi: ArrayLike, bruteforce: bool = ...,
...
class ConvexHull(_QhullUser):
    def __init__(self, points: ArrayLike, incremental: bool = ...,
                 qhull_options=...): ...
    def _update(self, qhull: _Qhull) -> None: ...
    def add_points(self, points: ArrayLike,
                   restart: bool = ...) -> None: ...
...
class HalfspaceIntersection(_QhullUser):
    def __init__(self, halfspaces: ArrayLike,
                 interior_point: ArrayLike, incremental: bool = ...,
                 qhull_options=...): ...
    def _update(self, qhull: _Qhull) -> None: ...
