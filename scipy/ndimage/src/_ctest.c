...
static int
_filter1d(double *input_line, npy_intp input_length, double *output_line, npy_intp output_length, void *callback_data) {
    npy_intp i, j;
...
static PyObject *py_filter1d(PyObject *obj, PyObject *args) {
    ...
    if (!PyArg_ParseTuple(args, "n", callback_data))
        goto error;
...
static int _filter2d(double *buffer, npy_intp filter_size, double *res, void *callback_data) {
    npy_intp i;
...
static PyObject *py_filter2d(PyObject *obj, PyObject *args) {
    Py_ssize_t i, size;
...
static int _transform(
    npy_intp *output_coordinates, double *input_coordinates, npy_intp output_rank, npy_intp input_rank,
    void *callback_data
) {
    npy_intp i;
...
static PyObject *py_transform(PyObject *obj, PyObject *args) {
    ...
    if (!PyArg_ParseTuple(args, "d", callback_data))
        goto error;
...
static struct PyModuleDef _ctest = {PyModuleDef_HEAD_INIT, "_ctest", NULL, -1, _CTestMethods, NULL, NULL, NULL, NULL};

PyMODINIT_FUNC PyInit__ctest(void) { return PyModule_Create(&_ctest); }
