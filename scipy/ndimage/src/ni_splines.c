...
static void _init_causal_mirror(double *c, const npy_intp n, const double z) {
    npy_intp i;
    double z_i = z;
...
static void _init_anticausal_mirror(double *c, const npy_intp n, const double z) {
    c[n - 1] = (z * c[n - 2] + c[n - 1]) * z / (z * z - 1);
}

static void _init_causal_wrap(double *c, const npy_intp n, const double z) {
    npy_intp i;
    double z_i = z;
...
static void _init_anticausal_wrap(double *c, const npy_intp n, const double z) {
    npy_intp i;
    double z_i = z;
...
static void _init_causal_reflect(double *c, const npy_intp n, const double z) {
    npy_intp i;
    double z_i = z;
...
void _init_anticausal_reflect(double *c, const npy_intp n, const double z) { c[n - 1] *= z / (z - 1); }
 ...
 */
static void _apply_filter(double *c, npy_intp n, double z, init_fn *causal_init, init_fn *anticausal_init) {
    npy_intp i;
...
static void _apply_filter_gain(double *c, npy_intp n, const double *zs, int nz) {
    double gain = 1.0;
