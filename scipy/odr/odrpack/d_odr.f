...
C   I:       AN INDEXING VARIABLE.
C   INFO:    AN INDICATOR VARIABLE, WHERE IF
...
C            DISAGREEMENT BETWEEN THE NUMERICAL AND ANALYTIC DERIVATIVES
...
C   DONE:    THE VARIABLE DESIGNATING WHETHER THE IMPLICIT SOLUTION HAS 
...
C            STOPPED DUE TO SOME NUMERICAL ERROR DETECTED WITHIN 
C            SUBROUTINE DODSTP.
...
C  SET NLMS TO INDICATE AN OPTIMAL STEP COULD NOT BE FOUND IN 10 TRIES
...
C            COMPUTING THE FUNCTION AT THE CURRENT BETA AND DELTA.
C   ISTOPC:  THE VARIABLE DESIGNATING WHETHER THE COMPUTATIONS WERE
C            STOPPED DUE TO SOME NUMERICAL ERROR WITHIN ROUTINE DODSTP. 
C   IWORK:   THE INTEGER WORK SPACE.
...
C  BEGIN NEXT ITERATION UNLESS A STOPPING CRITERIA HAS BEEN MET
...
C            ODRPACK. A POSITIVE VALUE INDICATES THE VALUE WAS SUPPLIED
C            BY THE USER.
C   NNZW:    THE NUMBER OF NONZERO OBSERVATIONAL ERROR WEIGHTS.
C   NP:      THE NUMBER OF FUNCTION PARAMETERS.
C   NPP:     THE NUMBER OF FUNCTION PARAMETERS BEING ESTIMATED.
...
C            (ISODR=TRUE) OR BY OLS (ISODR=FALSE).
C   ISTOPC:  THE VARIABLE DESIGNATING WHETHER THE COMPUTATIONS WERE 
C            STOPPED DUE TO A NUMERICAL ERROR WITHIN SUBROUTINE DODSTP.
C   J:       AN INDEXING VARIABLE.
C   K:       AN INDEXING VARIABLE.
C   K1:      AN INDEXING VARIABLE.
...
C                 AS ALGORITHM 70 OF APPLIED STATISTICS.
C               --AS POINTED OUT BY ODEH AND EVANS IN APPLIED 
C                 STATISTICS, THEIR ALGORITHM REPRESENTS A
...
C                 DISTRIBUTION, ALGORITHM 70, APPLIED STATISTICS, 1974, 
C                 PAGES 96-97.
