...
void F_FUNC(dodrc, DODRC)(
    void (*fcn)(
        F_INT *n, F_INT *m, F_INT *np, F_INT *nq, F_INT *ldn, F_INT *ldm, F_INT *ldnp, double *beta, double *xplusd,
        F_INT *ifixb, F_INT *ifixx, F_INT *ldifx, F_INT *ideval, double *f, double *fjacb, double *fjacd, F_INT *istop
    ),
    F_INT *n, F_INT *m, F_INT *np, F_INT *nq, double *beta, double *y, F_INT *ldy, double *x, F_INT *ldx, double *we,
    F_INT *ldwe, F_INT *ld2we, double *wd, F_INT *ldwd, F_INT *ld2wd, F_INT *ifixb, F_INT *ifixx, F_INT *ldifx,
    F_INT *job, F_INT *ndigit, double *taufac, double *sstol, double *partol, F_INT *maxit, F_INT *iprF_INT,
    F_INT *lunerr, F_INT *lunrpt, double *stpb, double *stpd, F_INT *ldstpd, double *sclb, double *scld, F_INT *ldscld,
    double *work, F_INT *lwork, F_INT *iwork, F_INT *liwork, F_INT *info
);
void F_FUNC(dwinf, DWINF)(
    F_INT *n, F_INT *m, F_INT *np, F_INT *nq, F_INT *ldwe, F_INT *ld2we, F_INT *isodr, F_INT *delta, F_INT *eps,
    F_INT *xplus, F_INT *fn, F_INT *sd, F_INT *vcv, F_INT *rvar, F_INT *wss, F_INT *wssde, F_INT *wssep, F_INT *rcond,
    F_INT *eta, F_INT *olmav, F_INT *tau, F_INT *alpha, F_INT *actrs, F_INT *pnorm, F_INT *rnors, F_INT *prers,
    F_INT *partl, F_INT *sstol, F_INT *taufc, F_INT *apsma, F_INT *betao, F_INT *betac, F_INT *betas, F_INT *betan,
    F_INT *s, F_INT *ss, F_INT *ssf, F_INT *qraux, F_INT *u, F_INT *fs, F_INT *fjacb, F_INT *we1, F_INT *diff,
    F_INT *delts, F_INT *deltn, F_INT *t, F_INT *tt, F_INT *omega, F_INT *fjacd, F_INT *wrk1, F_INT *wrk2, F_INT *wrk3,
    F_INT *wrk4, F_INT *wrk5, F_INT *wrk6, F_INT *wrk7, F_INT *lwkmn
);
...
void fcn_callback(
    F_INT *n, F_INT *m, F_INT *np, F_INT *nq, F_INT *ldn, F_INT *ldm, F_INT *ldnp, double *beta, double *xplusd,
    F_INT *ifixb, F_INT *ifixx, F_INT *ldfix, F_INT *ideval, double *f, double *fjacb, double *fjacd, F_INT *istop
) {
    ...
    *istop = 0;
    ...
    if ((*ideval % 10) >= 1) {
        ...
        if ((result_array = (PyArrayObject *) PyArray_ContiguousFromObject(result, NPY_DOUBLE, 0, 2)) == NULL) {
            PYERR2(odr_error, "Result from function call is not a proper array of floats.");
        }
    ...
    if (((*ideval) / 10) % 10 >= 1) {
        ...
        if ((result_array = (PyArrayObject *) PyArray_ContiguousFromObject(result, NPY_DOUBLE, 0, 3)) == NULL) {
            PYERR2(odr_error, "Result from function call is not a proper array of floats.");
        }
        ...
        memcpy((void *) fjacb, PyArray_DATA(result_array), (*n) * (*nq) * (*np) * sizeof(double));
        Py_DECREF(result_array);
    }
    ...
    if (((*ideval) / 100) % 10 >= 1) {
        ...
        memcpy((void *) fjacd, PyArray_DATA(result_array), (*n) * (*nq) * (*m) * sizeof(double));
        Py_DECREF(result_array);
    }
...
PyObject *gen_output(
    F_INT n, F_INT m, F_INT np, F_INT nq, F_INT ldwe, F_INT ld2we, PyArrayObject *beta, PyArrayObject *work,
    PyArrayObject *iwork, F_INT isodr, F_INT info, int full_output
) {
    ...
    F_FUNC(dwinf, DWINF)
    (&n, &m, &np, &nq, &ldwe, &ld2we, &isodr, &delta, &eps, &xplus, &fn, &sd, &vcv, &rvar, &wss, &wssde, &wssep, &rcond,
     &eta, &olmav, &tau, &alpha, &actrs, &pnorm, &rnors, &prers, &partl, &sstol, &taufc, &apsma, &betao, &betac, &betas,
     &betan, &s, &ss, &ssf, &qraux, &u, &fs, &fjacb, &we1, &diff, &delts, &deltn, &t, &tt, &omega, &fjacd, &wrk1, &wrk2,
    ...
    memcpy(PyArray_DATA(sd_beta), (void *) ((double *) (PyArray_DATA(work)) + sd), np * sizeof(double));
    memcpy(PyArray_DATA(cov_beta), (void *) ((double *) (PyArray_DATA(work)) + vcv), np * np * sizeof(double));

    if (!full_output) {
        retobj = Py_BuildValue("OOO", PyArray_Return(beta), PyArray_Return(sd_beta), PyArray_Return(cov_beta));
        ...
        work_ind = Py_BuildValue(
            ("{s:" F_INT_PYFMT ",s:" F_INT_PYFMT ",s:" F_INT_PYFMT ",s:" F_INT_PYFMT ",s:" F_INT_PYFMT ",s:" F_INT_PYFMT
             ",s:" F_INT_PYFMT ",s:" F_INT_PYFMT ",s:" F_INT_PYFMT ",s:" F_INT_PYFMT ",s:" F_INT_PYFMT ",s:" F_INT_PYFMT
             ",s:" F_INT_PYFMT ",s:" F_INT_PYFMT ",s:" F_INT_PYFMT ",s:" F_INT_PYFMT ",s:" F_INT_PYFMT ",s:" F_INT_PYFMT
             ",s:" F_INT_PYFMT ",s:" F_INT_PYFMT ",s:" F_INT_PYFMT ",s:" F_INT_PYFMT ",s:" F_INT_PYFMT ",s:" F_INT_PYFMT
             ",s:" F_INT_PYFMT ",s:" F_INT_PYFMT ",s:" F_INT_PYFMT ",s:" F_INT_PYFMT ",s:" F_INT_PYFMT ",s:" F_INT_PYFMT
             ...
             ",s:" F_INT_PYFMT ",s:" F_INT_PYFMT ",s:" F_INT_PYFMT ",s:" F_INT_PYFMT ",s:" F_INT_PYFMT ",s:" F_INT_PYFMT
             ",s:" F_INT_PYFMT "}"),
            "delta", delta, "eps", eps, "xplus", xplus, "fn", fn, "sd", sd, "vcv", vcv, "rvar", rvar, "wss", wss,
            "wssde", wssde, "wssep", wssep, "rcond", rcond, "eta", eta, "olmav", olmav, "tau", tau, "alpha", alpha,
            "actrs", actrs, "pnorm", pnorm, "rnors", rnors, "prers", prers, "partl", partl, "sstol", sstol, "taufc",
            taufc, "apsma", apsma, "betao", betao, "betac", betac, "betas", betas, "betan", betan, "s", s, "ss", ss,
            "ssf", ssf, "qraux", qraux, "u", u, "fs", fs, "fjacb", fjacb, "we1", we1, "diff", diff, "delts", delts,
            "deltn", deltn, "t", t, "tt", tt, "omega", omega, "fjacd", fjacd, "wrk1", wrk1, "wrk2", wrk2, "wrk3", wrk3,
            "wrk4", wrk4, "wrk5", wrk5, "wrk6", wrk6, "wrk7", wrk7
        );

        if (m == 1) {
            dim1[0] = n;
            deltaA = (PyArrayObject *) PyArray_SimpleNew(1, dim1, NPY_DOUBLE);
            xplusA = (PyArrayObject *) PyArray_SimpleNew(1, dim1, NPY_DOUBLE);
        } else {
            dim2[0] = m;
            dim2[1] = n;
            deltaA = (PyArrayObject *) PyArray_SimpleNew(2, dim2, NPY_DOUBLE);
            xplusA = (PyArrayObject *) PyArray_SimpleNew(2, dim2, NPY_DOUBLE);
        }
        ...
        memcpy(PyArray_DATA(deltaA), (void *) ((double *) (PyArray_DATA(work)) + delta), m * n * sizeof(double));
        memcpy(PyArray_DATA(epsA), (void *) ((double *) (PyArray_DATA(work)) + eps), nq * n * sizeof(double));
        memcpy(PyArray_DATA(xplusA), (void *) ((double *) (PyArray_DATA(work)) + xplus), m * n * sizeof(double));
        memcpy(PyArray_DATA(fnA), (void *) ((double *) (PyArray_DATA(work)) + fn), nq * n * sizeof(double));
        ...
        retobj = Py_BuildValue(
            ("OOO{s:O,s:O,s:O,s:O,s:d,s:d,s:d,s:d,s:d,s:d,s:O,s:O,s:O,s:" F_INT_PYFMT "}"), PyArray_Return(beta),
            PyArray_Return(sd_beta), PyArray_Return(cov_beta), "delta", PyArray_Return(deltaA), "eps",
            PyArray_Return(epsA), "xplus", PyArray_Return(xplusA), "y", PyArray_Return(fnA), "res_var", res_var,
            "sum_square", sum_square, "sum_square_delta", sum_square_delta, "sum_square_eps", sum_square_eps,
            "inv_condnum", inv_condnum, "rel_error", rel_error, "work", PyArray_Return(work), "work_ind", work_ind,
            "iwork", PyArray_Return(iwork), "info", info
        );
        Py_DECREF((PyObject *) sd_beta);
        Py_DECREF((PyObject *) cov_beta);
...
PyObject *odr(PyObject *self, PyObject *args, PyObject *kwds) {
    ...
    static char *kw_list[] = {"fcn",     "initbeta",   "y",      "x",     "we",     "wd",          "fjacb",
                              ...
                              "rptfile", "ndigit",     "taufac", "sstol", "partol", "maxit",       "stpb",
                              "stpd",    "sclb",       "scld",   "work",  "iwork",  "full_output", NULL};
    F_INT isodr = 1;
    PyObject *result;
    ...
    if (kwds == NULL) {
        if (!PyArg_ParseTuple(
                args, ("OOOO|OOOOOOO" F_INT_PYFMT F_INT_PYFMT "z#z#" F_INT_PYFMT "ddd" F_INT_PYFMT "OOOOOOi:odr"), &fcn,
                &initbeta, &py, &px, &pwe, &pwd, &fjacb, &fjacd, &extra_args, &pifixb, &pifixx, &job, &iprint, &errfile,
                &lerrfile, &rptfile, &lrptfile, &ndigit, &taufac, &sstol, &partol, &maxit, &pstpb, &pstpd, &psclb,
                &pscld, &pwork, &piwork, &full_output
            )) {
            return NULL;
        }
    } else {
        if (!PyArg_ParseTupleAndKeywords(
                args, kwds,
                ("OOOO|OOOOOOO" F_INT_PYFMT "" F_INT_PYFMT "z#z#" F_INT_PYFMT "ddd" F_INT_PYFMT "OOOOOOi:odr"), kw_list,
                &fcn, &initbeta, &py, &px, &pwe, &pwd, &fjacb, &fjacd, &extra_args, &pifixb, &pifixx, &job, &iprint,
                &errfile, &lerrfile, &rptfile, &lrptfile, &ndigit, &taufac, &sstol, &partol, &maxit, &pstpb, &pstpd,
                &psclb, &pscld, &pwork, &piwork, &full_output
            )) {
            return NULL;
        }
    }
    ...
    if (!PySequence_Check(py) && !PyNumber_Check(py)) {
        PYERR(PyExc_TypeError, "y must be a sequence or integer (if model is implicit)");
    }
    ...
    if (!implicit) {
        if ((y = (PyArrayObject *) PyArray_CopyFromObject(py, NPY_DOUBLE, 1, 2)) == NULL) {
            PYERR(PyExc_ValueError, "y could not be made into a suitable array");
        }
        n = PyArray_DIMS(y)[PyArray_NDIM(y) - 1]; /* pick the last dimension */
        if ((x = (PyArrayObject *) PyArray_CopyFromObject(px, NPY_DOUBLE, 1, 2)) == NULL) {
            PYERR(PyExc_ValueError, "x could not be made into a suitable array");
        }
        if (n != PyArray_DIMS(x)[PyArray_NDIM(x) - 1]) {
            PYERR(PyExc_ValueError, "x and y don't have matching numbers of observations");
        }
        if (PyArray_NDIM(y) == 1) {
            nq = 1;
        } else {
        ...
        ldx = ldy = n;
    } else { /* we *do* have an implicit model */
        ldy = 1;
    ...
    if ((beta = (PyArrayObject *) PyArray_CopyFromObject(initbeta, NPY_DOUBLE, 1, 1)) == NULL) {
        PYERR(PyExc_ValueError, "initbeta could not be made into a suitable array");
    }
    ...
    if (pwe == NULL) {
        ...
        if ((we = (PyArrayObject *) PyArray_CopyFromObject(pwe, NPY_DOUBLE, 1, 3)) == NULL) {
            PYERR(PyExc_ValueError, "could not convert we to a suitable array");
        }
        ...
        if (PyArray_NDIM(we) == 1 && nq == 1) {
            ...
            ldwe = 1;
            ld2we = 1;
        } else if (PyArray_NDIM(we) == 3 && PyArray_DIMS(we)[0] == nq && PyArray_DIMS(we)[1] == nq &&
                   PyArray_DIMS(we)[2] == 1) {
            /* we is a rank-3 array with the covariant weightings
               to be broadcast to all observations */
            ldwe = 1;
            ld2we = nq;
        } else if (PyArray_NDIM(we) == 2 && PyArray_DIMS(we)[0] == nq && PyArray_DIMS(we)[1] == nq) {
        ...
        else if (PyArray_NDIM(we) == 2 && PyArray_DIMS(we)[0] == nq && PyArray_DIMS(we)[1] == n) {
    ...
    if (pwd == NULL) {
        ...
        if ((wd = (PyArrayObject *) PyArray_CopyFromObject(pwd, NPY_DOUBLE, 1, 3)) == NULL) {
            PYERR(PyExc_ValueError, "could not convert wd to a suitable array");
        }
        ...
        else if (PyArray_NDIM(wd) == 3 && PyArray_DIMS(wd)[0] == m && PyArray_DIMS(wd)[1] == m &&
                 PyArray_DIMS(wd)[2] == 1) {
            /* wd is a rank-3 array with the covariant wdightings
               to be broadcast to all observations */
            ldwd = 1;
            ld2wd = m;
        } else if (PyArray_NDIM(wd) == 2 && PyArray_DIMS(wd)[0] == m && PyArray_DIMS(wd)[1] == m) {
        ...
        else if (PyArray_NDIM(wd) == 2 && PyArray_DIMS(wd)[0] == m && PyArray_DIMS(wd)[1] == n) {
    ...
    if (pifixb == NULL) {
        ...
        *(F_INT *) (PyArray_DATA(ifixb)) = -1; /* set first element negative */
        ...
        if ((ifixb = (PyArrayObject *) PyArray_CopyFromObject(pifixb, F_INT_NPY, 1, 1)) == NULL) {
            PYERR(PyExc_ValueError, "could not convert ifixb to a suitable array");
        }
    ...
    if (pifixx == NULL) {
        ...
        *(F_INT *) (PyArray_DATA(ifixx)) = -1; /* set first element negative */
        ...
        if ((ifixx = (PyArrayObject *) PyArray_CopyFromObject(pifixx, F_INT_NPY, 1, 2)) == NULL) {
            PYERR(PyExc_ValueError, "could not convert ifixx to a suitable array");
        }
        ...
        if (PyArray_NDIM(ifixx) == 1 && PyArray_DIMS(ifixx)[0] == m) {
            ...
            ldifx = n;
        } else if (PyArray_NDIM(ifixx) == 2 && PyArray_DIMS(ifixx)[0] == m && PyArray_DIMS(ifixx)[1] == n) {
            ldifx = n;
        } else {
            PYERR(PyExc_ValueError, "could not convert ifixx to a suitable array");
        }
    ...
    {
        if ((stpb = (PyArrayObject *) PyArray_CopyFromObject(pstpb, NPY_DOUBLE, 1, 1)) == NULL ||
            PyArray_DIMS(stpb)[0] != np) {
            PYERR(PyExc_ValueError, "could not convert stpb to a suitable array");
        }
    } /* stpb */
    ...
    if (pstpd == NULL) {
        ...
        *(double *) (PyArray_DATA(stpd)) = 0.0;
        ...
        if ((stpd = (PyArrayObject *) PyArray_CopyFromObject(pstpd, NPY_DOUBLE, 1, 2)) == NULL) {
            PYERR(PyExc_ValueError, "could not convert stpb to a suitable array");
        }
        ...
        if (PyArray_NDIM(stpd) == 1 && PyArray_DIMS(stpd)[0] == m) {
            ...
            ldstpd = n;
        } else if (PyArray_NDIM(stpd) == 2 && PyArray_DIMS(stpd)[0] == n && PyArray_DIMS(stpd)[1] == m) {
            ldstpd = n;
        }
    } /* stpd */
    ...
    {
        if ((sclb = (PyArrayObject *) PyArray_CopyFromObject(psclb, NPY_DOUBLE, 1, 1)) == NULL ||
            PyArray_DIMS(sclb)[0] != np) {
            PYERR(PyExc_ValueError, "could not convert sclb to a suitable array");
        }
    } /* sclb */
    ...
    if (pscld == NULL) {
        ...
        *(double *) (PyArray_DATA(scld)) = 0.0;
        ...
        if ((scld = (PyArrayObject *) PyArray_CopyFromObject(pscld, NPY_DOUBLE, 1, 2)) == NULL) {
            PYERR(PyExc_ValueError, "could not convert stpb to a suitable array");
        }
        ...
        if (PyArray_NDIM(scld) == 1 && PyArray_DIMS(scld)[0] == m) {
            ...
            ldscld = n;
        } else if (PyArray_NDIM(scld) == 2 && PyArray_DIMS(scld)[0] == n && PyArray_DIMS(scld)[1] == m) {
            ldscld = n;
        }
    } /* scld */
    ...
    if (job % 10 < 2) {
        ...
        lwork = 18 + 11 * np + np * np + m + m * m + 4 * n * nq + 6 * n * m + 2 * n * nq * np + 2 * n * nq * m +
                nq * nq + 5 * nq + nq * (np + m) + ldwe * ld2we * nq;

        isodr = 1;
    } else {
        /* OLS, not ODR */

        lwork = 18 + 11 * np + np * np + m + m * m + 4 * n * nq + 2 * n * m + 2 * n * nq * np + 5 * nq + nq * (np + m) +
                ldwe * ld2we * nq;
    ...
    if ((job / 10000) % 10 >= 1) {
        ...
        if (pwork == NULL || piwork == NULL) {
            PYERR(PyExc_ValueError, "need to input work and iwork arrays to restart");
        }
    }
    ...
    if ((job / 1000) % 10 >= 1) {
        ...
        if (pwork == NULL) {
            PYERR(PyExc_ValueError, "need to input work array for delta initialization");
        }
    }

    if (pwork != NULL) {
        if ((work = (PyArrayObject *) PyArray_CopyFromObject(pwork, NPY_DOUBLE, 1, 1)) == NULL) {
            PYERR(PyExc_ValueError, "could not convert work to a suitable array");
        }
    ...
    if (piwork != NULL) {
        if ((iwork = (PyArrayObject *) PyArray_CopyFromObject(piwork, F_INT_NPY, 1, 1)) == NULL) {
            PYERR(PyExc_ValueError, "could not convert iwork to a suitable array");
        }
    ...
    if ((job / 10) % 10 >= 2) {
        ...
        if (fjacb == NULL || fjacd == NULL) {
            PYERR(PyExc_ValueError, "need fjacb and fjacd to calculate derivatives");
        }
    }
    ...
    /* now call DODRC */
    F_FUNC(dodrc, DODRC)
    (fcn_callback, &n, &m, &np, &nq, (double *) (PyArray_DATA(beta)), (double *) (PyArray_DATA(y)), &ldy,
     (double *) (PyArray_DATA(x)), &ldx, (double *) (PyArray_DATA(we)), &ldwe, &ld2we, (double *) (PyArray_DATA(wd)),
     &ldwd, &ld2wd, (F_INT *) (PyArray_DATA(ifixb)), (F_INT *) (PyArray_DATA(ifixx)), &ldifx, &job, &ndigit, &taufac,
     &sstol, &partol, &maxit, &iprint, &lunerr, &lunrpt, (double *) (PyArray_DATA(stpb)),
     (double *) (PyArray_DATA(stpd)), &ldstpd, (double *) (PyArray_DATA(sclb)), (double *) (PyArray_DATA(scld)),
     &ldscld, (double *) (PyArray_DATA(work)), &lwork, (F_INT *) (PyArray_DATA(iwork)), &liwork, &info);

    result = gen_output(n, m, np, nq, ldwe, ld2we, beta, work, iwork, isodr, info, full_output);
    ...
    odr_global.fcn = odr_global.fjacb = odr_global.fjacd = odr_global.pyBeta = odr_global.extra_args = NULL;
...
static struct PyModuleDef moduledef = {PyModuleDef_HEAD_INIT, "_odrpack", NULL, -1, methods, NULL, NULL, NULL, NULL};

PyMODINIT_FUNC PyInit___odrpack(void) {
    PyObject *m;
    import_array();
