...
#define OVERRIDE_safe_divides(typ)                                                                                     \
    template <>                                                                                                        \
    inline typ safe_divides<typ>::operator()(const typ &x, const typ &y) const {                                       \
        return x / y;                                                                                                  \
    }

OVERRIDE_safe_divides(float) OVERRIDE_safe_divides(double) OVERRIDE_safe_divides(long double)
    OVERRIDE_safe_divides(npy_cfloat_wrapper) OVERRIDE_safe_divides(npy_cdouble_wrapper)
