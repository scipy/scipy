...
#define SPTOOLS_CSR_DEFINE_TEMPLATE(I, T) \
  ...
  template void _csr_todense(const I n_row, const I n_col, const I Ap_size, const I Aj_size, const I Ax_size, const I Bx_size, const I Ap[], const I Aj[], const T Ax[], T Bx[]); \
