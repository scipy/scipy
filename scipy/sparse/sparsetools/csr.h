...
void csr_diagonal(const I k, const I n_row, const I n_col, const I Ap[], const I Aj[], const T Ax[], T Yx[]) {
 ...
 */
template <class I>
void expandptr(const I n_row, const I Ap[], I Bi[]) {
    for (I i = 0; i < n_row; i++) {
 ...
 */
template <class I, class T>
void csr_scale_rows(const I n_row, const I n_col, const I Ap[], const I Aj[], T Ax[], const T Xx[]) {
    for (I i = 0; i < n_row; i++) {
        for (I jj = Ap[i]; jj < Ap[i + 1]; jj++) {
            Ax[jj] *= Xx[i];
        }
 ...
 */
template <class I, class T>
void csr_scale_columns(const I n_row, const I n_col, const I Ap[], const I Aj[], T Ax[], const T Xx[]) {
 ...
 */
template <class I>
I csr_count_blocks(const I n_row, const I n_col, const I R, const I C, const I Ap[], const I Aj[]) {
...
template <class I, class T>
void csr_tobsr(
    const I n_row, const I n_col, const I R, const I C, const I Ap[], const I Aj[], const T Ax[], I Bp[], I Bj[], T Bx[]
) {
 ...
 */
template <class I, class T>
void csr_todense(const I n_row, const I n_col, const I Ap[], const I Aj[], const T Ax[], T Bx[]) {
    T *Bx_row = Bx;
    for (I i = 0; i < n_row; i++) {
        for (I jj = Ap[i]; jj < Ap[i + 1]; jj++) {
            Bx_row[Aj[jj]] += Ax[jj];
 ...
 */
template <class I>
bool csr_has_sorted_indices(const I n_row, const I Ap[], const I Aj[]) {
    for (I i = 0; i < n_row; i++) {
 ...
 */
template <class I>
bool csr_has_canonical_format(const I n_row, const I Ap[], const I Aj[]) {
    for (I i = 0; i < n_row; i++) {
        if (Ap[i] > Ap[i + 1])
            return false;
...
template <class I, class T>
void csr_toell(
    const I n_row, const I n_col, const I Ap[], const I Aj[], const T Ax[], const I row_length, I Bj[], T Bx[]
) {
 ...
 */
template <class I>
npy_intp csr_matmat_maxnnz(const I n_row, const I n_col, const I Ap[], const I Aj[], const I Bp[], const I Bj[]) {
...
template <class I, class T>
void csr_matmat(
    const I n_row, const I n_col, const I Ap[], const I Aj[], const T Ax[], const I Bp[], const I Bj[], const T Bx[],
    I Cp[], I Cj[], T Cx[]
) {
...
void csr_binop_csr_general(
    const I n_row, const I n_col, const I Ap[], const I Aj[], const T Ax[], const I Bp[], const I Bj[], const T Bx[],
    I Cp[], I Cj[], T2 Cx[], const binary_op &op
) {
 ...
 */
template <class I, class T>
void csr_eliminate_zeros(const I n_row, const I n_col, I Ap[], I Aj[], T Ax[]) {
    I nnz = 0;
    I row_end = 0;
    for (I i = 0; i < n_row; i++) {
        I jj = row_end;
 ...
 */
template <class I, class T>
void csr_matvec(const I n_row, const I n_col, const I Ap[], const I Aj[], const T Ax[], const T Xx[], T Yx[]) {
    for (I i = 0; i < n_row; i++) {
        T sum = Yx[i];
        for (I jj = Ap[i]; jj < Ap[i + 1]; jj++) {
            sum += Ax[jj] * Xx[Aj[jj]];
...
template <class I, class T>
void csr_matvecs(
    const I n_row, const I n_col, const I n_vecs, const I Ap[], const I Aj[], const T Ax[], const T Xx[], T Yx[]
) {
    for (I i = 0; i < n_row; i++) {
...
void get_csr_submatrix(
    const I n_row, const I n_col, const I Ap[], const I Aj[], const T Ax[], const I ir0, const I ir1, const I ic0,
    const I ic1, std::vector<I> *Bp, std::vector<I> *Bj, std::vector<T> *Bx
) {
    I new_n_row = ir1 - ir0;
 ...
 */
template <class I, class T>
void csr_row_index(const I n_row_idx, const I rows[], const I Ap[], const I Aj[], const T Ax[], I Bj[], T Bx[]) {
...
template <class I, class T>
void csr_row_slice(
    const I start, const I stop, const I step, const I Ap[], const I Aj[], const T Ax[], I Bj[], T Bx[]
) {
    if (step > 0) {
 ...
 */
template <class I>
void csr_column_index1(
    const I n_idx, const I col_idxs[], const I n_row, const I n_col, const I Ap[], const I Aj[], I col_offsets[], I Bp[]
) {
    // bincount(col_idxs)
 ...
 */
template <class I, class T>
void csr_column_index2(
    const I col_order[], const I col_offsets[], const I nnz, const I Aj[], const T Ax[], I Bj[], T Bx[]
) {
    I n = 0;
 ...
 */
template <class I>
I csr_count_diagonals(const I n_row, const I Ap[], const I Aj[]) {
    std::set<I> diagonals;
 ...
 */
template <class I, class T>
void csr_sample_values(
    const I n_row, const I n_col, const I Ap[], const I Aj[], const T Ax[], const I n_samples, const I Bi[],
    const I Bj[], T Bx[]
) {
 ...
 */
template <class I>
int csr_sample_offsets(
    const I n_row, const I n_col, const I Ap[], const I Aj[], const I n_samples, const I Bi[], const I Bj[], I Bp[]
) {
    const I nnz = Ap[n_row];
    const I threshold = nnz / 10; // constant is arbitrary
...
template <class I, class T>
void csr_hstack(
    const I n_blocks, const I n_row, const I n_col_cat[], const I Ap_cat[], const I Aj_cat[], const T Ax_cat[], I Bp[],
    I Bj[], T Bx[]
) {
    ...
    for (I i = 0; i < n_row; i++) {
        for (I b = 0; b < n_blocks; b++) {
            ...
            std::transform(&bAj[b][jj_start], &bAj[b][jj_end], &Bj[s], [&](I x) { return (x + offset); });
...
#define SPTOOLS_CSR_EXTERN_TEMPLATE(I, T)                                                                              \
    extern template void csr_diagonal(                                                                                 \
        const I k, const I n_row, const I n_col, const I Ap[], const I Aj[], const T Ax[], T Yx[]                      \
    );                                                                                                                 \
    extern template void csr_scale_rows(                                                                               \
        const I n_row, const I n_col, const I Ap[], const I Aj[], T Ax[], const T Xx[]                                 \
    );                                                                                                                 \
    extern template void csr_scale_columns(                                                                            \
        const I n_row, const I n_col, const I Ap[], const I Aj[], T Ax[], const T Xx[]                                 \
    );                                                                                                                 \
    extern template void csr_tobsr(                                                                                    \
        const I n_row, const I n_col, const I R, const I C, const I Ap[], const I Aj[], const T Ax[], I Bp[], I Bj[],  \
        T Bx[]                                                                                                         \
    );                                                                                                                 \
    ...
    extern template void csr_tocsc(                                                                                    \
        const I n_row, const I n_col, const I Ap[], const I Aj[], const T Ax[], I Bp[], I Bi[], T Bx[]                 \
    );                                                                                                                 \
    extern template void csr_toell(                                                                                    \
        const I n_row, const I n_col, const I Ap[], const I Aj[], const T Ax[], const I row_length, I Bj[], T Bx[]     \
    );                                                                                                                 \
    extern template void csr_matmat(                                                                                   \
        const I n_row, const I n_col, const I Ap[], const I Aj[], const T Ax[], const I Bp[], const I Bj[],            \
        const T Bx[], I Cp[], I Cj[], T Cx[]                                                                           \
    );                                                                                                                 \
    extern template void csr_binop_csr(                                                                                \
        const I n_row, const I n_col, const I Ap[], const I Aj[], const T Ax[], const I Bp[], const I Bj[],            \
        const T Bx[], I Cp[], I Cj[], T Cx[], const std::not_equal_to<T> &op                                           \
    );                                                                                                                 \
    extern template void csr_binop_csr(                                                                                \
        const I n_row, const I n_col, const I Ap[], const I Aj[], const T Ax[], const I Bp[], const I Bj[],            \
        const T Bx[], I Cp[], I Cj[], T Cx[], const std::less<T> &op                                                   \
    );                                                                                                                 \
    extern template void csr_binop_csr(                                                                                \
        const I n_row, const I n_col, const I Ap[], const I Aj[], const T Ax[], const I Bp[], const I Bj[],            \
        const T Bx[], I Cp[], I Cj[], T Cx[], const std::less_equal<T> &op                                             \
    );                                                                                                                 \
    extern template void csr_binop_csr(                                                                                \
        const I n_row, const I n_col, const I Ap[], const I Aj[], const T Ax[], const I Bp[], const I Bj[],            \
        const T Bx[], I Cp[], I Cj[], T Cx[], const std::greater_equal<T> &op                                          \
    );                                                                                                                 \
    extern template void csr_binop_csr(                                                                                \
        const I n_row, const I n_col, const I Ap[], const I Aj[], const T Ax[], const I Bp[], const I Bj[],            \
        const T Bx[], I Cp[], I Cj[], T Cx[], const std::multiplies<T> &op                                             \
    );                                                                                                                 \
    extern template void csr_binop_csr(                                                                                \
        const I n_row, const I n_col, const I Ap[], const I Aj[], const T Ax[], const I Bp[], const I Bj[],            \
        const T Bx[], I Cp[], I Cj[], T Cx[], const safe_divides<T> &op                                                \
    );                                                                                                                 \
    extern template void csr_binop_csr(                                                                                \
        const I n_row, const I n_col, const I Ap[], const I Aj[], const T Ax[], const I Bp[], const I Bj[],            \
        const T Bx[], I Cp[], I Cj[], T Cx[], const std::plus<T> &op                                                   \
    );                                                                                                                 \
    extern template void csr_binop_csr(                                                                                \
        const I n_row, const I n_col, const I Ap[], const I Aj[], const T Ax[], const I Bp[], const I Bj[],            \
        const T Bx[], I Cp[], I Cj[], T Cx[], const std::minus<T> &op                                                  \
    );                                                                                                                 \
    extern template void csr_binop_csr(                                                                                \
        const I n_row, const I n_col, const I Ap[], const I Aj[], const T Ax[], const I Bp[], const I Bj[],            \
        const T Bx[], I Cp[], I Cj[], T Cx[], const maximum<T> &op                                                     \
    );                                                                                                                 \
    extern template void csr_binop_csr(                                                                                \
        const I n_row, const I n_col, const I Ap[], const I Aj[], const T Ax[], const I Bp[], const I Bj[],            \
        const T Bx[], I Cp[], I Cj[], T Cx[], const minimum<T> &op                                                     \
    );                                                                                                                 \
    ...
    extern template void csr_matvec(                                                                                   \
        const I n_row, const I n_col, const I Ap[], const I Aj[], const T Ax[], const T Xx[], T Yx[]                   \
    );                                                                                                                 \
    extern template void csr_matvecs(                                                                                  \
        const I n_row, const I n_col, const I n_vecs, const I Ap[], const I Aj[], const T Ax[], const T Xx[], T Yx[]   \
    );                                                                                                                 \
    extern template void get_csr_submatrix(                                                                            \
        const I n_row, const I n_col, const I Ap[], const I Aj[], const T Ax[], const I ir0, const I ir1, const I ic0, \
        const I ic1, std::vector<I> *Bp, std::vector<I> *Bj, std::vector<T> *Bx                                        \
    );                                                                                                                 \
    extern template void csr_row_index(                                                                                \
        const I n_row_idx, const I rows[], const I Ap[], const I Aj[], const T Ax[], I Bj[], T Bx[]                    \
    );                                                                                                                 \
    extern template void csr_row_slice(                                                                                \
        const I start, const I stop, const I step, const I Ap[], const I Aj[], const T Ax[], I Bj[], T Bx[]            \
    );                                                                                                                 \
    extern template void csr_column_index2(                                                                            \
        const I col_order[], const I col_offsets[], const I nnz, const I Aj[], const T Ax[], I Bj[], T Bx[]            \
    );                                                                                                                 \
    extern template void csr_sample_values(                                                                            \
        const I n_row, const I n_col, const I Ap[], const I Aj[], const T Ax[], const I n_samples, const I Bi[],       \
        const I Bj[], T Bx[]                                                                                           \
    );
