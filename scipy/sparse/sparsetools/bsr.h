...
static inline npy_intp diagonal_size(const npy_intp k, const npy_intp rows, const npy_intp cols) {
    return std::min(rows + std::min(k, (npy_intp) 0), cols - std::max(k, (npy_intp) 0));
}

template <class I, class T>
void bsr_diagonal(
    const I k, const I n_brow, const I n_bcol, const I R, const I C, const I Ap[], const I Aj[], const T Ax[], T Yx[]
) {
    const npy_intp RC = R * C;
    const npy_intp D = diagonal_size(k, (npy_intp) n_brow * R, (npy_intp) n_bcol * C);
    ...
    for (npy_intp brow = first_brow; brow < last_brow; ++brow) {
        ...
        for (npy_intp jj = Ap[brow]; jj < Ap[brow + 1]; ++jj) {
            ...
            if (first_bcol <= bcol && bcol < last_bcol) {
                ...
                const npy_intp Ax_idx = RC * jj + ((block_k >= 0) ? block_k : -C * block_k);
...
template <class I, class T>
void bsr_scale_rows(
    const I n_brow, const I n_bcol, const I R, const I C, const I Ap[], const I Aj[], T Ax[], const T Xx[]
) {
 ...
 */
template <class I, class T>
void bsr_sort_indices(const I n_brow, const I n_bcol, const I R, const I C, I Ap[], I Aj[], T Ax[]) {
    if (R == 1 && C == 1) {
...
template <class I, class T>
void bsr_transpose(
    const I n_brow, const I n_bcol, const I R, const I C, const I Ap[], const I Aj[], const T Ax[], I Bp[], I Bj[],
    T Bx[]
) {
    const I nblks = Ap[n_brow];
    const npy_intp RC = (npy_intp) R * C;
...
template <class I, class T>
void bsr_matmat(
    const I maxnnz, const I n_brow, const I n_bcol, const I R, const I C, const I N, const I Ap[], const I Aj[],
    const T Ax[], const I Bp[], const I Bj[], const T Bx[], I Cp[], I Cj[], T Cx[]
) {
    assert(R > 0 && C > 0 && N > 0);
...
void bsr_binop_bsr_general(
    const I n_brow, const I n_bcol, const I R, const I C, const I Ap[], const I Aj[], const T Ax[], const I Bp[],
    const I Bj[], const T Bx[], I Cp[], I Cj[], T2 Cx[], const bin_op &op
) {
...
void bsr_ne_bsr(
    const I n_row, const I n_col, const I R, const I C, const I Ap[], const I Aj[], const T Ax[], const I Bp[],
    const I Bj[], const T Bx[], I Cp[], I Cj[], T2 Cx[]
) {
...
template <class I, class T>
void bsr_matvec(
    const I n_brow, const I n_bcol, const I R, const I C, const I Ap[], const I Aj[], const T Ax[], const T Xx[], T Yx[]
) {
    assert(R > 0 && C > 0);
...
template <class I, class T>
void bsr_matvecs(
    const I n_brow, const I n_bcol, const I n_vecs, const I R, const I C, const I Ap[], const I Aj[], const T Ax[],
    const T Xx[], T Yx[]
) {
    assert(R > 0 && C > 0);
