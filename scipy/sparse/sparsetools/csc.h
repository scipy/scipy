...
void csc_matvec(const I n_row, const I n_col, const I Ap[], const I Ai[], const T Ax[], const T Xx[], T Yx[]) {
    for (I j = 0; j < n_col; j++) {
        I col_start = Ap[j];
        I col_end = Ap[j + 1];
...
template <class I, class T>
void csc_matvecs(
    const I n_row, const I n_col, const I n_vecs, const I Ap[], const I Ai[], const T Ax[], const T Xx[], T Yx[]
) {
    for (I j = 0; j < n_col; j++) {
 ...
 */
template <class I, class T>
void csc_diagonal(const I k, const I n_row, const I n_col, const I Ap[], const I Aj[], const T Ax[], T Yx[]) {
    csr_diagonal(-k, n_col, n_row, Ap, Aj, Ax, Yx);
}

template <class I, class T>
void csc_tocsr(const I n_row, const I n_col, const I Ap[], const I Ai[], const T Ax[], I Bp[], I Bj[], T Bx[]) {
    csr_tocsc<I, T>(n_col, n_row, Ap, Ai, Ax, Bp, Bj, Bx);
}

template <class I>
npy_intp csc_matmat_maxnnz(const I n_row, const I n_col, const I Ap[], const I Ai[], const I Bp[], const I Bi[]) {
    return csr_matmat_maxnnz(n_col, n_row, Bp, Bi, Ap, Ai);
}

template <class I, class T>
void csc_matmat(
    const I n_row, const I n_col, const I Ap[], const I Ai[], const T Ax[], const I Bp[], const I Bi[], const T Bx[],
    I Cp[], I Ci[], T Cx[]
) {
