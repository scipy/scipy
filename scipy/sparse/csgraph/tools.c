/* Generated by Cython 0.15.1 on Sat Feb 11 10:19:16 2012 */
...
/* "scipy/sparse/csgraph/tools.pyx":111
 * 
 * 
...
static PyObject *__pyx_pf_5scipy_6sparse_7csgraph_5tools_reconstruct_path(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  /* "scipy/sparse/csgraph/tools.pyx":44
 *         csgraph which is represented by the predecessor list.
 *     """
 ...
 */
  ...
  /* "scipy/sparse/csgraph/tools.pyx":46
 *     csgraph = validate_graph(csgraph, directed, dense_output=False)
 * 
 *     N = csgraph.shape[0]             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "scipy/sparse/csgraph/tools.pyx":48
 *     N = csgraph.shape[0]
 * 
 *     nnull = (predecessors < 0).sum()             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "scipy/sparse/csgraph/tools.pyx":50
 *     nnull = (predecessors < 0).sum()
 * 
 *     indices = np.argsort(predecessors)[nnull:]             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "scipy/sparse/csgraph/tools.pyx":52
 *     indices = np.argsort(predecessors)[nnull:]
 *     pind = predecessors[indices]
 *     indptr = pind.searchsorted(np.arange(N + 1))             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "scipy/sparse/csgraph/tools.pyx":54
 *     indptr = pind.searchsorted(np.arange(N + 1))
 * 
 *     if directed == True:             # <<<<<<<<<<<<<<
 ...
 */
    ...
    /* "scipy/sparse/csgraph/tools.pyx":60
 *         data2 = csgraph[indices, pind]
 *         data1[data1 == 0] = np.inf
 *         data2[data2 == 0] = np.inf             # <<<<<<<<<<<<<<
 *         data = np.minimum(data1, data2)
 ...
 */
  ...
  /* "scipy/sparse/csgraph/tools.pyx":63
 *         data = np.minimum(data1, data2)
 * 
 *     data = np.asarray(data).ravel()             # <<<<<<<<<<<<<<
 * 
...
static PyObject *__pyx_pf_5scipy_6sparse_7csgraph_5tools_1construct_dist_matrix(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  /* "scipy/sparse/csgraph/tools.pyx":97
 *     predecessors[i, j] = -9999
 *     """
 ...
 */
  ...
  /* "scipy/sparse/csgraph/tools.pyx":98
 *     """
 *     graph = validate_graph(graph, directed, dtype=DTYPE,
 *                            csr_output=False, copy_if_dense=not directed)             # <<<<<<<<<<<<<<
 *     predecessors = np.asarray(predecessors)
 ...
 */
  ...
  /* "scipy/sparse/csgraph/tools.pyx":99
 *     graph = validate_graph(graph, directed, dtype=DTYPE,
 *                            csr_output=False, copy_if_dense=not directed)
 *     predecessors = np.asarray(predecessors)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "scipy/sparse/csgraph/tools.pyx":101
 *     predecessors = np.asarray(predecessors)
 * 
 *     if predecessors.shape != graph.shape:             # <<<<<<<<<<<<<<
 ...
 */
  ...
  if (__pyx_t_5) {
    ...
    /* "scipy/sparse/csgraph/tools.pyx":102
 * 
 *     if predecessors.shape != graph.shape:
 *         raise ValueError("graph and predecessors "             # <<<<<<<<<<<<<<
 *                          "must have the same shape")
...
static void __pyx_f_5scipy_6sparse_7csgraph_5tools__construct_dist_matrix(PyArrayObject *__pyx_v_graph, PyArrayObject *__pyx_v_pred, PyArrayObject *__pyx_v_dist, struct __pyx_opt_args_5scipy_6sparse_7csgraph_5tools__construct_dist_matrix *__pyx_optional_args) {
  ...
  __pyx_bstruct_dist.buf = NULL;
  {
    ...
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_bstruct_graph, (PyObject*)__pyx_v_graph, &__Pyx_TypeInfo_nn___pyx_t_5scipy_6sparse_7csgraph_5tools_DTYPE_t, PyBUF_FORMAT| PyBUF_STRIDES| PyBUF_WRITABLE, 2, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 111; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_bstruct_pred, (PyObject*)__pyx_v_pred, &__Pyx_TypeInfo_nn___pyx_t_5scipy_6sparse_7csgraph_5tools_ITYPE_t, PyBUF_FORMAT| PyBUF_STRIDES, 2, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 111; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_bstruct_dist, (PyObject*)__pyx_v_dist, &__Pyx_TypeInfo_nn___pyx_t_5scipy_6sparse_7csgraph_5tools_DTYPE_t, PyBUF_FORMAT| PyBUF_STRIDES| PyBUF_WRITABLE, 2, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 111; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  ...
  /* "scipy/sparse/csgraph/tools.pyx":120
 * 
 ...
 */
  ...
  /* "scipy/sparse/csgraph/tools.pyx":124
 *     #------------------------------------------
 ...
 */
  ...
  if (__pyx_t_2) {
    ...
    /* "scipy/sparse/csgraph/tools.pyx":125
 *     # symmetrize matrix if necessary
 *     if not directed:
 *         graph[graph == 0] = np.inf             # <<<<<<<<<<<<<<
 *         for i from 0 <= i < N:
 ...
 */
    ...
    /* "scipy/sparse/csgraph/tools.pyx":126
 *     if not directed:
 *         graph[graph == 0] = np.inf
 *         for i from 0 <= i < N:             # <<<<<<<<<<<<<<
 *             for j from i + 1 <= j < N:
 ...
 */
      ...
      for (__pyx_v_j = (__pyx_v_i + 1); __pyx_v_j < __pyx_t_6; __pyx_v_j++) {
        ...
        /* "scipy/sparse/csgraph/tools.pyx":128
 *         for i from 0 <= i < N:
 *             for j from i + 1 <= j < N:
 *                 if graph[j, i] <= graph[i, j]:             # <<<<<<<<<<<<<<
 *                     graph[i, j] = graph[j, i]
 ...
 */
        ...
        if (__pyx_t_2) {
          ...
          /* "scipy/sparse/csgraph/tools.pyx":129
 *             for j from i + 1 <= j < N:
 *                 if graph[j, i] <= graph[i, j]:
 *                     graph[i, j] = graph[j, i]             # <<<<<<<<<<<<<<
 *                 else:
 ...
 */
      ...
      /* "scipy/sparse/csgraph/tools.pyx":137
 *         for j from 0 <= j < N:
 *             k2 = j
 *             while k2 != i:             # <<<<<<<<<<<<<<
 *                 k1 = pred[i, k2]
 ...
 */
        ...
        /* "scipy/sparse/csgraph/tools.pyx":139
 *             while k2 != i:
 *                 k1 = pred[i, k2]
 *                 if k1 == NULL_IDX:             # <<<<<<<<<<<<<<
 *                     break
 ...
 */
        ...
        if (__pyx_t_2) {
          ...
          /* "scipy/sparse/csgraph/tools.pyx":140
 *                 k1 = pred[i, k2]
 *                 if k1 == NULL_IDX:
 *                     break             # <<<<<<<<<<<<<<
 *                 dist[i, j] += graph[k1, k2]
 ...
 */
  ...
  __pyx_t_1 = 0;
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_5scipy_6sparse_7csgraph_5tools_reconstruct_path, NULL, __pyx_n_s_20); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 21; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
 ...
 *                           directed=True):
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_5scipy_6sparse_7csgraph_5tools_1construct_dist_matrix, NULL, __pyx_n_s_20); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 68; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  ...
  /* "scipy/sparse/csgraph/tools.pyx":114
 *                                  np.ndarray[ITYPE_t, ndim=2] pred,
 *                                  np.ndarray[DTYPE_t, ndim=2] dist,
 *                                  directed=True):             # <<<<<<<<<<<<<<
