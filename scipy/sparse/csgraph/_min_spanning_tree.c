/* Generated by Cython 0.15.1 on Sat Feb 11 08:32:24 2012 */
...
/* "scipy/sparse/csgraph/_min_spanning_tree.pyx":11
 * 
 * DTYPE = np.float64
...
/* "scipy/sparse/csgraph/_min_spanning_tree.pyx":14
 * 
 * ITYPE = np.int32
...
static __Pyx_TypeInfo __Pyx_TypeInfo_nn___pyx_t_5scipy_6sparse_7csgraph_18_min_spanning_tree_DTYPE_t = { "DTYPE_t", NULL, sizeof(__pyx_t_5scipy_6sparse_7csgraph_18_min_spanning_tree_DTYPE_t), 'R' };
static __Pyx_TypeInfo __Pyx_TypeInfo_nn___pyx_t_5scipy_6sparse_7csgraph_18_min_spanning_tree_ITYPE_t = { "ITYPE_t", NULL, sizeof(__pyx_t_5scipy_6sparse_7csgraph_18_min_spanning_tree_ITYPE_t), 'I' };
...
/* "scipy/sparse/csgraph/_min_spanning_tree.pyx":18
 * cdef ITYPE_t NULL_IDX = -9999
 * 
...
static PyObject *__pyx_pf_5scipy_6sparse_7csgraph_18_min_spanning_tree_minimum_spanning_tree(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static char __pyx_doc_5scipy_6sparse_7csgraph_18_min_spanning_tree_minimum_spanning_tree[] = "Return a minimum spanning tree of an undirected graph\n\n    A minimum spanning tree is a graph consisting of the subset of edges\n    which together connect all connected nodes, while minimizing the total\n    sum of weights on the edges.  This is computed using the Kruskal algorithm.\n\n    Parameters\n    ----------\n    csgraph: array-like or sparse matrix, shape = (N, N)\n        the matrix representing an undirected graph over N nodes.\n        (see notes below)\n    overwrite: boolean (optional)\n        if true, then parts of the input graph will be overwritten for\n        efficiency.\n\n    Returns\n    -------\n    span_tree: csr matrix, shape = (N, N)\n        The compressed-sparse representation of the undirected minimum spanning\n        tree over the input (see notes below)\n\n    Examples\n    --------\n    The following example shows the computation of a minimum spanning tree\n    over a simple four-component graph::\n\n         input graph             minimum spanning tree\n\n             (0)                         (0)\n            /   \\                       /\n           3     8                     3\n          /       \\                   /\n        (3)---5---(1)               (3)---5---(1)\n          \\       /                           /\n           6     2                           2\n            \\   /                           /\n             (2)                         (2)\n\n    It is easy to see from inspection that the minimum spanning tree involves\n    removing the edges with weights 8 and 6.  In compressed sparse\n    representation, the solution looks like this:\n\n    >>> from scipy.sparse import csr_matrix\n    >>> from scipy.sparse.csgraph import minimum_spanning_tree\n    >>> X = csr_matrix([[0, 8, 0, 3],\n    ...                 [0, 0, 2, 5],\n    ...                 [0, 0, 0, 6],\n    ...                 [0, 0, 0, 0]])\n    >>> Tcsr = minimum_spanning_tree(X)\n    >>> Tcsr.toarray().astype(int)\n    array([[0, 0, 0, 3],\n   ""        [0, 0, 2, 5],\n           [0, 0, 0, 0],\n           [0, 0, 0, 0]])\n\n    Notes\n    -----\n    This routine uses undirected graphs as input and output.  That is, if\n    graph[i, j] and graph[j, i] are both zero, then nodes i and j do not\n    have an edge connecting them.  If either is nonzero, then the two are\n    connected by the minimum nonzero value of the two.\n    ";
static PyMethodDef __pyx_mdef_5scipy_6sparse_7csgraph_18_min_spanning_tree_minimum_spanning_tree = {__Pyx_NAMESTR("minimum_spanning_tree"), (PyCFunction)__pyx_pf_5scipy_6sparse_7csgraph_18_min_spanning_tree_minimum_spanning_tree, METH_VARARGS|METH_KEYWORDS, __Pyx_DOCSTR(__pyx_doc_5scipy_6sparse_7csgraph_18_min_spanning_tree_minimum_spanning_tree)};
static PyObject *__pyx_pf_5scipy_6sparse_7csgraph_18_min_spanning_tree_minimum_spanning_tree(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("minimum_spanning_tree");
  __pyx_self = __pyx_self;
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, PyTuple_GET_SIZE(__pyx_args), "minimum_spanning_tree") < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 18; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
      }
    } else {
      switch (PyTuple_GET_SIZE(__pyx_args)) {
        case  2: values[1] = PyTuple_GET_ITEM(__pyx_args, 1);
  ...
  __Pyx_RaiseArgtupleInvalid("minimum_spanning_tree", 0, 1, 2, PyTuple_GET_SIZE(__pyx_args)); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 18; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  __pyx_L3_error:;
 ...
 */
  __pyx_t_1 = __Pyx_GetName(__pyx_m, __pyx_n_s__validate_graph); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 83; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  ...
  __pyx_t_3 = __Pyx_GetName(__pyx_m, __pyx_n_s__DTYPE); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 83; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  ...
  __Pyx_GOTREF(__pyx_t_2);
  if (PyDict_SetItem(__pyx_t_3, ((PyObject *)__pyx_n_s__dense_output), __pyx_t_2) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 83; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 * 
 */
  __pyx_t_5 = __Pyx_PyObject_IsTrue(__pyx_v_overwrite); if (unlikely(__pyx_t_5 < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 84; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_t_2 = __Pyx_PyBool_FromLong((!__pyx_t_5)); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 84; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  if (PyDict_SetItem(__pyx_t_3, ((PyObject *)__pyx_n_s__copy_if_sparse), __pyx_t_2) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 83; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_2 = PyEval_CallObjectWithKeywords(__pyx_t_1, ((PyObject *)__pyx_t_4), ((PyObject *)__pyx_t_3)); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 83; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
 ...
 *     data = csgraph.data
 */
  __pyx_t_2 = PyObject_GetAttr(__pyx_v_csgraph, __pyx_n_s__shape); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 85; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_3 = __Pyx_GetItemInt(__pyx_t_2, 0, sizeof(long), PyInt_FromLong); if (!__pyx_t_3) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 85; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_6 = __Pyx_PyInt_AsInt(__pyx_t_3); if (unlikely((__pyx_t_6 == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 85; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 */
  __pyx_t_3 = PyObject_GetAttr(__pyx_v_csgraph, __pyx_n_s__data); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 87; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_3);
 ...
 * 
 */
  __pyx_t_3 = PyObject_GetAttr(__pyx_v_csgraph, __pyx_n_s__indices); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 88; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_3);
 ...
 */
  __pyx_t_3 = PyObject_GetAttr(__pyx_v_csgraph, __pyx_n_s__indptr); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 89; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_3);
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_2 = PyObject_GetAttr(__pyx_t_3, __pyx_n_s__arange); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 91; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_t_3 = PyInt_FromLong(__pyx_v_N); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 91; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_3);
  ...
  __Pyx_GOTREF(((PyObject *)__pyx_t_3));
  __pyx_t_1 = __Pyx_GetName(__pyx_m, __pyx_n_s__ITYPE); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 91; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_t_3, ((PyObject *)__pyx_n_s__dtype), __pyx_t_1) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 91; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_1 = PyEval_CallObjectWithKeywords(__pyx_t_2, ((PyObject *)__pyx_t_4), ((PyObject *)__pyx_t_3)); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 91; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __Pyx_DECREF(((PyObject *)__pyx_t_4)); __pyx_t_4 = 0;
  __Pyx_DECREF(((PyObject *)__pyx_t_3)); __pyx_t_3 = 0;
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_3 = PyObject_GetAttr(__pyx_t_1, __pyx_n_s__empty); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 92; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  ...
  __pyx_t_2 = __Pyx_GetName(__pyx_m, __pyx_n_s__ITYPE); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 92; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  if (PyDict_SetItem(__pyx_t_1, ((PyObject *)__pyx_n_s__dtype), __pyx_t_2) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 92; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_2 = PyEval_CallObjectWithKeywords(__pyx_t_3, ((PyObject *)__pyx_t_4), ((PyObject *)__pyx_t_1)); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 92; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __Pyx_DECREF(((PyObject *)__pyx_t_4)); __pyx_t_4 = 0;
 ...
 */
  __pyx_t_2 = PyObject_GetAttr(__pyx_v_predecessors, __pyx_n_s__fill); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 93; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_1 = __Pyx_PyInt_to_py_npy_int32(__pyx_v_5scipy_6sparse_7csgraph_18_min_spanning_tree_NULL_IDX); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 93; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_4 = PyObject_GetAttr(__pyx_t_1, __pyx_n_s__argsort); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 95; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_1 = PyObject_GetAttr(__pyx_t_2, __pyx_n_s__zeros); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 96; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_7 = PyObject_Length(__pyx_v_data); if (unlikely(__pyx_t_7 == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 96; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_t_2 = PyInt_FromSsize_t(__pyx_t_7); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 96; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  ...
  __pyx_t_3 = __Pyx_GetName(__pyx_m, __pyx_n_s__ITYPE); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 96; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_3);
  if (PyDict_SetItem(__pyx_t_2, ((PyObject *)__pyx_n_s__dtype), __pyx_t_3) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 96; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_t_3 = PyEval_CallObjectWithKeywords(__pyx_t_1, ((PyObject *)__pyx_t_4), ((PyObject *)__pyx_t_2)); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 96; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __Pyx_DECREF(((PyObject *)__pyx_t_4)); __pyx_t_4 = 0;
 ...
 */
  ...
  if (!(likely(((__pyx_v_indices) == Py_None) || likely(__Pyx_TypeTest(__pyx_v_indices, __pyx_ptype_5numpy_ndarray))))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 98; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_t_2 = __pyx_v_indices;
  __Pyx_INCREF(__pyx_t_2);
  if (!(likely(((__pyx_v_indptr) == Py_None) || likely(__Pyx_TypeTest(__pyx_v_indptr, __pyx_ptype_5numpy_ndarray))))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 98; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_t_4 = __pyx_v_indptr;
  __Pyx_INCREF(__pyx_t_4);
  if (!(likely(((__pyx_v_i_sort) == Py_None) || likely(__Pyx_TypeTest(__pyx_v_i_sort, __pyx_ptype_5numpy_ndarray))))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 98; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 */
  if (!(likely(((__pyx_v_row_indices) == Py_None) || likely(__Pyx_TypeTest(__pyx_v_row_indices, __pyx_ptype_5numpy_ndarray))))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 99; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_t_8 = __pyx_v_row_indices;
  __Pyx_INCREF(__pyx_t_8);
  if (!(likely(((__pyx_v_predecessors) == Py_None) || likely(__Pyx_TypeTest(__pyx_v_predecessors, __pyx_ptype_5numpy_ndarray))))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 99; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_t_9 = __pyx_v_predecessors;
  __Pyx_INCREF(__pyx_t_9);
  if (!(likely(((__pyx_v_components) == Py_None) || likely(__Pyx_TypeTest(__pyx_v_components, __pyx_ptype_5numpy_ndarray))))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 99; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_t_10 = __pyx_v_components;
  __Pyx_INCREF(__pyx_t_10);
  __pyx_t_11 = __pyx_f_5scipy_6sparse_7csgraph_18_min_spanning_tree__min_spanning_tree(((PyArrayObject *)__pyx_t_3), ((PyArrayObject *)__pyx_t_2), ((PyArrayObject *)__pyx_t_4), ((PyArrayObject *)__pyx_t_1), ((PyArrayObject *)__pyx_t_8), ((PyArrayObject *)__pyx_t_9), ((PyArrayObject *)__pyx_t_10)); if (unlikely(!__pyx_t_11)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 98; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 * 
 */
  __pyx_t_11 = __Pyx_GetName(__pyx_m, __pyx_n_s__csr_matrix); if (unlikely(!__pyx_t_11)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 101; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_11);
  __pyx_t_10 = PyTuple_New(3); if (unlikely(!__pyx_t_10)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 101; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  ...
  __pyx_t_9 = PyInt_FromLong(__pyx_v_N); if (unlikely(!__pyx_t_9)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 101; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_9);
  __pyx_t_8 = PyInt_FromLong(__pyx_v_N); if (unlikely(!__pyx_t_8)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 101; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  ...
  __pyx_t_10 = 0;
  __pyx_t_1 = 0;
  __pyx_t_1 = PyObject_Call(__pyx_t_11, ((PyObject *)__pyx_t_8), NULL); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 101; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_11); __pyx_t_11 = 0;
 ...
 *     return sp_tree
 */
  __pyx_t_1 = PyObject_GetAttr(__pyx_v_sp_tree, __pyx_n_s__eliminate_zeros); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 102; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_8 = PyObject_Call(__pyx_t_1, ((PyObject *)__pyx_empty_tuple), NULL); if (unlikely(!__pyx_t_8)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 102; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_8);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;

  /* "scipy/sparse/csgraph/_min_spanning_tree.pyx":104
 *     sp_tree.eliminate_zeros()
 * 
 *     return sp_tree             # <<<<<<<<<<<<<<
 * 
...
/* "scipy/sparse/csgraph/_min_spanning_tree.pyx":107
 * 
 * 
...
static PyObject *__pyx_f_5scipy_6sparse_7csgraph_18_min_spanning_tree__min_spanning_tree(PyArrayObject *__pyx_v_data, PyArrayObject *__pyx_v_col_indices, PyArrayObject *__pyx_v_indptr, PyArrayObject *__pyx_v_i_sort, PyArrayObject *__pyx_v_row_indices, PyArrayObject *__pyx_v_predecessors, PyArrayObject *__pyx_v_components) {
  ...
  __pyx_t_5scipy_6sparse_7csgraph_18_min_spanning_tree_DTYPE_t __pyx_v_E;
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_bstruct_indptr, (PyObject*)__pyx_v_indptr, &__Pyx_TypeInfo_nn___pyx_t_5scipy_6sparse_7csgraph_18_min_spanning_tree_ITYPE_t, PyBUF_FORMAT| PyBUF_C_CONTIGUOUS, 1, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 107; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  __pyx_bstride_0_indptr = __pyx_bstruct_indptr.strides[0];
  __pyx_bshape_0_indptr = __pyx_bstruct_indptr.shape[0];
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_bstruct_i_sort, (PyObject*)__pyx_v_i_sort, &__Pyx_TypeInfo_nn___pyx_t_5scipy_6sparse_7csgraph_18_min_spanning_tree_ITYPE_t, PyBUF_FORMAT| PyBUF_C_CONTIGUOUS, 1, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 107; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  __pyx_bstride_0_i_sort = __pyx_bstruct_i_sort.strides[0];
  __pyx_bshape_0_i_sort = __pyx_bstruct_i_sort.shape[0];
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_bstruct_row_indices, (PyObject*)__pyx_v_row_indices, &__Pyx_TypeInfo_nn___pyx_t_5scipy_6sparse_7csgraph_18_min_spanning_tree_ITYPE_t, PyBUF_FORMAT| PyBUF_C_CONTIGUOUS| PyBUF_WRITABLE, 1, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 107; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_bstruct_predecessors, (PyObject*)__pyx_v_predecessors, &__Pyx_TypeInfo_nn___pyx_t_5scipy_6sparse_7csgraph_18_min_spanning_tree_ITYPE_t, PyBUF_FORMAT| PyBUF_C_CONTIGUOUS| PyBUF_WRITABLE, 1, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 107; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_bstruct_components, (PyObject*)__pyx_v_components, &__Pyx_TypeInfo_nn___pyx_t_5scipy_6sparse_7csgraph_18_min_spanning_tree_ITYPE_t, PyBUF_FORMAT| PyBUF_C_CONTIGUOUS, 1, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 107; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
 ...
 */
    ...
    __pyx_t_5 = (*__Pyx_BufPtrCContig1d(__pyx_t_5scipy_6sparse_7csgraph_18_min_spanning_tree_ITYPE_t *, __pyx_bstruct_indptr.buf, __pyx_t_4, __pyx_bstride_0_indptr));
    for (__pyx_v_j = (*__Pyx_BufPtrCContig1d(__pyx_t_5scipy_6sparse_7csgraph_18_min_spanning_tree_ITYPE_t *, __pyx_bstruct_indptr.buf, __pyx_t_2, __pyx_bstride_0_indptr)); __pyx_v_j < __pyx_t_5; __pyx_v_j++) {
 ...
 */
      ...
      *__Pyx_BufPtrCContig1d(__pyx_t_5scipy_6sparse_7csgraph_18_min_spanning_tree_ITYPE_t *, __pyx_bstruct_row_indices.buf, __pyx_t_6, __pyx_bstride_0_row_indices) = __pyx_v_i;
    }
  }
 ...
 */
    ...
    __pyx_v_j = (*__Pyx_BufPtrCContig1d(__pyx_t_5scipy_6sparse_7csgraph_18_min_spanning_tree_ITYPE_t *, __pyx_bstruct_i_sort.buf, __pyx_t_7, __pyx_bstride_0_i_sort));
 ...
 */
    ...
    __pyx_v_V1 = (*__Pyx_BufPtrCContig1d(__pyx_t_5scipy_6sparse_7csgraph_18_min_spanning_tree_ITYPE_t *, __pyx_bstruct_row_indices.buf, __pyx_t_8, __pyx_bstride_0_row_indices));
 ...
 */
    ...
    __pyx_v_V2 = (*__Pyx_BufPtrCContig1d(__pyx_t_5scipy_6sparse_7csgraph_18_min_spanning_tree_ITYPE_t *, __pyx_bstruct_col_indices.buf, __pyx_t_9, __pyx_bstride_0_col_indices));
 ...
 */
    ...
    __pyx_v_E = (*__Pyx_BufPtrCContig1d(__pyx_t_5scipy_6sparse_7csgraph_18_min_spanning_tree_DTYPE_t *, __pyx_bstruct_data.buf, __pyx_t_10, __pyx_bstride_0_data));
 ...
 */
    while (1) {
      ...
      __pyx_t_12 = ((*__Pyx_BufPtrCContig1d(__pyx_t_5scipy_6sparse_7csgraph_18_min_spanning_tree_ITYPE_t *, __pyx_bstruct_predecessors.buf, __pyx_t_11, __pyx_bstride_0_predecessors)) != __pyx_v_5scipy_6sparse_7csgraph_18_min_spanning_tree_NULL_IDX);
      if (!__pyx_t_12) break;
 ...
 */
      ...
      __pyx_v_V1 = (*__Pyx_BufPtrCContig1d(__pyx_t_5scipy_6sparse_7csgraph_18_min_spanning_tree_ITYPE_t *, __pyx_bstruct_predecessors.buf, __pyx_t_13, __pyx_bstride_0_predecessors));
    }
 ...
 */
    while (1) {
      ...
      __pyx_t_12 = ((*__Pyx_BufPtrCContig1d(__pyx_t_5scipy_6sparse_7csgraph_18_min_spanning_tree_ITYPE_t *, __pyx_bstruct_predecessors.buf, __pyx_t_14, __pyx_bstride_0_predecessors)) != __pyx_v_5scipy_6sparse_7csgraph_18_min_spanning_tree_NULL_IDX);
      if (!__pyx_t_12) break;
 ...
 */
      ...
      __pyx_v_V2 = (*__Pyx_BufPtrCContig1d(__pyx_t_5scipy_6sparse_7csgraph_18_min_spanning_tree_ITYPE_t *, __pyx_bstruct_predecessors.buf, __pyx_t_15, __pyx_bstride_0_predecessors));
    }
 ...
 */
    ...
    __pyx_t_12 = ((*__Pyx_BufPtrCContig1d(__pyx_t_5scipy_6sparse_7csgraph_18_min_spanning_tree_ITYPE_t *, __pyx_bstruct_components.buf, __pyx_t_16, __pyx_bstride_0_components)) != (*__Pyx_BufPtrCContig1d(__pyx_t_5scipy_6sparse_7csgraph_18_min_spanning_tree_ITYPE_t *, __pyx_bstruct_components.buf, __pyx_t_17, __pyx_bstride_0_components)));
    if (__pyx_t_12) {
 ...
 */
      ...
      *__Pyx_BufPtrCContig1d(__pyx_t_5scipy_6sparse_7csgraph_18_min_spanning_tree_ITYPE_t *, __pyx_bstruct_predecessors.buf, __pyx_t_18, __pyx_bstride_0_predecessors) = __pyx_v_V1;
      goto __pyx_L13;
    }
    /*else*/ {
 ...
 */
      ...
      *__Pyx_BufPtrCContig1d(__pyx_t_5scipy_6sparse_7csgraph_18_min_spanning_tree_DTYPE_t *, __pyx_bstruct_data.buf, __pyx_t_19, __pyx_bstride_0_data) = 0.0;
    }
    __pyx_L13:;
  }
...
#endif
{
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit__min_spanning_tree(void)");
  ...
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4(__Pyx_NAMESTR("_min_spanning_tree"), __pyx_methods, 0, 0, PYTHON_API_VERSION);
  #else
 ...
 */
  ...
  /* "scipy/sparse/csgraph/_min_spanning_tree.pyx":10
 * from validation import validate_graph
 * 
 * DTYPE = np.float64             # <<<<<<<<<<<<<<
 * ctypedef np.float64_t DTYPE_t
 ...
 */
  ...
  /* "scipy/sparse/csgraph/_min_spanning_tree.pyx":16
 * ctypedef np.int32_t ITYPE_t
 * 
 * cdef ITYPE_t NULL_IDX = -9999             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __Pyx_GIVEREF(__pyx_t_1);
  __pyx_t_1 = 0;
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_5scipy_6sparse_7csgraph_18_min_spanning_tree_minimum_spanning_tree, NULL, __pyx_n_s_15); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 18; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
