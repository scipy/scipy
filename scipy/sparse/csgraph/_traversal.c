/* Generated by Cython 0.17.1 on Sat Oct 20 20:42:57 2012 */
...
static char __pyx_k_36[] = "/Users/mb312/dev_trees/scipy/scipy/sparse/csgraph/_traversal.pyx";
 ...
 */
      ...
      __Pyx_GOTREF(__pyx_t_4);
      __pyx_t_1 = PyObject_RichCompare(((PyObject *)__pyx_v_flag), __pyx_int_0, Py_GT); __Pyx_XGOTREF(__pyx_t_1); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 588; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
...
#endif
{
  ...
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4(__Pyx_NAMESTR("_traversal"), __pyx_methods, __Pyx_DOCSTR(__pyx_k_29), 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
