/* Generated by Cython 0.15.1 on Wed Feb  8 22:08:43 2012 */
...
#endif
#include <math.h>
#define __PYX_HAVE__scipy__sparse__csgraph__graph_min_spanning_tree
#define __PYX_HAVE_API__scipy__sparse__csgraph__graph_min_spanning_tree
#include "stdio.h"
#include "stdlib.h"
...
/* "scipy/sparse/csgraph/graph_min_spanning_tree.pyx":10
 * 
 * DTYPE = np.float64
 ...
 * ITYPE = np.int32
 */
typedef __pyx_t_5numpy_float64_t __pyx_t_5scipy_6sparse_7csgraph_23graph_min_spanning_tree_DTYPE_t;

/* "scipy/sparse/csgraph/graph_min_spanning_tree.pyx":13
 * 
 * ITYPE = np.int32
 ...
 */
typedef __pyx_t_5numpy_int32_t __pyx_t_5scipy_6sparse_7csgraph_23graph_min_spanning_tree_ITYPE_t;
...
/* Module declarations from 'scipy.sparse.csgraph.graph_min_spanning_tree' */
static __pyx_t_5scipy_6sparse_7csgraph_23graph_min_spanning_tree_ITYPE_t __pyx_v_5scipy_6sparse_7csgraph_23graph_min_spanning_tree_NULL_IDX;
static PyObject *__pyx_f_5scipy_6sparse_7csgraph_23graph_min_spanning_tree__min_spanning_tree(PyArrayObject *, PyArrayObject *, PyArrayObject *, PyArrayObject *, PyArrayObject *, PyArrayObject *, PyArrayObject *); /*proto*/
static __Pyx_TypeInfo __Pyx_TypeInfo_nn___pyx_t_5scipy_6sparse_7csgraph_23graph_min_spanning_tree_DTYPE_t = { "DTYPE_t", NULL, sizeof(__pyx_t_5scipy_6sparse_7csgraph_23graph_min_spanning_tree_DTYPE_t), 'R' };
static __Pyx_TypeInfo __Pyx_TypeInfo_nn___pyx_t_5scipy_6sparse_7csgraph_23graph_min_spanning_tree_ITYPE_t = { "ITYPE_t", NULL, sizeof(__pyx_t_5scipy_6sparse_7csgraph_23graph_min_spanning_tree_ITYPE_t), 'I' };
#define __Pyx_MODULE_NAME "scipy.sparse.csgraph.graph_min_spanning_tree"
int __pyx_module_is_main_scipy__sparse__csgraph__graph_min_spanning_tree = 0;

/* Implementation of 'scipy.sparse.csgraph.graph_min_spanning_tree' */
static PyObject *__pyx_builtin_ValueError;
static PyObject *__pyx_builtin_range;
static PyObject *__pyx_builtin_RuntimeError;
static char __pyx_k_2[] = "csgraph must be square";
...
static char __pyx_k_17[] = "scipy.sparse.csgraph.graph_min_spanning_tree";
static char __pyx_k_18[] = "cs_graph_minimum_spanning_tree";
...
/* "scipy/sparse/csgraph/graph_min_spanning_tree.pyx":17
 * cdef ITYPE_t NULL_IDX = -9999
 * 
...
static PyObject *__pyx_pf_5scipy_6sparse_7csgraph_23graph_min_spanning_tree_cs_graph_minimum_spanning_tree(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static char __pyx_doc_5scipy_6sparse_7csgraph_23graph_min_spanning_tree_cs_graph_minimum_spanning_tree[] = "Return a minimum spanning tree of an undirected graph\n\n    A minimum spanning tree is a graph consisting of the subset of edges\n    which together connect all connected nodes, while minimizing the total\n    sum of weights on the edges.  This is computed using the Kruskal algorithm.\n\n    Parameters\n    ----------\n    csgraph: array-like or sparse matrix, shape = (N, N)\n        the matrix representing an undirected graph over N nodes.\n        (see notes below)\n    overwrite: boolean (optional)\n        if true, then parts of the input graph will be overwritten for\n        efficiency.\n\n    Returns\n    -------\n    span_tree: csr matrix, shape = (N, N)\n        The compressed-sparse representation of the undirected minimum spanning\n        tree over the input (see notes below)\n\n    Notes\n    -----\n    This routine uses undirected graphs as input and output.  That is, if\n    graph[i, j] and graph[j, i] are both zero, then nodes i and j do not\n    have an edge connecting them.  If either is nonzero, then the two are\n    connected by the lowest nonzero value of the two.\n    ";
static PyMethodDef __pyx_mdef_5scipy_6sparse_7csgraph_23graph_min_spanning_tree_cs_graph_minimum_spanning_tree = {__Pyx_NAMESTR("cs_graph_minimum_spanning_tree"), (PyCFunction)__pyx_pf_5scipy_6sparse_7csgraph_23graph_min_spanning_tree_cs_graph_minimum_spanning_tree, METH_VARARGS|METH_KEYWORDS, __Pyx_DOCSTR(__pyx_doc_5scipy_6sparse_7csgraph_23graph_min_spanning_tree_cs_graph_minimum_spanning_tree)};
static PyObject *__pyx_pf_5scipy_6sparse_7csgraph_23graph_min_spanning_tree_cs_graph_minimum_spanning_tree(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  PyArrayObject *__pyx_v_components = 0;
  PyArrayObject *__pyx_v_predecessors = 0;
  PyArrayObject *__pyx_v_i_sort = 0;
  ...
  __Pyx_RefNannySetupContext("cs_graph_minimum_spanning_tree");
  __pyx_self = __pyx_self;
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, PyTuple_GET_SIZE(__pyx_args), "cs_graph_minimum_spanning_tree") < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 17; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
      }
    } else {
      switch (PyTuple_GET_SIZE(__pyx_args)) {
        case  2: values[1] = PyTuple_GET_ITEM(__pyx_args, 1);
  ...
  __Pyx_RaiseArgtupleInvalid("cs_graph_minimum_spanning_tree", 0, 1, 2, PyTuple_GET_SIZE(__pyx_args)); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 17; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  __pyx_L3_error:;
  __Pyx_AddTraceback("scipy.sparse.csgraph.graph_min_spanning_tree.cs_graph_minimum_spanning_tree", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __Pyx_INCREF(__pyx_v_csgraph);

  /* "scipy/sparse/csgraph/graph_min_spanning_tree.pyx":48
 *     global NULL_IDX
 * 
 ...
 */
  __pyx_t_1 = __Pyx_GetName(__pyx_m, __pyx_n_s__isspmatrix_csc); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 48; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  ...
  if (__pyx_t_4) {
    ...
    /* "scipy/sparse/csgraph/graph_min_spanning_tree.pyx":49
 * 
 *     if isspmatrix_csc(csgraph):
 *         csgraph = csgraph.T             # <<<<<<<<<<<<<<
 *     elif isspmatrix(csgraph):
 ...
 */
    __pyx_t_3 = PyObject_GetAttr(__pyx_v_csgraph, __pyx_n_s__T); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 49; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_3);
  ...
  /* "scipy/sparse/csgraph/graph_min_spanning_tree.pyx":50
 *     if isspmatrix_csc(csgraph):
 *         csgraph = csgraph.T
 *     elif isspmatrix(csgraph):             # <<<<<<<<<<<<<<
 *         csgraph = csgraph.tocsr()
 *     else:
 */
  __pyx_t_3 = __Pyx_GetName(__pyx_m, __pyx_n_s__isspmatrix); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 50; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_3);
  ...
  PyTuple_SET_ITEM(__pyx_t_2, 0, __pyx_v_csgraph);
  __Pyx_GIVEREF(__pyx_v_csgraph);
  __pyx_t_1 = PyObject_Call(__pyx_t_3, ((PyObject *)__pyx_t_2), NULL); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 50; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __Pyx_DECREF(((PyObject *)__pyx_t_2)); __pyx_t_2 = 0;
  ...
  if (__pyx_t_4) {
    ...
    /* "scipy/sparse/csgraph/graph_min_spanning_tree.pyx":51
 *         csgraph = csgraph.T
 *     elif isspmatrix(csgraph):
 *         csgraph = csgraph.tocsr()             # <<<<<<<<<<<<<<
 *     else:
 ...
 */
    __pyx_t_1 = PyObject_GetAttr(__pyx_v_csgraph, __pyx_n_s__tocsr); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 51; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_1);
  ...
  /*else*/ {
    ...
    /* "scipy/sparse/csgraph/graph_min_spanning_tree.pyx":53
 *         csgraph = csgraph.tocsr()
 *     else:
 *         csgraph = csr_matrix(csgraph)             # <<<<<<<<<<<<<<
 * 
 ...
 */
    __pyx_t_2 = __Pyx_GetName(__pyx_m, __pyx_n_s__csr_matrix); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 53; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_2);
  ...
  /* "scipy/sparse/csgraph/graph_min_spanning_tree.pyx":55
 *         csgraph = csr_matrix(csgraph)
 * 
 *     cdef int N = csgraph.shape[0]             # <<<<<<<<<<<<<<
 ...
 */
  __pyx_t_3 = PyObject_GetAttr(__pyx_v_csgraph, __pyx_n_s__shape); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 55; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_1 = __Pyx_GetItemInt(__pyx_t_3, 0, sizeof(long), PyInt_FromLong); if (!__pyx_t_1) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 55; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  ...
  /* "scipy/sparse/csgraph/graph_min_spanning_tree.pyx":56
 * 
 *     cdef int N = csgraph.shape[0]
 *     if csgraph.shape[1] != N:             # <<<<<<<<<<<<<<
 *         raise ValueError("csgraph must be square")
 * 
 */
  __pyx_t_1 = PyObject_GetAttr(__pyx_v_csgraph, __pyx_n_s__shape); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 56; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_3 = __Pyx_GetItemInt(__pyx_t_1, 1, sizeof(long), PyInt_FromLong); if (!__pyx_t_3) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 56; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_1 = PyInt_FromLong(__pyx_v_N); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 56; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_2 = PyObject_RichCompare(__pyx_t_3, __pyx_t_1, Py_NE); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 56; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  ...
  if (__pyx_t_4) {
    ...
    /* "scipy/sparse/csgraph/graph_min_spanning_tree.pyx":57
 *     cdef int N = csgraph.shape[0]
 *     if csgraph.shape[1] != N:
 *         raise ValueError("csgraph must be square")             # <<<<<<<<<<<<<<
 * 
 *     if overwrite:
 */
    __pyx_t_2 = PyObject_Call(__pyx_builtin_ValueError, ((PyObject *)__pyx_k_tuple_3), NULL); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 57; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_2);
  ...
  /* "scipy/sparse/csgraph/graph_min_spanning_tree.pyx":59
 *         raise ValueError("csgraph must be square")
 * 
 *     if overwrite:             # <<<<<<<<<<<<<<
 *         data = csgraph.data
 ...
 */
  __pyx_t_4 = __Pyx_PyObject_IsTrue(__pyx_v_overwrite); if (unlikely(__pyx_t_4 < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 59; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  if (__pyx_t_4) {

    /* "scipy/sparse/csgraph/graph_min_spanning_tree.pyx":60
 * 
 *     if overwrite:
 *         data = csgraph.data             # <<<<<<<<<<<<<<
 *         indices = csgraph.indices
 ...
 */
    __pyx_t_2 = PyObject_GetAttr(__pyx_v_csgraph, __pyx_n_s__data); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 60; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_2);
    __pyx_v_data = __pyx_t_2;
    __pyx_t_2 = 0;

    /* "scipy/sparse/csgraph/graph_min_spanning_tree.pyx":61
 *     if overwrite:
 *         data = csgraph.data
 *         indices = csgraph.indices             # <<<<<<<<<<<<<<
 *         indptr = csgraph.indptr
 *     else:
 */
    __pyx_t_2 = PyObject_GetAttr(__pyx_v_csgraph, __pyx_n_s__indices); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 61; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_2);
    __pyx_v_indices = __pyx_t_2;
    __pyx_t_2 = 0;

    /* "scipy/sparse/csgraph/graph_min_spanning_tree.pyx":62
 *         data = csgraph.data
 *         indices = csgraph.indices
 *         indptr = csgraph.indptr             # <<<<<<<<<<<<<<
 *     else:
 ...
 */
    __pyx_t_2 = PyObject_GetAttr(__pyx_v_csgraph, __pyx_n_s__indptr); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 62; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_2);
  ...
  /*else*/ {
    ...
    /* "scipy/sparse/csgraph/graph_min_spanning_tree.pyx":64
 *         indptr = csgraph.indptr
 *     else:
 *         data = csgraph.data.copy()             # <<<<<<<<<<<<<<
 ...
 */
    __pyx_t_2 = PyObject_GetAttr(__pyx_v_csgraph, __pyx_n_s__data); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 64; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_2);
    __pyx_t_1 = PyObject_GetAttr(__pyx_t_2, __pyx_n_s__copy); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 64; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_1);
    __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
    ...
    /* "scipy/sparse/csgraph/graph_min_spanning_tree.pyx":65
 *     else:
 *         data = csgraph.data.copy()
 *         indices = csgraph.indices.copy()             # <<<<<<<<<<<<<<
 *         indptr = csgraph.indptr.copy()
 * 
 */
    __pyx_t_2 = PyObject_GetAttr(__pyx_v_csgraph, __pyx_n_s__indices); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 65; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_2);
    __pyx_t_1 = PyObject_GetAttr(__pyx_t_2, __pyx_n_s__copy); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 65; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_1);
    __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
    ...
    /* "scipy/sparse/csgraph/graph_min_spanning_tree.pyx":66
 *         data = csgraph.data.copy()
 *         indices = csgraph.indices.copy()
 *         indptr = csgraph.indptr.copy()             # <<<<<<<<<<<<<<
 * 
 ...
 */
    __pyx_t_2 = PyObject_GetAttr(__pyx_v_csgraph, __pyx_n_s__indptr); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 66; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_2);
    __pyx_t_1 = PyObject_GetAttr(__pyx_t_2, __pyx_n_s__copy); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 66; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_1);
    __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  ...
  /* "scipy/sparse/csgraph/graph_min_spanning_tree.pyx":68
 *         indptr = csgraph.indptr.copy()
 * 
 *     cdef np.ndarray components = np.arange(N, dtype=ITYPE)             # <<<<<<<<<<<<<<
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_1 = PyObject_GetAttr(__pyx_t_2, __pyx_n_s__arange); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 68; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  ...
  __Pyx_GOTREF(((PyObject *)__pyx_t_2));
  __pyx_t_6 = __Pyx_GetName(__pyx_m, __pyx_n_s__ITYPE); if (unlikely(!__pyx_t_6)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 68; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_6);
  if (PyDict_SetItem(__pyx_t_2, ((PyObject *)__pyx_n_s__dtype), __pyx_t_6) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 68; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
  __pyx_t_6 = PyEval_CallObjectWithKeywords(__pyx_t_1, ((PyObject *)__pyx_t_3), ((PyObject *)__pyx_t_2)); if (unlikely(!__pyx_t_6)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 68; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_6);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  ...
  /* "scipy/sparse/csgraph/graph_min_spanning_tree.pyx":69
 * 
 *     cdef np.ndarray components = np.arange(N, dtype=ITYPE)
 *     cdef np.ndarray predecessors = np.empty(N, dtype=ITYPE)             # <<<<<<<<<<<<<<
 *     predecessors.fill(NULL_IDX)
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_6);
  __pyx_t_2 = PyObject_GetAttr(__pyx_t_6, __pyx_n_s__empty); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 69; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
  __pyx_t_6 = PyInt_FromLong(__pyx_v_N); if (unlikely(!__pyx_t_6)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 69; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_6);
  ...
  __pyx_t_1 = __Pyx_GetName(__pyx_m, __pyx_n_s__ITYPE); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 69; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_t_6, ((PyObject *)__pyx_n_s__dtype), __pyx_t_1) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 69; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_1 = PyEval_CallObjectWithKeywords(__pyx_t_2, ((PyObject *)__pyx_t_3), ((PyObject *)__pyx_t_6)); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 69; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __Pyx_DECREF(((PyObject *)__pyx_t_3)); __pyx_t_3 = 0;
  ...
  __pyx_v_predecessors = ((PyArrayObject *)__pyx_t_1);
  __pyx_t_1 = 0;

  /* "scipy/sparse/csgraph/graph_min_spanning_tree.pyx":70
 *     cdef np.ndarray components = np.arange(N, dtype=ITYPE)
 *     cdef np.ndarray predecessors = np.empty(N, dtype=ITYPE)
 *     predecessors.fill(NULL_IDX)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __pyx_t_1 = PyObject_GetAttr(((PyObject *)__pyx_v_predecessors), __pyx_n_s__fill); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 70; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_6 = __Pyx_PyInt_to_py_npy_int32(__pyx_v_5scipy_6sparse_7csgraph_23graph_min_spanning_tree_NULL_IDX); if (unlikely(!__pyx_t_6)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 70; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_6);
  ...
  __Pyx_GIVEREF(__pyx_t_6);
  __pyx_t_6 = 0;
  __pyx_t_6 = PyObject_Call(__pyx_t_1, ((PyObject *)__pyx_t_3), NULL); if (unlikely(!__pyx_t_6)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 70; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_6);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __Pyx_DECREF(((PyObject *)__pyx_t_3)); __pyx_t_3 = 0;
  __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;

  /* "scipy/sparse/csgraph/graph_min_spanning_tree.pyx":72
 *     predecessors.fill(NULL_IDX)
 * 
 *     cdef np.ndarray i_sort = np.argsort(data)             # <<<<<<<<<<<<<<
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_6);
  __pyx_t_3 = PyObject_GetAttr(__pyx_t_6, __pyx_n_s__argsort); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 72; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
  ...
  __pyx_v_i_sort = ((PyArrayObject *)__pyx_t_1);
  __pyx_t_1 = 0;

  /* "scipy/sparse/csgraph/graph_min_spanning_tree.pyx":73
 * 
 *     cdef np.ndarray i_sort = np.argsort(data)
 *     cdef np.ndarray row_indices = np.zeros(len(data), dtype=ITYPE)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_6 = PyObject_GetAttr(__pyx_t_1, __pyx_n_s__zeros); if (unlikely(!__pyx_t_6)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 73; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_6);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_7 = PyObject_Length(__pyx_v_data); if (unlikely(__pyx_t_7 == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 73; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_t_1 = PyInt_FromSsize_t(__pyx_t_7); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 73; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  ...
  __Pyx_GOTREF(((PyObject *)__pyx_t_1));
  __pyx_t_2 = __Pyx_GetName(__pyx_m, __pyx_n_s__ITYPE); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 73; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  if (PyDict_SetItem(__pyx_t_1, ((PyObject *)__pyx_n_s__dtype), __pyx_t_2) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 73; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_2 = PyEval_CallObjectWithKeywords(__pyx_t_6, ((PyObject *)__pyx_t_3), ((PyObject *)__pyx_t_1)); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 73; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
  __Pyx_DECREF(((PyObject *)__pyx_t_3)); __pyx_t_3 = 0;
  __Pyx_DECREF(((PyObject *)__pyx_t_1)); __pyx_t_1 = 0;
  ...
  __pyx_v_row_indices = ((PyArrayObject *)__pyx_t_2);
  __pyx_t_2 = 0;

  /* "scipy/sparse/csgraph/graph_min_spanning_tree.pyx":75
 *     cdef np.ndarray row_indices = np.zeros(len(data), dtype=ITYPE)
 * 
 *     _min_spanning_tree(data, indices, indptr, i_sort,             # <<<<<<<<<<<<<<
 ...
 * 
 */
  if (!(likely(((__pyx_v_data) == Py_None) || likely(__Pyx_TypeTest(__pyx_v_data, __pyx_ptype_5numpy_ndarray))))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 75; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_t_2 = __pyx_v_data;
  __Pyx_INCREF(__pyx_t_2);
  if (!(likely(((__pyx_v_indices) == Py_None) || likely(__Pyx_TypeTest(__pyx_v_indices, __pyx_ptype_5numpy_ndarray))))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 75; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_t_1 = __pyx_v_indices;
  __Pyx_INCREF(__pyx_t_1);
  if (!(likely(((__pyx_v_indptr) == Py_None) || likely(__Pyx_TypeTest(__pyx_v_indptr, __pyx_ptype_5numpy_ndarray))))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 75; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_t_3 = __pyx_v_indptr;
  __Pyx_INCREF(__pyx_t_3);

  /* "scipy/sparse/csgraph/graph_min_spanning_tree.pyx":76
 * 
 *     _min_spanning_tree(data, indices, indptr, i_sort,
 *                        row_indices, predecessors, components)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __pyx_t_6 = __pyx_f_5scipy_6sparse_7csgraph_23graph_min_spanning_tree__min_spanning_tree(((PyArrayObject *)__pyx_t_2), ((PyArrayObject *)__pyx_t_1), ((PyArrayObject *)__pyx_t_3), ((PyArrayObject *)__pyx_v_i_sort), ((PyArrayObject *)__pyx_v_row_indices), ((PyArrayObject *)__pyx_v_predecessors), ((PyArrayObject *)__pyx_v_components)); if (unlikely(!__pyx_t_6)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 75; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_6);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  ...
  /* "scipy/sparse/csgraph/graph_min_spanning_tree.pyx":78
 *                        row_indices, predecessors, components)
 * 
 *     sp_tree = csr_matrix((data, indices, indptr), (N, N))             # <<<<<<<<<<<<<<
 ...
 * 
 */
  __pyx_t_6 = __Pyx_GetName(__pyx_m, __pyx_n_s__csr_matrix); if (unlikely(!__pyx_t_6)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 78; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_6);
  ...
  __pyx_t_1 = PyInt_FromLong(__pyx_v_N); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 78; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_2 = PyInt_FromLong(__pyx_v_N); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 78; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  ...
  __pyx_t_3 = 0;
  __pyx_t_8 = 0;
  __pyx_t_8 = PyObject_Call(__pyx_t_6, ((PyObject *)__pyx_t_2), NULL); if (unlikely(!__pyx_t_8)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 78; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  ...
  /* "scipy/sparse/csgraph/graph_min_spanning_tree.pyx":79
 * 
 *     sp_tree = csr_matrix((data, indices, indptr), (N, N))
 *     sp_tree.eliminate_zeros()             # <<<<<<<<<<<<<<
 * 
 *     return sp_tree
 */
  __pyx_t_8 = PyObject_GetAttr(__pyx_v_sp_tree, __pyx_n_s__eliminate_zeros); if (unlikely(!__pyx_t_8)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 79; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_8);
  __pyx_t_2 = PyObject_Call(__pyx_t_8, ((PyObject *)__pyx_empty_tuple), NULL); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 79; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;

  /* "scipy/sparse/csgraph/graph_min_spanning_tree.pyx":81
 *     sp_tree.eliminate_zeros()
 * 
 *     return sp_tree             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __Pyx_XDECREF((PyObject *)__pyx_v_i_sort);
  __Pyx_XDECREF((PyObject *)__pyx_v_row_indices);
...
/* "scipy/sparse/csgraph/graph_min_spanning_tree.pyx":84
 * 
 * 
...
static PyObject *__pyx_f_5scipy_6sparse_7csgraph_23graph_min_spanning_tree__min_spanning_tree(PyArrayObject *__pyx_v_data, PyArrayObject *__pyx_v_col_indices, PyArrayObject *__pyx_v_indptr, PyArrayObject *__pyx_v_i_sort, PyArrayObject *__pyx_v_row_indices, PyArrayObject *__pyx_v_predecessors, PyArrayObject *__pyx_v_components) {
  unsigned int __pyx_v_i;
  unsigned int __pyx_v_j;
  unsigned int __pyx_v_V1;
  unsigned int __pyx_v_V2;
  __pyx_t_5scipy_6sparse_7csgraph_23graph_min_spanning_tree_DTYPE_t __pyx_v_E;
  Py_buffer __pyx_bstruct_row_indices;
  Py_ssize_t __pyx_bstride_0_row_indices = 0;
  Py_ssize_t __pyx_bshape_0_row_indices = 0;
  Py_buffer __pyx_bstruct_col_indices;
  Py_ssize_t __pyx_bstride_0_col_indices = 0;
  Py_ssize_t __pyx_bshape_0_col_indices = 0;
  Py_buffer __pyx_bstruct_indptr;
  Py_ssize_t __pyx_bstride_0_indptr = 0;
  Py_ssize_t __pyx_bshape_0_indptr = 0;
  Py_buffer __pyx_bstruct_i_sort;
  Py_ssize_t __pyx_bstride_0_i_sort = 0;
  Py_ssize_t __pyx_bshape_0_i_sort = 0;
  Py_buffer __pyx_bstruct_components;
  Py_ssize_t __pyx_bstride_0_components = 0;
  Py_ssize_t __pyx_bshape_0_components = 0;
  ...
  int __pyx_t_3;
  long __pyx_t_4;
  __pyx_t_5scipy_6sparse_7csgraph_23graph_min_spanning_tree_ITYPE_t __pyx_t_5;
  ...
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("_min_spanning_tree");
  __pyx_bstruct_data.buf = NULL;
  __pyx_bstruct_col_indices.buf = NULL;
  __pyx_bstruct_indptr.buf = NULL;
  __pyx_bstruct_i_sort.buf = NULL;
  __pyx_bstruct_row_indices.buf = NULL;
  __pyx_bstruct_predecessors.buf = NULL;
  __pyx_bstruct_components.buf = NULL;
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_bstruct_data, (PyObject*)__pyx_v_data, &__Pyx_TypeInfo_nn___pyx_t_5scipy_6sparse_7csgraph_23graph_min_spanning_tree_DTYPE_t, PyBUF_FORMAT| PyBUF_C_CONTIGUOUS| PyBUF_WRITABLE, 1, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 84; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  __pyx_bstride_0_data = __pyx_bstruct_data.strides[0];
  __pyx_bshape_0_data = __pyx_bstruct_data.shape[0];
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_bstruct_col_indices, (PyObject*)__pyx_v_col_indices, &__Pyx_TypeInfo_nn___pyx_t_5scipy_6sparse_7csgraph_23graph_min_spanning_tree_ITYPE_t, PyBUF_FORMAT| PyBUF_C_CONTIGUOUS, 1, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 84; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  __pyx_bstride_0_col_indices = __pyx_bstruct_col_indices.strides[0];
  __pyx_bshape_0_col_indices = __pyx_bstruct_col_indices.shape[0];
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_bstruct_indptr, (PyObject*)__pyx_v_indptr, &__Pyx_TypeInfo_nn___pyx_t_5scipy_6sparse_7csgraph_23graph_min_spanning_tree_ITYPE_t, PyBUF_FORMAT| PyBUF_C_CONTIGUOUS, 1, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 84; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  __pyx_bstride_0_indptr = __pyx_bstruct_indptr.strides[0];
  __pyx_bshape_0_indptr = __pyx_bstruct_indptr.shape[0];
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_bstruct_i_sort, (PyObject*)__pyx_v_i_sort, &__Pyx_TypeInfo_nn___pyx_t_5scipy_6sparse_7csgraph_23graph_min_spanning_tree_ITYPE_t, PyBUF_FORMAT| PyBUF_C_CONTIGUOUS, 1, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 84; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  __pyx_bstride_0_i_sort = __pyx_bstruct_i_sort.strides[0];
  __pyx_bshape_0_i_sort = __pyx_bstruct_i_sort.shape[0];
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_bstruct_row_indices, (PyObject*)__pyx_v_row_indices, &__Pyx_TypeInfo_nn___pyx_t_5scipy_6sparse_7csgraph_23graph_min_spanning_tree_ITYPE_t, PyBUF_FORMAT| PyBUF_C_CONTIGUOUS| PyBUF_WRITABLE, 1, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 84; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  __pyx_bstride_0_row_indices = __pyx_bstruct_row_indices.strides[0];
  __pyx_bshape_0_row_indices = __pyx_bstruct_row_indices.shape[0];
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_bstruct_predecessors, (PyObject*)__pyx_v_predecessors, &__Pyx_TypeInfo_nn___pyx_t_5scipy_6sparse_7csgraph_23graph_min_spanning_tree_ITYPE_t, PyBUF_FORMAT| PyBUF_C_CONTIGUOUS| PyBUF_WRITABLE, 1, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 84; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_bstruct_components, (PyObject*)__pyx_v_components, &__Pyx_TypeInfo_nn___pyx_t_5scipy_6sparse_7csgraph_23graph_min_spanning_tree_ITYPE_t, PyBUF_FORMAT| PyBUF_C_CONTIGUOUS, 1, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 84; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  __pyx_bstride_0_components = __pyx_bstruct_components.strides[0];
  __pyx_bshape_0_components = __pyx_bstruct_components.shape[0];

  /* "scipy/sparse/csgraph/graph_min_spanning_tree.pyx":100
 ...
 *             row_indices[j] = i
 */
  __pyx_t_1 = (__pyx_v_predecessors->dimensions[0]);
  for (__pyx_v_i = 0; __pyx_v_i < __pyx_t_1; __pyx_v_i++) {

    /* "scipy/sparse/csgraph/graph_min_spanning_tree.pyx":101
 *     # Note that the array `col_indices` already contains the column index.
 *     for i from 0 <= i < predecessors.shape[0]:
 *         for j from indptr[i] <= j < indptr[i + 1]:             # <<<<<<<<<<<<<<
 *             row_indices[j] = i
 ...
 */
    __pyx_t_2 = __pyx_v_i;
    __pyx_t_3 = -1;
    if (unlikely(__pyx_t_2 >= (size_t)__pyx_bshape_0_indptr)) __pyx_t_3 = 0;
    ...
    __pyx_t_5 = (*__Pyx_BufPtrCContig1d(__pyx_t_5scipy_6sparse_7csgraph_23graph_min_spanning_tree_ITYPE_t *, __pyx_bstruct_indptr.buf, __pyx_t_4, __pyx_bstride_0_indptr));
    for (__pyx_v_j = (*__Pyx_BufPtrCContig1d(__pyx_t_5scipy_6sparse_7csgraph_23graph_min_spanning_tree_ITYPE_t *, __pyx_bstruct_indptr.buf, __pyx_t_2, __pyx_bstride_0_indptr)); __pyx_v_j < __pyx_t_5; __pyx_v_j++) {

      /* "scipy/sparse/csgraph/graph_min_spanning_tree.pyx":102
 *     for i from 0 <= i < predecessors.shape[0]:
 *         for j from indptr[i] <= j < indptr[i + 1]:
 *             row_indices[j] = i             # <<<<<<<<<<<<<<
 * 
 ...
 */
      __pyx_t_6 = __pyx_v_j;
      __pyx_t_3 = -1;
      if (unlikely(__pyx_t_6 >= (size_t)__pyx_bshape_0_row_indices)) __pyx_t_3 = 0;
      if (unlikely(__pyx_t_3 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_3);
        {__pyx_filename = __pyx_f[0]; __pyx_lineno = 102; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      }
      *__Pyx_BufPtrCContig1d(__pyx_t_5scipy_6sparse_7csgraph_23graph_min_spanning_tree_ITYPE_t *, __pyx_bstruct_row_indices.buf, __pyx_t_6, __pyx_bstride_0_row_indices) = __pyx_v_i;
    }
  }

  /* "scipy/sparse/csgraph/graph_min_spanning_tree.pyx":106
 *     # step through the edges from smallest to largest.
 ...
 *         V1 = row_indices[j]
 */
  __pyx_t_1 = (__pyx_v_i_sort->dimensions[0]);
  for (__pyx_v_i = 0; __pyx_v_i < __pyx_t_1; __pyx_v_i++) {

    /* "scipy/sparse/csgraph/graph_min_spanning_tree.pyx":107
 *     #  V1 and V2 are the vertices, and E is the edge weight connecting them.
 *     for i from 0 <= i < i_sort.shape[0]:
 *         j = i_sort[i]             # <<<<<<<<<<<<<<
 *         V1 = row_indices[j]
 ...
 */
    __pyx_t_7 = __pyx_v_i;
    __pyx_t_3 = -1;
    if (unlikely(__pyx_t_7 >= (size_t)__pyx_bshape_0_i_sort)) __pyx_t_3 = 0;
    if (unlikely(__pyx_t_3 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_3);
      {__pyx_filename = __pyx_f[0]; __pyx_lineno = 107; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    }
    __pyx_v_j = (*__Pyx_BufPtrCContig1d(__pyx_t_5scipy_6sparse_7csgraph_23graph_min_spanning_tree_ITYPE_t *, __pyx_bstruct_i_sort.buf, __pyx_t_7, __pyx_bstride_0_i_sort));

    /* "scipy/sparse/csgraph/graph_min_spanning_tree.pyx":108
 *     for i from 0 <= i < i_sort.shape[0]:
 *         j = i_sort[i]
 *         V1 = row_indices[j]             # <<<<<<<<<<<<<<
 *         V2 = col_indices[j]
 ...
 */
    __pyx_t_8 = __pyx_v_j;
    __pyx_t_3 = -1;
    if (unlikely(__pyx_t_8 >= (size_t)__pyx_bshape_0_row_indices)) __pyx_t_3 = 0;
    if (unlikely(__pyx_t_3 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_3);
      {__pyx_filename = __pyx_f[0]; __pyx_lineno = 108; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    }
    __pyx_v_V1 = (*__Pyx_BufPtrCContig1d(__pyx_t_5scipy_6sparse_7csgraph_23graph_min_spanning_tree_ITYPE_t *, __pyx_bstruct_row_indices.buf, __pyx_t_8, __pyx_bstride_0_row_indices));

    /* "scipy/sparse/csgraph/graph_min_spanning_tree.pyx":109
 *         j = i_sort[i]
 *         V1 = row_indices[j]
 *         V2 = col_indices[j]             # <<<<<<<<<<<<<<
 *         E = data[j]
 ...
 */
    __pyx_t_9 = __pyx_v_j;
    __pyx_t_3 = -1;
    if (unlikely(__pyx_t_9 >= (size_t)__pyx_bshape_0_col_indices)) __pyx_t_3 = 0;
    if (unlikely(__pyx_t_3 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_3);
      {__pyx_filename = __pyx_f[0]; __pyx_lineno = 109; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    }
    __pyx_v_V2 = (*__Pyx_BufPtrCContig1d(__pyx_t_5scipy_6sparse_7csgraph_23graph_min_spanning_tree_ITYPE_t *, __pyx_bstruct_col_indices.buf, __pyx_t_9, __pyx_bstride_0_col_indices));

    /* "scipy/sparse/csgraph/graph_min_spanning_tree.pyx":110
 *         V1 = row_indices[j]
 *         V2 = col_indices[j]
 *         E = data[j]             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    __pyx_t_3 = -1;
    if (unlikely(__pyx_t_10 >= (size_t)__pyx_bshape_0_data)) __pyx_t_3 = 0;
    if (unlikely(__pyx_t_3 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_3);
      {__pyx_filename = __pyx_f[0]; __pyx_lineno = 110; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    }
    __pyx_v_E = (*__Pyx_BufPtrCContig1d(__pyx_t_5scipy_6sparse_7csgraph_23graph_min_spanning_tree_DTYPE_t *, __pyx_bstruct_data.buf, __pyx_t_10, __pyx_bstride_0_data));

    /* "scipy/sparse/csgraph/graph_min_spanning_tree.pyx":113
 * 
 *         # progress upward to the head node of each subtree
 ...
 */
    while (1) {
      ...
      __pyx_t_3 = -1;
      if (unlikely(__pyx_t_11 >= (size_t)__pyx_bshape_0_predecessors)) __pyx_t_3 = 0;
      if (unlikely(__pyx_t_3 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_3);
        {__pyx_filename = __pyx_f[0]; __pyx_lineno = 113; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      }
      __pyx_t_12 = ((*__Pyx_BufPtrCContig1d(__pyx_t_5scipy_6sparse_7csgraph_23graph_min_spanning_tree_ITYPE_t *, __pyx_bstruct_predecessors.buf, __pyx_t_11, __pyx_bstride_0_predecessors)) != __pyx_v_5scipy_6sparse_7csgraph_23graph_min_spanning_tree_NULL_IDX);
      if (!__pyx_t_12) break;

      /* "scipy/sparse/csgraph/graph_min_spanning_tree.pyx":114
 *         # progress upward to the head node of each subtree
 *         while predecessors[V1] != NULL_IDX:
 *             V1 = predecessors[V1]             # <<<<<<<<<<<<<<
 *         while predecessors[V2] != NULL_IDX:
 ...
 */
      ...
      __pyx_t_3 = -1;
      if (unlikely(__pyx_t_13 >= (size_t)__pyx_bshape_0_predecessors)) __pyx_t_3 = 0;
      if (unlikely(__pyx_t_3 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_3);
        {__pyx_filename = __pyx_f[0]; __pyx_lineno = 114; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      }
      __pyx_v_V1 = (*__Pyx_BufPtrCContig1d(__pyx_t_5scipy_6sparse_7csgraph_23graph_min_spanning_tree_ITYPE_t *, __pyx_bstruct_predecessors.buf, __pyx_t_13, __pyx_bstride_0_predecessors));
    }

    /* "scipy/sparse/csgraph/graph_min_spanning_tree.pyx":115
 *         while predecessors[V1] != NULL_IDX:
 *             V1 = predecessors[V1]
 *         while predecessors[V2] != NULL_IDX:             # <<<<<<<<<<<<<<
 *             V2 = predecessors[V2]
 ...
 */
    while (1) {
      ...
      __pyx_t_3 = -1;
      if (unlikely(__pyx_t_14 >= (size_t)__pyx_bshape_0_predecessors)) __pyx_t_3 = 0;
      if (unlikely(__pyx_t_3 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_3);
        {__pyx_filename = __pyx_f[0]; __pyx_lineno = 115; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      }
      __pyx_t_12 = ((*__Pyx_BufPtrCContig1d(__pyx_t_5scipy_6sparse_7csgraph_23graph_min_spanning_tree_ITYPE_t *, __pyx_bstruct_predecessors.buf, __pyx_t_14, __pyx_bstride_0_predecessors)) != __pyx_v_5scipy_6sparse_7csgraph_23graph_min_spanning_tree_NULL_IDX);
      if (!__pyx_t_12) break;

      /* "scipy/sparse/csgraph/graph_min_spanning_tree.pyx":116
 *             V1 = predecessors[V1]
 *         while predecessors[V2] != NULL_IDX:
 *             V2 = predecessors[V2]             # <<<<<<<<<<<<<<
 * 
 ...
 */
      ...
      __pyx_t_3 = -1;
      if (unlikely(__pyx_t_15 >= (size_t)__pyx_bshape_0_predecessors)) __pyx_t_3 = 0;
      if (unlikely(__pyx_t_3 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_3);
        {__pyx_filename = __pyx_f[0]; __pyx_lineno = 116; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      }
      __pyx_v_V2 = (*__Pyx_BufPtrCContig1d(__pyx_t_5scipy_6sparse_7csgraph_23graph_min_spanning_tree_ITYPE_t *, __pyx_bstruct_predecessors.buf, __pyx_t_15, __pyx_bstride_0_predecessors));
    }

    /* "scipy/sparse/csgraph/graph_min_spanning_tree.pyx":121
 ...
 */
    ...
    __pyx_t_3 = -1;
    if (unlikely(__pyx_t_16 >= (size_t)__pyx_bshape_0_components)) __pyx_t_3 = 0;
    if (unlikely(__pyx_t_3 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_3);
    ...
    __pyx_t_3 = -1;
    if (unlikely(__pyx_t_17 >= (size_t)__pyx_bshape_0_components)) __pyx_t_3 = 0;
    if (unlikely(__pyx_t_3 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_3);
      {__pyx_filename = __pyx_f[0]; __pyx_lineno = 121; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    }
    __pyx_t_12 = ((*__Pyx_BufPtrCContig1d(__pyx_t_5scipy_6sparse_7csgraph_23graph_min_spanning_tree_ITYPE_t *, __pyx_bstruct_components.buf, __pyx_t_16, __pyx_bstride_0_components)) != (*__Pyx_BufPtrCContig1d(__pyx_t_5scipy_6sparse_7csgraph_23graph_min_spanning_tree_ITYPE_t *, __pyx_bstruct_components.buf, __pyx_t_17, __pyx_bstride_0_components)));
    if (__pyx_t_12) {

      /* "scipy/sparse/csgraph/graph_min_spanning_tree.pyx":122
 *         # in the spanning tree.
 *         if components[V1] != components[V2]:
 *             predecessors[V2] = V1             # <<<<<<<<<<<<<<
 *         else:
 ...
 */
      ...
      __pyx_t_3 = -1;
      if (unlikely(__pyx_t_18 >= (size_t)__pyx_bshape_0_predecessors)) __pyx_t_3 = 0;
      if (unlikely(__pyx_t_3 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_3);
        {__pyx_filename = __pyx_f[0]; __pyx_lineno = 122; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      }
      *__Pyx_BufPtrCContig1d(__pyx_t_5scipy_6sparse_7csgraph_23graph_min_spanning_tree_ITYPE_t *, __pyx_bstruct_predecessors.buf, __pyx_t_18, __pyx_bstride_0_predecessors) = __pyx_v_V1;
      goto __pyx_L13;
    }
    /*else*/ {

      /* "scipy/sparse/csgraph/graph_min_spanning_tree.pyx":124
 *             predecessors[V2] = V1
 *         else:
 *             data[j] = 0             # <<<<<<<<<<<<<<
 * 
 */
      ...
      __pyx_t_3 = -1;
      if (unlikely(__pyx_t_19 >= (size_t)__pyx_bshape_0_data)) __pyx_t_3 = 0;
      if (unlikely(__pyx_t_3 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_3);
        {__pyx_filename = __pyx_f[0]; __pyx_lineno = 124; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      }
      *__Pyx_BufPtrCContig1d(__pyx_t_5scipy_6sparse_7csgraph_23graph_min_spanning_tree_DTYPE_t *, __pyx_bstruct_data.buf, __pyx_t_19, __pyx_bstride_0_data) = 0.0;
    }
    __pyx_L13:;
  }
  ...
  { PyObject *__pyx_type, *__pyx_value, *__pyx_tb;
    ...
    __Pyx_SafeReleaseBuffer(&__pyx_bstruct_row_indices);
    __Pyx_SafeReleaseBuffer(&__pyx_bstruct_col_indices);
    __Pyx_SafeReleaseBuffer(&__pyx_bstruct_indptr);
    __Pyx_SafeReleaseBuffer(&__pyx_bstruct_i_sort);
    __Pyx_SafeReleaseBuffer(&__pyx_bstruct_components);
    __Pyx_SafeReleaseBuffer(&__pyx_bstruct_data);
    __Pyx_SafeReleaseBuffer(&__pyx_bstruct_predecessors);
  __Pyx_ErrRestore(__pyx_type, __pyx_value, __pyx_tb);}
  __Pyx_AddTraceback("scipy.sparse.csgraph.graph_min_spanning_tree._min_spanning_tree", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  goto __pyx_L2;
  __pyx_L0:;
  __Pyx_SafeReleaseBuffer(&__pyx_bstruct_row_indices);
...
static struct PyModuleDef __pyx_moduledef = {
    ...
    __Pyx_NAMESTR("graph_min_spanning_tree"),
    0, /* m_doc */
    -1, /* m_size */
...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC initgraph_min_spanning_tree(void); /*proto*/
PyMODINIT_FUNC initgraph_min_spanning_tree(void)
#else
PyMODINIT_FUNC PyInit_graph_min_spanning_tree(void); /*proto*/
PyMODINIT_FUNC PyInit_graph_min_spanning_tree(void)
#endif
{
  PyObject *__pyx_t_1 = NULL;
  PyObject *__pyx_t_2 = NULL;
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit_graph_min_spanning_tree(void)");
  ...
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4(__Pyx_NAMESTR("graph_min_spanning_tree"), __pyx_methods, 0, 0, PYTHON_API_VERSION);
  #else
  ...
  if (__pyx_module_is_main_scipy__sparse__csgraph__graph_min_spanning_tree) {
  ...
  /* "scipy/sparse/csgraph/graph_min_spanning_tree.pyx":4
 * # License: BSD, (C) 2011
 * 
 * import numpy as np             # <<<<<<<<<<<<<<
 * cimport numpy as np
 ...
 */
  ...
  /* "scipy/sparse/csgraph/graph_min_spanning_tree.pyx":7
 * cimport numpy as np
 * 
 ...
 */
  ...
  __pyx_t_2 = __Pyx_Import(((PyObject *)__pyx_n_s_16), ((PyObject *)__pyx_t_1), -1); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 7; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(((PyObject *)__pyx_t_1)); __pyx_t_1 = 0;
  __pyx_t_1 = PyObject_GetAttr(__pyx_t_2, __pyx_n_s__csr_matrix); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 7; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  ...
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_1 = PyObject_GetAttr(__pyx_t_2, __pyx_n_s__isspmatrix_csc); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 7; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  ...
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_1 = PyObject_GetAttr(__pyx_t_2, __pyx_n_s__isspmatrix); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 7; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  ...
  /* "scipy/sparse/csgraph/graph_min_spanning_tree.pyx":9
 * from scipy.sparse import csr_matrix, isspmatrix_csc, isspmatrix
 * 
 * DTYPE = np.float64             # <<<<<<<<<<<<<<
 * ctypedef np.float64_t DTYPE_t
 * 
 */
  __pyx_t_2 = __Pyx_GetName(__pyx_m, __pyx_n_s__np); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 9; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_1 = PyObject_GetAttr(__pyx_t_2, __pyx_n_s__float64); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 9; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  if (PyObject_SetAttr(__pyx_m, __pyx_n_s__DTYPE, __pyx_t_1) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 9; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;

  /* "scipy/sparse/csgraph/graph_min_spanning_tree.pyx":12
 * ctypedef np.float64_t DTYPE_t
 * 
 * ITYPE = np.int32             # <<<<<<<<<<<<<<
 * ctypedef np.int32_t ITYPE_t
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  if (PyObject_SetAttr(__pyx_m, __pyx_n_s__ITYPE, __pyx_t_2) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 12; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;

  /* "scipy/sparse/csgraph/graph_min_spanning_tree.pyx":15
 * ctypedef np.int32_t ITYPE_t
 * 
 * cdef ITYPE_t NULL_IDX = -9999             # <<<<<<<<<<<<<<
 * 
 * def cs_graph_minimum_spanning_tree(csgraph, overwrite=False):
 */
  __pyx_v_5scipy_6sparse_7csgraph_23graph_min_spanning_tree_NULL_IDX = -9999;
 ...
 */
  ...
  __Pyx_GIVEREF(__pyx_t_2);
  __pyx_t_2 = 0;
  __pyx_t_2 = PyCFunction_NewEx(&__pyx_mdef_5scipy_6sparse_7csgraph_23graph_min_spanning_tree_cs_graph_minimum_spanning_tree, NULL, __pyx_n_s_17); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 17; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  if (PyObject_SetAttr(__pyx_m, __pyx_n_s_18, __pyx_t_2) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 17; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;

  /* "scipy/sparse/csgraph/graph_min_spanning_tree.pyx":1
 ...
 */
  ...
  __Pyx_XDECREF(__pyx_t_2);
  if (__pyx_m) {
    __Pyx_AddTraceback("init scipy.sparse.csgraph.graph_min_spanning_tree", __pyx_clineno, __pyx_lineno, __pyx_filename);
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init scipy.sparse.csgraph.graph_min_spanning_tree");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if PY_MAJOR_VERSION < 3
