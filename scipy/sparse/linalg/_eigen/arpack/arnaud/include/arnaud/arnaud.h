...
struct ARNAUD_state_s {
    ...
    ARNAUD_INT info;                /** problem outcome,                 input/output          */
    ARNAUD_INT bmat;                /** problem parameter, boolean       input                 */
    ARNAUD_INT mode;         /** problem parameter,               input                 */
    ARNAUD_INT n;            /** problem parameter,               input                 */
    ARNAUD_INT ncv;          /** problem parameter,               input                 */
    ARNAUD_INT nev;          /** problem parameter,               input                 */
    ARNAUD_INT shift;        /** problem parameter, boolean       input                 */
    ARNAUD_INT maxiter;      /** problem parameter,               input                 */
    ARNAUD_INT nconv;        /** problem outcome,                 output                */
    ARNAUD_INT iter;         /** problem intermediate,            internal              */
    ARNAUD_INT np;           /** problem intermediate,            internal              */
    ARNAUD_INT getv0_first;  /** getv0 flow control               internal              */
    ARNAUD_INT getv0_iter;   /** getv0 flow control               internal              */
    ARNAUD_INT getv0_itry;   /** getv0 flow control               internal              */
    ARNAUD_INT getv0_orth;   /** getv0 flow control               internal              */
    ARNAUD_INT aitr_iter;    /** naitr flow control               internal              */
    ARNAUD_INT aitr_j;       /** naitr flow control               internal              */
    ARNAUD_INT aitr_orth1;   /** naitr flow control               internal              */
    ARNAUD_INT aitr_orth2;   /** naitr flow control               internal              */
    ARNAUD_INT aitr_restart; /** naitr flow control               internal              */
    ARNAUD_INT aitr_step3;   /** naitr flow control               internal              */
    ARNAUD_INT aitr_step4;   /** naitr flow control               internal              */
    ARNAUD_INT aitr_ierr;    /** naitr flow control               internal              */
    ARNAUD_INT aup2_initv;   /** naupd2 flow control              internal              */
    ARNAUD_INT aup2_iter;    /** naupd2 flow control              internal              */
    ARNAUD_INT aup2_getv0;   /** naupd2 flow control              internal              */
    ARNAUD_INT aup2_cnorm;   /** naupd2 flow control              internal              */
    ARNAUD_INT aup2_kplusp;  /** naupd2 flow control              internal              */
    ARNAUD_INT aup2_nev;     /** naupd2 working nev variable      internal              */
    ARNAUD_INT aup2_nev0;    /** naupd2 internal compute          internal              */
    ARNAUD_INT aup2_np0;     /** naupd2 internal compute          internal              */
    ARNAUD_INT aup2_numcnv;  /** naupd2 internal compute          internal              */
    ARNAUD_INT aup2_update;  /** naupd2 flow control              internal              */
    ARNAUD_INT aup2_ushift;  /** naupd2 flow control              internal              */
};
 ...
 */
void ARNAUD_snaupd(struct ARNAUD_state_s *V, float* resid, float* v, ARNAUD_INT ldv, ARNAUD_INT* ipntr, float* workd, float* workl);
 ...
 */
void ARNAUD_dnaupd(struct ARNAUD_state_d *V, double* resid, double* v, ARNAUD_INT ldv, ARNAUD_INT* ipntr, double* workd, double* workl);
 ...
 */
void ARNAUD_cnaupd(struct ARNAUD_state_s *V, ARNAUD_CPLXF_TYPE* resid, ARNAUD_CPLXF_TYPE* v, ARNAUD_INT ldv, ARNAUD_INT* ipntr, ARNAUD_CPLXF_TYPE* workd, ARNAUD_CPLXF_TYPE* workl, float* rwork);
 ...
 */
void ARNAUD_znaupd(struct ARNAUD_state_d *V, ARNAUD_CPLX_TYPE* resid, ARNAUD_CPLX_TYPE* v, ARNAUD_INT ldv, ARNAUD_INT* ipntr, ARNAUD_CPLX_TYPE* workd, ARNAUD_CPLX_TYPE* workl, double* rwork);
 ...
 */
void ARNAUD_sneupd(struct ARNAUD_state_s *V, ARNAUD_INT rvec, ARNAUD_INT howmny, ARNAUD_INT* select, float* dr, float* di, float* z, ARNAUD_INT ldz, float sigmar, float sigmai, float* workev, float* resid, float* v, ARNAUD_INT ldv, ARNAUD_INT* ipntr, float* workd, float* workl);
 ...
 */
void ARNAUD_dneupd(struct ARNAUD_state_d *V, ARNAUD_INT rvec, ARNAUD_INT howmny, ARNAUD_INT* select, double* dr, double* di, double* z, ARNAUD_INT ldz, double sigmar, double sigmai, double* workev, double* resid, double* v, ARNAUD_INT ldv, ARNAUD_INT* ipntr, double* workd, double* workl);
 ...
 * @param rwork    Work array, float, >= 3*ncv; additional workspace for real valued computations (input/output).
 */
void ARNAUD_cneupd(struct ARNAUD_state_s *V, ARNAUD_INT rvec, ARNAUD_INT howmny, ARNAUD_INT* select, ARNAUD_CPLXF_TYPE* d, ARNAUD_CPLXF_TYPE* z, ARNAUD_INT ldz, ARNAUD_CPLXF_TYPE sigma, ARNAUD_CPLXF_TYPE* workev, ARNAUD_CPLXF_TYPE* resid, ARNAUD_CPLXF_TYPE* v, ARNAUD_INT ldv, ARNAUD_INT* ipntr, ARNAUD_CPLXF_TYPE* workd, ARNAUD_CPLXF_TYPE* workl, float* rwork);
 ...
 * @param rwork    Work array, float, >= 3*ncv; additional workspace for real valued computations (input/output).
 */
void ARNAUD_zneupd(struct ARNAUD_state_d *V, ARNAUD_INT rvec, ARNAUD_INT howmny, ARNAUD_INT* select, ARNAUD_CPLX_TYPE* d, ARNAUD_CPLX_TYPE* z, ARNAUD_INT ldz, ARNAUD_CPLX_TYPE sigma, ARNAUD_CPLX_TYPE* workev, ARNAUD_CPLX_TYPE* resid, ARNAUD_CPLX_TYPE* v, ARNAUD_INT ldv, ARNAUD_INT* ipntr, ARNAUD_CPLX_TYPE* workd, ARNAUD_CPLX_TYPE* workl, double* rwork);
 ...
 */
void ARNAUD_ssaupd(struct ARNAUD_state_s *V, float* resid, float* v, ARNAUD_INT ldv, ARNAUD_INT* ipntr, float* workd, float* workl);
 ...
 */
void ARNAUD_dsaupd(struct ARNAUD_state_d *V, double* resid, double* v, ARNAUD_INT ldv, ARNAUD_INT* ipntr, double* workd, double* workl);
 ...
 */
void ARNAUD_sseupd(struct ARNAUD_state_s *V, ARNAUD_INT rvec, ARNAUD_INT howmny, ARNAUD_INT* select, float* d, float* z, ARNAUD_INT ldz, float sigma, float* resid, float* v, ARNAUD_INT ldv, ARNAUD_INT* ipntr, float* workd, float* workl);
 ...
 */
void ARNAUD_dseupd(struct ARNAUD_state_d *V, ARNAUD_INT rvec, ARNAUD_INT howmny, ARNAUD_INT* select, double* d, double* z, ARNAUD_INT ldz, double sigma, double* resid, double* v, ARNAUD_INT ldv, ARNAUD_INT* ipntr, double* workd, double* workl);
