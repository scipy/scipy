...
static ARNAUD_CPLX_TYPE ARNAUD_BLAS(zdotc)(const ARNAUD_INT* n, const ARNAUD_CPLX_TYPE* restrict x, const ARNAUD_INT* incx, const ARNAUD_CPLX_TYPE* restrict y, const ARNAUD_INT* incy);
static void zgetv0(struct ARNAUD_state_d*, ARNAUD_INT, ARNAUD_INT, ARNAUD_INT, ARNAUD_CPLX_TYPE*, ARNAUD_INT, ARNAUD_CPLX_TYPE*, double*, ARNAUD_INT*, ARNAUD_CPLX_TYPE*);
static void znaup2(struct ARNAUD_state_d*, ARNAUD_CPLX_TYPE* , ARNAUD_CPLX_TYPE*, ARNAUD_INT, ARNAUD_CPLX_TYPE*, ARNAUD_INT, ARNAUD_CPLX_TYPE*, ARNAUD_CPLX_TYPE*, ARNAUD_CPLX_TYPE*, ARNAUD_INT, ARNAUD_CPLX_TYPE*, ARNAUD_INT*, ARNAUD_CPLX_TYPE*, double*);
static void znaitr(struct ARNAUD_state_d*, ARNAUD_INT, ARNAUD_INT, ARNAUD_CPLX_TYPE*, double*, ARNAUD_CPLX_TYPE*, ARNAUD_INT, ARNAUD_CPLX_TYPE*, ARNAUD_INT, ARNAUD_INT*, ARNAUD_CPLX_TYPE*);
static void znapps(ARNAUD_INT, ARNAUD_INT*, ARNAUD_INT, ARNAUD_CPLX_TYPE*, ARNAUD_CPLX_TYPE*, ARNAUD_INT, ARNAUD_CPLX_TYPE*, ARNAUD_INT, ARNAUD_CPLX_TYPE*, ARNAUD_CPLX_TYPE*, ARNAUD_INT, ARNAUD_CPLX_TYPE*, ARNAUD_CPLX_TYPE*);
...
void
ARNAUD_zneupd(struct ARNAUD_state_d *V, ARNAUD_INT rvec, ARNAUD_INT howmny, ARNAUD_INT* select,
       ARNAUD_CPLX_TYPE* d, ARNAUD_CPLX_TYPE* z, ARNAUD_INT ldz, ARNAUD_CPLX_TYPE sigma,
       ARNAUD_CPLX_TYPE* workev, ARNAUD_CPLX_TYPE* resid, ARNAUD_CPLX_TYPE* v, ARNAUD_INT ldv,
       ARNAUD_INT* ipntr, ARNAUD_CPLX_TYPE* workd, ARNAUD_CPLX_TYPE* workl, double* rwork)
{
    ...
    if (rvec) {
        ...
        for (j = 1; j <= V->ncv; j++)
        {
            ...
            jj = (ARNAUD_INT)creal(workl[bounds + V->ncv - j]);
        ...
        tmp_int = ldh*V->ncv;
        ARNAUD_BLAS(zcopy)(&tmp_int, &workl[ih], &int1, &workl[iuptri], &int1);
        ARNAUD_BLAS(zlaset)("A", &V->ncv, &V->ncv, &cdbl0, &cdbl1, &workl[invsub], &ldq);
        ARNAUD_BLAS(zlahqr)(&int1, &int1, &V->ncv, &int1, &V->ncv, &workl[iuptri], &ldh,
                &workl[iheig], &int1, &V->ncv, &workl[invsub], &ldq, &ierr);
        ARNAUD_BLAS(zcopy)(&V->ncv, &workl[invsub + V->ncv - 1], &ldq, &workl[ihbds], &int1);
        ...
        if (reord)
        {
            ...
            ARNAUD_BLAS(ztrsen)("N", "V", select, &V->ncv, &workl[iuptri], &ldh, &workl[invsub], &ldq,
        ...
        if (TYP == REGULAR)
        {
            ARNAUD_BLAS(zcopy)(&V->nconv, &workl[iheig], &int1, d, &int1);
        }
        ...
        ARNAUD_BLAS(zgeqr2)(&V->ncv, &V->nconv, &workl[invsub], &ldq, workev, &workev[V->ncv], &ierr);
        ...
        ARNAUD_BLAS(zunm2r)("R", "N", &V->n, &V->ncv, &V->nconv, &workl[invsub], &ldq, workev, v, &ldv, &workd[V->n], &ierr);
        ARNAUD_BLAS(zlacpy)("A", &V->n, &V->nconv, v, &ldv, z, &ldz);
        ...
        for (ARNAUD_INT j = 0; j < V->nconv; j++)
        {
            ...
            {
                ARNAUD_BLAS(zscal)(&V->nconv, &cdblm1, &workl[iuptri + j], &ldq);
                ARNAUD_BLAS(zscal)(&V->nconv, &cdblm1, &workl[iuptri + j*ldq], &int1);
            }
        }
        // 20
        ...
        if (howmny == 0)
        {
            ...
            ARNAUD_BLAS(ztrevc)("R", "S", select, &V->ncv, &workl[iuptri], &ldq, vl, &int1,
            ...
            for (j = 0; j < V->nconv; j++)
            {
                rtemp = 1.0 / ARNAUD_BLAS(dznrm2)(&V->ncv, &workl[invsub + j*ldq], &int1);
                ARNAUD_BLAS(zdscal)(&V->ncv, &rtemp, &workl[invsub + j*ldq], &int1);
                ...
                tmp_int = j + 1;
                workev[j] = ARNAUD_BLAS(zdotc)(&tmp_int, &workl[ihbds], &int1, &workl[invsub + j*ldq], &int1);
            }
            // 40

            //  Copy Ritz estimates into workl(ihbds)

            ARNAUD_BLAS(zcopy)(&V->nconv, workev, &int1, &workl[ihbds], &int1);

            //  The eigenvector mactirx Q of T is triangular. Form Z*Q

            ARNAUD_BLAS(ztrmm)("R", "U", "N", "N", &V->n, &V->nconv, &cdbl1, &workl[invsub], &ldq, z, &ldz);
        ...
        ARNAUD_BLAS(zcopy)(&V->nconv, &workl[ritz], &int1, d, &int1);
        ARNAUD_BLAS(zcopy)(&V->nconv, &workl[ritz], &int1, &workl[iheig], &int1);
        ARNAUD_BLAS(zcopy)(&V->nconv, &workl[bounds], &int1, &workl[ihbds], &int1);
    ...
    if (TYP == REGULAR)
    {
        if (rvec)
        {
            ARNAUD_BLAS(zscal)(&V->ncv, &rnorm, &workl[ihbds], &int1);
        }
    } else {
    ...
    if ((rvec) && (howmny == 0) && (TYP == SHIFTI))
    {
        ...
        ARNAUD_BLAS(zgeru)(&V->n, &V->nconv, &cdbl1, resid, &int1, workev, &int1, z, &ldz);
    }
...
ARNAUD_znaupd(struct ARNAUD_state_d *V, ARNAUD_CPLX_TYPE* resid,
       ARNAUD_CPLX_TYPE* v, ARNAUD_INT ldv, ARNAUD_INT* ipntr, ARNAUD_CPLX_TYPE* workd,
...
znaup2(struct ARNAUD_state_d *V, ARNAUD_CPLX_TYPE* resid,
       ARNAUD_CPLX_TYPE* v, ARNAUD_INT ldv, ARNAUD_CPLX_TYPE* h, ARNAUD_INT ldh,
       ARNAUD_CPLX_TYPE* ritz, ARNAUD_CPLX_TYPE* bounds,
       ARNAUD_CPLX_TYPE* q, ARNAUD_INT ldq, ARNAUD_CPLX_TYPE* workl, ARNAUD_INT* ipntr,
...
LINE20:
    ...
    ARNAUD_BLAS(zcopy)(&V->aup2_kplusp, ritz, &int1, &workl[tmp_int], &int1);
    tmp_int += V->aup2_kplusp;
    ARNAUD_BLAS(zcopy)(&V->aup2_kplusp, bounds, &int1, &workl[tmp_int], &int1);
...
LINE50:
    ...
    if (V->shift != 1)
    {
        ...
        ARNAUD_BLAS(zcopy)(&V->np, workl, &int1, ritz, &int1);
    }
    ...
    if (V->bmat)
    {
        ARNAUD_BLAS(zcopy)(&V->n, resid, &int1, &workd[V->n], &int1);
        ipntr[0] = V->n;
        ipntr[1] = 0;
        V->ido = ido_BX;
        ...
        ARNAUD_BLAS(zcopy)(&V->n, resid, &int1, workd, &int1);
    }
...
LINE100:
    ...
    if (V->bmat)
    {
        V->aup2_rnorm = sqrt(cabs(ARNAUD_BLAS(zdotc)(&V->n, resid, &int1, workd, &int1)));
    } else {
        V->aup2_rnorm = ARNAUD_BLAS(dznrm2)(&V->n, resid, &int1);
    }
    V->aup2_cnorm = 0;
...
static void
znaitr(struct ARNAUD_state_d *V, ARNAUD_INT k, ARNAUD_INT np, ARNAUD_CPLX_TYPE* resid,
       double* rnorm, ARNAUD_CPLX_TYPE* v, ARNAUD_INT ldv, ARNAUD_CPLX_TYPE* h, ARNAUD_INT ldh,
       ARNAUD_INT* ipntr, ARNAUD_CPLX_TYPE* workd)
{
...
LINE40:
    ...
    ARNAUD_BLAS(zcopy)(&n, resid, &int1, &v[ldv*V->aitr_j], &int1);

    if (*rnorm >= unfl)
    {
        temp1 = 1.0 / *rnorm;
        ARNAUD_BLAS(zdscal)(&n, &temp1, &v[ldv*V->aitr_j], &int1);
        ARNAUD_BLAS(zdscal)(&n, &temp1, &workd[ipj], &int1);
    } else {
        ARNAUD_BLAS(zlascl)("G", &i, &i, rnorm, &dbl1, &n, &int1, &v[ldv*V->aitr_j], &n, &infol);
        ARNAUD_BLAS(zlascl)("G", &i, &i, rnorm, &dbl1, &n, &int1, &workd[ipj], &n, &infol);
    }
    ...
    V->aitr_step3 = 1;
    ARNAUD_BLAS(zcopy)(&n, &v[ldv*(V->aitr_j)], &int1, &workd[ivj], &int1);
    ipntr[0] = ivj;
    ipntr[1] = irj;
    ipntr[2] = ipj;
    V->ido = ido_OPX;
...
LINE50:
    ...
    ARNAUD_BLAS(zcopy)(&n, &workd[irj], &int1, resid, &int1);
    ...
    if (V->bmat)
    {
        ...
        ARNAUD_BLAS(zcopy)(&n, resid, &int1, &workd[ipj], &int1);
    }
...
LINE60:
    ...
    if (V->bmat)
    {
        V->aitr_wnorm = sqrt(cabs(ARNAUD_BLAS(zdotc)(&n, resid, &int1, &workd[ipj], &int1)));
    } else {
        V->aitr_wnorm = ARNAUD_BLAS(dznrm2)(&n, resid, &int1);
    }
    ...
    tmp_int = V->aitr_j + 1;
    ARNAUD_BLAS(zgemv)("C", &n, &tmp_int, &cdbl1, v, &ldv, &workd[ipj], &int1, &cdbl0, &h[ldh*(V->aitr_j)], &int1);

    //  Orthogonalize r_{j} against V_{j}.
    //  RESID contains OP*v_{j}. See STEP 3.

    ARNAUD_BLAS(zgemv)("N", &n, &tmp_int, &cdblm1, v, &ldv, &h[ldh*(V->aitr_j)], &int1, &cdbl1, resid, &int1);
    ...
    if (V->bmat)
    {
        ARNAUD_BLAS(zcopy)(&n, resid, &int1, &workd[irj], &int1);
        ipntr[0] = irj;
        ipntr[1] = ipj;
        V->ido = ido_BX;
...
LINE70:
    ...
    if (V->bmat)
    {
        *rnorm = sqrt(cabs(ARNAUD_BLAS(zdotc)(&n, resid, &int1, &workd[ipj], &int1)));
    } else {
        *rnorm = ARNAUD_BLAS(dznrm2)(&n, resid, &int1);
    }
...
LINE80:
    ...
    tmp_int = V->aitr_j + 1;
    ARNAUD_BLAS(zgemv)("C", &n, &tmp_int, &cdbl1, v, &ldv, &workd[ipj], &int1, &cdbl0, &workd[irj], &int1);
    ...
    ARNAUD_BLAS(zgemv)("N", &n, &tmp_int, &cdblm1, v, &ldv, &workd[irj], &int1, &cdbl1, resid, &int1);
    ARNAUD_BLAS(zaxpy)(&tmp_int, &cdbl1, &workd[irj], &int1, &h[ldh*(V->aitr_j)], &int1);
...
LINE90:
    ...
    if (V->bmat)
    {
        V->aitr_rnorm1 = sqrt(cabs(ARNAUD_BLAS(zdotc)(&n, resid, &int1, &workd[ipj], &int1)));
    } else {
        V->aitr_rnorm1 = ARNAUD_BLAS(dznrm2)(&n, resid, &int1);
    }
    ...
    if (V->aitr_j >= k + np)
    {
        ...
        for (i = (k > 0 ? k-1 : k); i < k + np - 1; i++)
        {
            ...
            if (tst1 == 0.0)
            {
                ...
                tst1 = ARNAUD_BLAS(zlanhs)("1", &tmp_int, h, &ldh, (double*)&workd[n]);
            }
...
static void
znapps(ARNAUD_INT n, ARNAUD_INT* kev, ARNAUD_INT np, ARNAUD_CPLX_TYPE* shift, ARNAUD_CPLX_TYPE* v,
       ARNAUD_INT ldv, ARNAUD_CPLX_TYPE* h, ARNAUD_INT ldh, ARNAUD_CPLX_TYPE* resid,
       ARNAUD_CPLX_TYPE* q, ARNAUD_INT ldq, ARNAUD_CPLX_TYPE* workl,
       ARNAUD_CPLX_TYPE* workd)
{
    ...
    ARNAUD_BLAS(zlaset)("G", &kplusp, &kplusp, &cdbl0, &cdbl1, q, &ldq);
    ...
    for (jj = 0; jj < np; jj++)
    {
        ...
        while (istart < kplusp - 1)
        {
            for  (iend = istart; iend < kplusp - 1; iend++)
            {
                ...
                {
                    tmp_int = kplusp - jj;
                    ARNAUD_BLAS(zlanhs)("1", &tmp_int, h, &ldh, (double*)workl);
                }
            ...
            for (i = istart; i < iend; i++)
            {
                ...
                tmp_int = kplusp - i;
                ARNAUD_BLAS(zrot)(&tmp_int, &h[i + ldh*i], &ldh, &h[i + 1 + ldh*i], &ldh, &c, &s);
                // z = a + bi, -conj(z) = -a + bi
                s2 = conj(s);
                tmp_int = (i + 2 > iend ? iend : i + 2) + 1;
                ARNAUD_BLAS(zrot)(&tmp_int, &h[ldh*i], &int1, &h[ldh*(i+1)], &int1, &c, &s2);
                tmp_int = (i + jj + 2 > kplusp ? kplusp : i + jj + 2);
                ARNAUD_BLAS(zrot)(&tmp_int, &q[ldq*i], &int1, &q[ldq*(i+1)], &int1, &c, &s2);
    ...
    for (j = 0; j < *kev; j++)
    {
        if ((creal(h[j+1 + ldh*j]) < 0.0) || (cimag(h[j+1 + ldh*j]) != 0.0))
        {
            ...
            tmp_cplx = conj(t);
            tmp_int = kplusp - j;
            ARNAUD_BLAS(zscal)(&tmp_int, &tmp_cplx, &h[j+1 + ldh*j], &ldh);

            tmp_int = (j+3 > kplusp ? kplusp : j+3);
            ARNAUD_BLAS(zscal)(&tmp_int, &t, &h[ldh*(j+1)], &int1);

            tmp_int = (j+np+2 > kplusp ? kplusp : j+np+2);
            ARNAUD_BLAS(zscal)(&tmp_int, &t, &q[ldq*(j+1)], &int1);
    ...
    for (i = 0; i < *kev; i++)
    {
        ...
        if (tst1 == 0.0)
        {
            tst1 = ARNAUD_BLAS(zlanhs)("1", kev, h, &ldh, (double*)workl);
        }
    ...
    {
        ARNAUD_BLAS(zgemv)("N", &n, &kplusp, &cdbl1, v, &ldv, &q[(*kev)*ldq], &int1, &cdbl0, &workd[n], &int1);
    }
    ...
    {
        tmp_int = kplusp - i;
        ARNAUD_BLAS(zgemv)("N", &n, &tmp_int, &cdbl1, v, &ldv, &q[(*kev-i-1)*ldq], &int1, &cdbl0, workd, &int1);
        ARNAUD_BLAS(zcopy)(&n, workd, &int1, &v[(kplusp-i-1)*ldv], &int1);
    }

    //   Move v(:,kplusp-kev+1:kplusp) into v(:,1:kev).

    ARNAUD_BLAS(zlacpy)("A", &n, kev, &v[ldv*(kplusp - *kev)], &ldv, v, &ldv);

    //  Copy the (kev+1)-st column of (V*Q) in the appropriate place

    if (creal(h[*kev + ldh*(*kev-1)]) > 0.0) {
        ARNAUD_BLAS(zcopy)(&n, &workd[n], &int1, &v[ldv*(*kev)], &int1);
    }
    ...
    ARNAUD_BLAS(zscal)(&n, &q[kplusp-1 + ldq*(*kev-1)], resid, &int1);

    if (creal(h[*kev + ldh*(*kev-1)]) > 0.0)
    {
        ARNAUD_BLAS(zaxpy)(&n, &h[*kev + ldh*(*kev-1)], &v[ldv*(*kev)], &int1, resid, &int1);
    }
...
static void
zneigh(double* rnorm, ARNAUD_INT n, ARNAUD_CPLX_TYPE* h, ARNAUD_INT ldh, ARNAUD_CPLX_TYPE* ritz,
       ARNAUD_CPLX_TYPE* bounds, ARNAUD_CPLX_TYPE* q, ARNAUD_INT ldq, ARNAUD_CPLX_TYPE* workl,
       double* rwork, ARNAUD_INT* ierr)
{
    ...
    ARNAUD_BLAS(zlacpy)("A", &n, &n, h, &ldh, workl, &n);
    ARNAUD_BLAS(zlaset)("A", &n, &n, &c0, &c1, q, &ldq);
    ARNAUD_BLAS(zlahqr)(&int1, &int1, &n, &int1, &n, workl, &ldh, ritz, &int1, &n, q, &ldq, ierr);

    if (*ierr != 0) { return; }

    ARNAUD_BLAS(zcopy)(&n, &q[n-2], &ldq, bounds, &int1);

    //  2. Compute the eigenvectors of the full Schur form T and
    //     apply the Schur vectors to get the corresponding
    //     eigenvectors.

    ARNAUD_BLAS(ztrevc)("R", "B", select, &n, workl, &n, vl, &n, q, &ldq, &n, &n, &workl[n*n], rwork, ierr);
    ...
    for (j = 0; j < n; j++)
    {
        temp = 1.0 / ARNAUD_BLAS(dznrm2)(&n, &q[j*ldq], &int1);
        ARNAUD_BLAS(zdscal)(&n, &temp, &q[j*ldq], &int1);
    }

    //  Compute the Ritz estimates

    ARNAUD_BLAS(zcopy)(&n, &q[n-1], &n, bounds, &int1);
    ARNAUD_BLAS(zdscal)(&n, rnorm, bounds, &int1);
...
static void
zngets(struct ARNAUD_state_d *V, ARNAUD_INT* kev, ARNAUD_INT* np,
       ARNAUD_CPLX_TYPE* ritz, ARNAUD_CPLX_TYPE* bounds)
{
...
static void
zgetv0(struct ARNAUD_state_d *V, ARNAUD_INT initv, ARNAUD_INT n, ARNAUD_INT j,
       ARNAUD_CPLX_TYPE* v, ARNAUD_INT ldv, ARNAUD_CPLX_TYPE* resid, double* rnorm,
       ARNAUD_INT* ipntr, ARNAUD_CPLX_TYPE* workd)
{
    ...
    if (V->ido == ido_RANDOM)
    {
        ...
        if (V->getv0_itry == 1)
        {
            ipntr[0] = 0;
            ipntr[1] = n;
            ARNAUD_BLAS(zcopy)(&n, resid, &int1, workd, &int1);
            V->ido = ido_RANDOM_OPX;
            return;
        } else if ((V->getv0_itry > 1) && (V->bmat == 1))
        {
            ARNAUD_BLAS(zcopy)(&n, resid, &int1, &workd[n], &int1);
        }
    }
    ...
    if (V->getv0_itry == 1)
    {
        ARNAUD_BLAS(zcopy)(&n, &workd[n], &int1, resid, &int1);
    }
    if (V->bmat)
    {
        ipntr[0] = n;
...
LINE20:
    ...
    if (V->bmat)
    {
        V->getv0_rnorm0 = sqrt(cabs(ARNAUD_BLAS(zdotc)(&n, resid, &int1, workd, &int1)));
    } else {
        V->getv0_rnorm0 = ARNAUD_BLAS(dznrm2)(&n, resid, &int1);
    }
...
LINE30:
    ...
    ARNAUD_BLAS(zgemv)("C", &n, &j, &c1, v, &ldv, workd, &int1, &c0, &workd[n], &int1);
    ARNAUD_BLAS(zgemv)("N", &n, &j, &cm1, v, &ldv, &workd[n], &int1, &c1, resid, &int1);
...
LINE40:
    ...
    if (V->bmat)
    {
        *rnorm = sqrt(cabs(ARNAUD_BLAS(zdotc)(&n, resid, &int1, workd, &int1)));
    } else {
        *rnorm = ARNAUD_BLAS(dznrm2)(&n, resid, &int1);
    }
...
static void
zsortc(const enum ARNAUD_which w, const ARNAUD_INT apply, const ARNAUD_INT n, ARNAUD_CPLX_TYPE* x, ARNAUD_CPLX_TYPE* y)
{
...
ARNAUD_BLAS(zdotc)(const ARNAUD_INT* n, const ARNAUD_CPLX_TYPE* restrict x, const ARNAUD_INT* incx, const ARNAUD_CPLX_TYPE* restrict y, const ARNAUD_INT* incy)
{
