...
c in veclib_cabi.c
      ...
      EXTERNAL ACC_SDOT
      REAL ACC_SDOT
      WSDOT = ACC_SDOT( N, SX, INCX, SY, INCY )
      END FUNCTION
      ...
      EXTERNAL ACC_SDSDOT
      REAL ACC_SDSDOT
      WSDSDOT = ACC_SDSDOT( N, SB, SX, INCX, SY, INCY )
      END FUNCTION
