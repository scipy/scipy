...
c        %----------------------------------------------------%
c
         call scopy(kplusp, ritzr, 1, workl(kplusp2+1), 1)
         call scopy(kplusp, ritzi, 1, workl(kplusp2+kplusp+1), 1)
         call scopy(kplusp, bounds, 1, workl(kplusp2+2*kplusp+1), 1)
c
c        %---------------------------------------------------%
...
c
            if (msglvl .gt. 4) then
               call svout(logfil, kplusp, workl(kplusp2+1), ndigit,
     &             '_naup2: Real part of the eig computed by _neigh:')
               call svout(logfil, kplusp, workl(kplusp2+kplusp+1),
     &                     ndigit,
     &             '_naup2: Imag part of the eig computed by _neigh:')
               call svout(logfil, kplusp, workl(kplusp2+kplusp*2+1),
     &                     ndigit,
