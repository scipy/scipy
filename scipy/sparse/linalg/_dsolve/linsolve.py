...
def splu(A, permc_spec=None, diag_pivot_thresh=None,
    ...
    Notes
    -----
    When a real array is factorized and the returned SuperLU object ``solve()`` method is
    used with complex arguments an error is generated. Instead cast the initial matrix
    to complex and then factorize.
