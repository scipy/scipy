...
PyObject *scipy_signal__sigtools_linear_filter(PyObject *NPY_UNUSED(dummy), PyObject *args);

PyObject *scipy_signal__sigtools_correlateND(PyObject *NPY_UNUSED(dummy), PyObject *args);

void scipy_signal__sigtools_linear_filter_module_init(void);
...
static void RawFilter(Generic_Vector, Generic_Vector, Generic_Array, Generic_Array, Generic_Array *, Generic_Array *,
BasicFilterFunction *, int);
*/
