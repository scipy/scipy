...
class TestMedFilt(TestCase):
    ...
    def test_basic(self):
        ...
        d = signal.medfilt(f, [7, 3], reflect=False)
        e = signal.medfilt2d(np.array(f, np.float), [7, 3], reflect=False)
    ...
    def test_reflect(self):
        ...
        d = signal.medfilt(f, [7, 3], reflect=True)
        e = signal.medfilt2d(np.array(f, np.float), [7, 3], reflect=True)
        assert_array_equal(d, [[50, 50, 50, 50, 50, 47, 42, 64, 65, 66],
                               [50, 50, 50, 50, 50, 47, 42, 47, 65, 66],
                               [50, 50, 50, 50, 50, 50, 46, 61, 65, 66],
                               [50, 50, 50, 50, 50, 50, 42, 47, 64, 65],
                               [50, 50, 50, 50, 50, 50, 46, 55, 64, 66],
                               [50, 50, 50, 50, 50, 47, 46, 43, 55, 61],
                               [50, 50, 50, 50, 50, 47, 46, 45, 55, 45],
                               [50, 46, 50, 50, 50, 47, 47, 45, 55, 45],
                               [33, 44, 53, 53, 60, 60, 55, 55, 55, 45],
                               [33, 44, 46, 53, 47, 47, 47, 45, 55, 45]])
        assert_array_equal(d, e)
