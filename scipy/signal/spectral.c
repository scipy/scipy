/* Generated by Cython 0.15 on Tue Nov  1 18:19:21 2011 */
...
static PyObject *__pyx_pf_5scipy_6signal_8spectral_lombscargle(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static char __pyx_doc_5scipy_6signal_8spectral_lombscargle[] = "Computes the Lomb-Scargle periodogram.\n    \n    The Lomb-Scargle periodogram was developed by Lomb [1]_ and further\n    extended by Scargle [2]_ to find, and test the significance of weak\n    periodic signals with uneven temporal sampling.\n\n    The computed periodogram is unnormalized, it takes the value\n    ``(A**2) * N/4`` for a harmonic signal with amplitude A for sufficiently\n    large N.\n\n    Parameters\n    ----------\n    x : array_like\n        Sample times.\n    y : array_like\n        Measurement values.\n    freqs : array_like\n        Angular frequencies for output periodogram.\n\n    Returns\n    -------\n    pgram : array_like\n        Lomb-Scargle periodogram.\n\n    Raises\n    ------\n    ValueError\n        If the input arrays `x` and `y` do not have the same shape.\n\n    Notes\n    -----\n    This subroutine calculates the periodogram using a slightly\n    modified algorithm due to Townsend [3]_ which allows the\n    periodogram to be calculated using only a single pass through\n    the input arrays for each frequency.\n\n    The algorithm running time scales roughly as O(x * freqs) or O(N^2)\n    for a large number of samples and frequencies.\n\n    References\n    ----------\n    .. [1] N.R. Lomb \"Least-squares frequency analysis of unequally spaced\n    data\", Astrophysics and Space Science, vol 39, pp. 447-462, 1976\n\n    .. [2] J.D. Scargle \"Studies in astronomical time series analysis. II - \n    Statistical aspects of spectral analysis of unevenly spaced data\",\n    The Astrophysical Journal, vol 263, pp. 835-853, 1982\n\n    .. [3] R.H.D. Townsend, \"Fast calculation of the Lomb-Scargle\n    periodogram using graphics processing units.\", The Astrophysical\n    Journal Supplement Series, vol 191, pp. 247-253, 2010\n\n    Examples\n    --------\n    >>> import scipy.signal\n\n    First define some input parameters for the signal:\n\n    >>> A = 2.\n    >>> w = 1.\n    >>> phi = 0.5 * np.pi\n    >>> nin = 1000\n    >>> nout ="" 100000\n    >>> frac_points = 0.9 # Fraction of points to select\n     \n    Randomly select a fraction of an array with timesteps:\n\n    >>> r = np.random.rand(nin)\n    >>> x = np.linspace(0.01, 10*np.pi, nin)\n    >>> x = x[r >= frac_points]\n    >>> normval = x.shape[0] # For normalization of the periodogram\n     \n    Plot a sine wave for the selected times:\n\n    >>> y = A * np.sin(w*x+phi)\n\n    Define the array of frequencies for which to compute the periodogram:\n    \n    >>> f = np.linspace(0.01, 10, nout)\n     \n    Calculate Lomb-Scargle periodogram:\n\n    >>> pgram = sp.signal.lombscargle(x, y, f)\n\n    Now make a plot of the input data:\n\n    >>> plt.subplot(2, 1, 1)\n    <matplotlib.axes.AxesSubplot object at 0x102154f50>\n    >>> plt.plot(x, y, 'b+')\n    [<matplotlib.lines.Line2D object at 0x102154a10>]\n\n    Then plot the normalized periodogram:\n\n    >>> plt.subplot(2, 1, 2)\n    <matplotlib.axes.AxesSubplot object at 0x104b0a990>\n    >>> plt.plot(f, np.sqrt(4*(pgram/normval)))\n    [<matplotlib.lines.Line2D object at 0x104b2f910>]\n    >>> plt.show()\n    \n    ";
static PyMethodDef __pyx_mdef_5scipy_6signal_8spectral_lombscargle = {__Pyx_NAMESTR("lombscargle"), (PyCFunction)__pyx_pf_5scipy_6signal_8spectral_lombscargle, METH_VARARGS|METH_KEYWORDS, __Pyx_DOCSTR(__pyx_doc_5scipy_6signal_8spectral_lombscargle)};
static PyObject *__pyx_pf_5scipy_6signal_8spectral_lombscargle(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("lombscargle");
  ...
  if (unlikely(__pyx_kwds)) {
    ...
    __pyx_v_freqs = ((PyArrayObject *)PyTuple_GET_ITEM(__pyx_args, 2));
  }
 ...
 */
    __pyx_t_2 = PyObject_Call(__pyx_builtin_ValueError, ((PyObject *)__pyx_k_tuple_2), NULL); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 125; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 */
  ...
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_2 = __Pyx_PyInt_to_py_Py_intptr_t((__pyx_v_freqs->dimensions[0])); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 128; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  ...
  if (PyDict_SetItem(__pyx_t_2, ((PyObject *)__pyx_n_s__dtype), __pyx_t_6) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 128; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
  __pyx_t_6 = PyEval_CallObjectWithKeywords(__pyx_t_3, ((PyObject *)__pyx_t_4), ((PyObject *)__pyx_t_2)); if (unlikely(!__pyx_t_6)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 128; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_6);
 ...
 */
      ...
      if (__pyx_t_11 < 0) __pyx_t_11 += __pyx_bshape_0_freqs;
 ...
 */
      ...
      if (__pyx_t_13 < 0) __pyx_t_13 += __pyx_bshape_0_freqs;
 ...
 */
      ...
      __pyx_v_xc = (__pyx_v_xc + ((*__Pyx_BufPtrStrided1d(__pyx_t_5numpy_float64_t *, __pyx_bstruct_y.buf, __pyx_t_15, __pyx_bstride_0_y)) * __pyx_v_c));
 ...
 */
      ...
      __pyx_v_xs = (__pyx_v_xs + ((*__Pyx_BufPtrStrided1d(__pyx_t_5numpy_float64_t *, __pyx_bstruct_y.buf, __pyx_t_16, __pyx_bstride_0_y)) * __pyx_v_s));

      /* "scipy/signal/spectral.pyx":150
 *             xc += y[j] * c
 *             xs += y[j] * s
 *             cc += c * c             # <<<<<<<<<<<<<<
 *             ss += s * s
 ...
 */
    ...
    __pyx_t_20 = (2.0 * (*__Pyx_BufPtrStrided1d(__pyx_t_5numpy_float64_t *, __pyx_bstruct_freqs.buf, __pyx_t_10, __pyx_bstride_0_freqs)));
...
#endif
{
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit_spectral(void)");
 ...
 *                 np.ndarray[np.float64_t, ndim=1] freqs):
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_5scipy_6signal_8spectral_lombscargle, NULL, __pyx_n_s_16); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 19; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
 ...
 */
  ...
  __Pyx_GOTREF(((PyObject *)__pyx_t_1));
  if (PyDict_SetItem(__pyx_t_1, ((PyObject *)__pyx_kp_u_17), ((PyObject *)__pyx_kp_u_18)) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
