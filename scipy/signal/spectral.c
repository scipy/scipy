...
static PyObject *__pyx_pf_5scipy_6signal_8spectral_lombscargle(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __pyx_v_pgram = Py_None; __Pyx_INCREF(Py_None);
 ...
 */
  ...
  __Pyx_DECREF((PyObject *)__pyx_v_freqs);
...
static struct PyMethodDef __pyx_methods[] = {
  {__Pyx_NAMESTR("lombscargle"), (PyCFunction)__pyx_pf_5scipy_6signal_8spectral_lombscargle, METH_VARARGS|METH_KEYWORDS, __Pyx_DOCSTR(__pyx_doc_5scipy_6signal_8spectral_lombscargle)},
  {0, 0, 0, 0}
};
...
#endif
{
  ...
  __pyx_refnanny = __Pyx_RefNanny->SetupContext("PyMODINIT_FUNC PyInit_spectral(void)", __LINE__, __FILE__);
  #endif
  ...
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4(__Pyx_NAMESTR("spectral"), __pyx_methods, __Pyx_DOCSTR(__pyx_k_8), 0, PYTHON_API_VERSION);
  #else
  ...
  /* "/Users/rgommers/Code/scipy/scipy/signal/spectral.pyx":6
 ...
 */
  ...
  __pyx_t_2 = PyObject_GetAttr(__pyx_m, __pyx_n_s__lombscargle); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
 ...
 */
  ...
  __Pyx_XDECREF(__pyx_t_3);
  if (__pyx_m) {
    __Pyx_AddTraceback("init scipy.signal.spectral");
