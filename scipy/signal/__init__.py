...
.. autosummary::
   ...
   decluster_peaks  -- Find and "decluster" peaks inside a signal. 
...
Signal crossing finding
=======================

.. autosummary::
   :toctree: generated/

   argcross        -- Calculate signal up and down crossings
   argcrossup      -- Calculate signal up crossings
   argcrossdown    -- Calculate signal down crossings
