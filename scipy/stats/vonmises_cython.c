/* Generated by Cython 0.12.1 on Mon Feb  8 18:10:52 2010 */
...
/* "/home/david/src/numeric/scipy/scipy-git/scipy/stats/vonmises_cython.pyx":12
 * 
 * 
...
static  double __pyx_f_5scipy_5stats_15vonmises_cython_von_mises_cdf_series(double __pyx_v_k, double __pyx_v_x, unsigned int __pyx_v_p) {
  ...
  /* "/home/david/src/numeric/scipy/scipy-git/scipy/stats/vonmises_cython.pyx":15
 *     cdef double s, c, sn, cn, R, V
 *     cdef unsigned int n
 *     s = sin(x)             # <<<<<<<<<<<<<<
 *     c = cos(x)
 ...
 */
  ...
  /* "/home/david/src/numeric/scipy/scipy-git/scipy/stats/vonmises_cython.pyx":16
 *     cdef unsigned int n
 *     s = sin(x)
 *     c = cos(x)             # <<<<<<<<<<<<<<
 *     sn = sin(p*x)
 ...
 */
  ...
  /* "/home/david/src/numeric/scipy/scipy-git/scipy/stats/vonmises_cython.pyx":17
 *     s = sin(x)
 *     c = cos(x)
 *     sn = sin(p*x)             # <<<<<<<<<<<<<<
 *     cn = cos(p*x)
 ...
 */
  ...
  /* "/home/david/src/numeric/scipy/scipy-git/scipy/stats/vonmises_cython.pyx":18
 *     c = cos(x)
 *     sn = sin(p*x)
 *     cn = cos(p*x)             # <<<<<<<<<<<<<<
 *     R = 0
 ...
 */
  ...
  /* "/home/david/src/numeric/scipy/scipy-git/scipy/stats/vonmises_cython.pyx":19
 *     sn = sin(p*x)
 *     cn = cos(p*x)
 *     R = 0             # <<<<<<<<<<<<<<
 *     V = 0
 ...
 */
  ...
  /* "/home/david/src/numeric/scipy/scipy-git/scipy/stats/vonmises_cython.pyx":20
 *     cn = cos(p*x)
 *     R = 0
 *     V = 0             # <<<<<<<<<<<<<<
 *     for n in range(p-1,0,-1):
 ...
 */
  ...
  /* "/home/david/src/numeric/scipy/scipy-git/scipy/stats/vonmises_cython.pyx":21
 *     R = 0
 *     V = 0
 *     for n in range(p-1,0,-1):             # <<<<<<<<<<<<<<
 *         sn, cn = sn*c - cn*s, cn*c + sn*s
 ...
 */
  ...
  for (;;) {
    ...
    /* "/home/david/src/numeric/scipy/scipy-git/scipy/stats/vonmises_cython.pyx":22
 *     V = 0
 *     for n in range(p-1,0,-1):
 *         sn, cn = sn*c - cn*s, cn*c + sn*s             # <<<<<<<<<<<<<<
 *         R = 1./(2*n/k + R)
 ...
 */
    ...
    /* "/home/david/src/numeric/scipy/scipy-git/scipy/stats/vonmises_cython.pyx":23
 *     for n in range(p-1,0,-1):
 *         sn, cn = sn*c - cn*s, cn*c + sn*s
 *         R = 1./(2*n/k + R)             # <<<<<<<<<<<<<<
 *         V = R*(sn/n+V)
 ...
 */
    ...
    /* "/home/david/src/numeric/scipy/scipy-git/scipy/stats/vonmises_cython.pyx":24
 *         sn, cn = sn*c - cn*s, cn*c + sn*s
 *         R = 1./(2*n/k + R)
 *         V = R*(sn/n+V)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "/home/david/src/numeric/scipy/scipy-git/scipy/stats/vonmises_cython.pyx":26
 *         V = R*(sn/n+V)
 * 
 *     return 0.5+x/(2*np.pi) + V/np.pi             # <<<<<<<<<<<<<<
 * 
...
/* "/home/david/src/numeric/scipy/scipy-git/scipy/stats/vonmises_cython.pyx":28
 *     return 0.5+x/(2*np.pi) + V/np.pi
 * 
 * def von_mises_cdf_normalapprox(k,x,C1):             # <<<<<<<<<<<<<<
...
static PyObject *__pyx_pf_5scipy_5stats_15vonmises_cython_von_mises_cdf_normalapprox(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  /* "/home/david/src/numeric/scipy/scipy-git/scipy/stats/vonmises_cython.pyx":29
 * 
 * def von_mises_cdf_normalapprox(k,x,C1):
 *     b = np.sqrt(2/np.pi)*np.exp(k)/i0(k)             # <<<<<<<<<<<<<<
 *     z = b*np.sin(x/2.)
 ...
 */
  ...
  /* "/home/david/src/numeric/scipy/scipy-git/scipy/stats/vonmises_cython.pyx":30
 * def von_mises_cdf_normalapprox(k,x,C1):
 *     b = np.sqrt(2/np.pi)*np.exp(k)/i0(k)
 *     z = b*np.sin(x/2.)             # <<<<<<<<<<<<<<
 *     C = 24*k
 ...
 */
  ...
  /* "/home/david/src/numeric/scipy/scipy-git/scipy/stats/vonmises_cython.pyx":31
 *     b = np.sqrt(2/np.pi)*np.exp(k)/i0(k)
 *     z = b*np.sin(x/2.)
 *     C = 24*k             # <<<<<<<<<<<<<<
 *     chi = z - z**3/((C-2*z**2-16)/3.-(z**4+7/4.*z**2+167./2)/(C+C1-z**2+3))**2
 ...
 */
  ...
  /* "/home/david/src/numeric/scipy/scipy-git/scipy/stats/vonmises_cython.pyx":32
 *     z = b*np.sin(x/2.)
 *     C = 24*k
 *     chi = z - z**3/((C-2*z**2-16)/3.-(z**4+7/4.*z**2+167./2)/(C+C1-z**2+3))**2             # <<<<<<<<<<<<<<
 *     return scipy.stats.norm.cdf(z)
 ...
 */
  ...
  /* "/home/david/src/numeric/scipy/scipy-git/scipy/stats/vonmises_cython.pyx":33
 *     C = 24*k
 *     chi = z - z**3/((C-2*z**2-16)/3.-(z**4+7/4.*z**2+167./2)/(C+C1-z**2+3))**2
 *     return scipy.stats.norm.cdf(z)             # <<<<<<<<<<<<<<
 * 
...
/* "/home/david/src/numeric/scipy/scipy-git/scipy/stats/vonmises_cython.pyx":37
 * cimport cython
...
static PyObject *__pyx_pf_5scipy_5stats_15vonmises_cython_von_mises_cdf(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  /* "/home/david/src/numeric/scipy/scipy-git/scipy/stats/vonmises_cython.pyx":42
 ...
 */
  ...
  /* "/home/david/src/numeric/scipy/scipy-git/scipy/stats/vonmises_cython.pyx":43
 *     #k,x = np.broadcast_arrays(np.asarray(k),np.asarray(x))
 *     k = np.asarray(k)
 *     x = np.asarray(x)             # <<<<<<<<<<<<<<
 *     zerodim = k.ndim==0 and x.ndim==0
 ...
 */
  ...
  /* "/home/david/src/numeric/scipy/scipy-git/scipy/stats/vonmises_cython.pyx":44
 *     k = np.asarray(k)
 *     x = np.asarray(x)
 *     zerodim = k.ndim==0 and x.ndim==0             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "/home/david/src/numeric/scipy/scipy-git/scipy/stats/vonmises_cython.pyx":46
 *     zerodim = k.ndim==0 and x.ndim==0
 * 
 *     k = np.atleast_1d(k)             # <<<<<<<<<<<<<<
 *     x = np.atleast_1d(x)
 ...
 */
  ...
  /* "/home/david/src/numeric/scipy/scipy-git/scipy/stats/vonmises_cython.pyx":47
 * 
 *     k = np.atleast_1d(k)
 *     x = np.atleast_1d(x)             # <<<<<<<<<<<<<<
 *     ix = np.round(x/(2*np.pi))
 ...
 */
  ...
  /* "/home/david/src/numeric/scipy/scipy-git/scipy/stats/vonmises_cython.pyx":48
 *     k = np.atleast_1d(k)
 *     x = np.atleast_1d(x)
 *     ix = np.round(x/(2*np.pi))             # <<<<<<<<<<<<<<
 *     x = x-ix
 ...
 */
  ...
  /* "/home/david/src/numeric/scipy/scipy-git/scipy/stats/vonmises_cython.pyx":49
 *     x = np.atleast_1d(x)
 *     ix = np.round(x/(2*np.pi))
 *     x = x-ix             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "/home/david/src/numeric/scipy/scipy-git/scipy/stats/vonmises_cython.pyx":52
 * 
 *     # These values should give 12 decimal digits
 *     CK=50             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "/home/david/src/numeric/scipy/scipy-git/scipy/stats/vonmises_cython.pyx":53
 *     # These values should give 12 decimal digits
 *     CK=50
 *     a1, a2, a3, a4 = [28., 0.5, 100., 5.0]             # <<<<<<<<<<<<<<
 *     C1 = 50.1
 ...
 */
  ...
  /* "/home/david/src/numeric/scipy/scipy-git/scipy/stats/vonmises_cython.pyx":54
 *     CK=50
 *     a1, a2, a3, a4 = [28., 0.5, 100., 5.0]
 *     C1 = 50.1             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "/home/david/src/numeric/scipy/scipy-git/scipy/stats/vonmises_cython.pyx":56
 *     C1 = 50.1
 * 
 *     bx, bk = np.broadcast_arrays(x,k)             # <<<<<<<<<<<<<<
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_3 = PyObject_GetAttr(__pyx_t_2, __pyx_n_s__broadcast_arrays); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 56; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  ...
  if (PyTuple_CheckExact(__pyx_t_1) && likely(PyTuple_GET_SIZE(__pyx_t_1) == 2)) {
    ...
    __Pyx_GOTREF(__pyx_t_9);
    __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
    __pyx_t_2 = __Pyx_UnpackItem(__pyx_t_9, 0); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 56; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_2);
  ...
  /* "/home/david/src/numeric/scipy/scipy-git/scipy/stats/vonmises_cython.pyx":57
 * 
 *     bx, bk = np.broadcast_arrays(x,k)
 *     result = np.empty(bx.shape,dtype=np.float)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_3 = PyObject_GetAttr(__pyx_t_1, __pyx_n_s__empty); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 57; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_1 = PyObject_GetAttr(__pyx_v_bx, __pyx_n_s__shape); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 57; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  ...
  __Pyx_DECREF(__pyx_t_9); __pyx_t_9 = 0;
  if (PyDict_SetItem(__pyx_t_1, ((PyObject *)__pyx_n_s__dtype), __pyx_t_10) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 57; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_10); __pyx_t_10 = 0;
  __pyx_t_10 = PyEval_CallObjectWithKeywords(__pyx_t_3, __pyx_t_2, ((PyObject *)__pyx_t_1)); if (unlikely(!__pyx_t_10)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 57; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_10);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  ...
  /* "/home/david/src/numeric/scipy/scipy-git/scipy/stats/vonmises_cython.pyx":59
 *     result = np.empty(bx.shape,dtype=np.float)
 * 
 *     c_small_k = bk<CK             # <<<<<<<<<<<<<<
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_10);
  __pyx_t_1 = PyObject_RichCompare(__pyx_v_bk, __pyx_t_10, Py_LT); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 59; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_10); __pyx_t_10 = 0;
  ...
  /* "/home/david/src/numeric/scipy/scipy-git/scipy/stats/vonmises_cython.pyx":60
 * 
 *     c_small_k = bk<CK
 *     temp = result[c_small_k]             # <<<<<<<<<<<<<<
 *     temp_xs = bx[c_small_k].astype(np.float)
 ...
 */
  __pyx_t_1 = PyObject_GetItem(__pyx_v_result, __pyx_v_c_small_k); if (!__pyx_t_1) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 60; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  ...
  /* "/home/david/src/numeric/scipy/scipy-git/scipy/stats/vonmises_cython.pyx":61
 *     c_small_k = bk<CK
 *     temp = result[c_small_k]
 *     temp_xs = bx[c_small_k].astype(np.float)             # <<<<<<<<<<<<<<
 *     temp_ks = bk[c_small_k].astype(np.float)
 ...
 */
  __pyx_t_1 = PyObject_GetItem(__pyx_v_bx, __pyx_v_c_small_k); if (!__pyx_t_1) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 61; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_10 = PyObject_GetAttr(__pyx_t_1, __pyx_n_s__astype); if (unlikely(!__pyx_t_10)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 61; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_10);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  ...
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_2 = PyObject_GetAttr(__pyx_t_1, __pyx_n_s__float); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 61; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  ...
  __Pyx_GIVEREF(__pyx_t_2);
  __pyx_t_2 = 0;
  __pyx_t_2 = PyObject_Call(__pyx_t_10, __pyx_t_1, NULL); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 61; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_10); __pyx_t_10 = 0;
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  ...
  __pyx_v_temp_xs = ((PyArrayObject *)__pyx_t_2);
  __pyx_t_2 = 0;

  /* "/home/david/src/numeric/scipy/scipy-git/scipy/stats/vonmises_cython.pyx":62
 *     temp = result[c_small_k]
 *     temp_xs = bx[c_small_k].astype(np.float)
 *     temp_ks = bk[c_small_k].astype(np.float)             # <<<<<<<<<<<<<<
 *     for i in range(len(temp)):
 ...
 */
  __pyx_t_2 = PyObject_GetItem(__pyx_v_bk, __pyx_v_c_small_k); if (!__pyx_t_2) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 62; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_1 = PyObject_GetAttr(__pyx_t_2, __pyx_n_s__astype); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 62; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  ...
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_10 = PyObject_GetAttr(__pyx_t_2, __pyx_n_s__float); if (unlikely(!__pyx_t_10)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 62; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_10);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  ...
  __pyx_t_10 = 0;
  __pyx_t_10 = PyObject_Call(__pyx_t_1, __pyx_t_2, NULL); if (unlikely(!__pyx_t_10)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 62; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_10);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  ...
  /* "/home/david/src/numeric/scipy/scipy-git/scipy/stats/vonmises_cython.pyx":63
 *     temp_xs = bx[c_small_k].astype(np.float)
 *     temp_ks = bk[c_small_k].astype(np.float)
 *     for i in range(len(temp)):             # <<<<<<<<<<<<<<
 *         p = <int>(1+a1+a2*temp_ks[i]-a3/(temp_ks[i]+a4))
 ...
 */
  ...
  for (__pyx_t_17 = 0; __pyx_t_17 < __pyx_t_16; __pyx_t_17+=1) {
    ...
    /* "/home/david/src/numeric/scipy/scipy-git/scipy/stats/vonmises_cython.pyx":64
 *     temp_ks = bk[c_small_k].astype(np.float)
 *     for i in range(len(temp)):
 *         p = <int>(1+a1+a2*temp_ks[i]-a3/(temp_ks[i]+a4))             # <<<<<<<<<<<<<<
 *         temp[i] = von_mises_cdf_series(temp_ks[i],temp_xs[i],p)
 ...
 */
    ...
    /* "/home/david/src/numeric/scipy/scipy-git/scipy/stats/vonmises_cython.pyx":65
 *     for i in range(len(temp)):
 *         p = <int>(1+a1+a2*temp_ks[i]-a3/(temp_ks[i]+a4))
 *         temp[i] = von_mises_cdf_series(temp_ks[i],temp_xs[i],p)             # <<<<<<<<<<<<<<
 *         if temp[i]<0:
 ...
 */
    ...
    *__Pyx_BufPtrStrided1d(double *, __pyx_bstruct_temp.buf, __pyx_t_22, __pyx_bstride_0_temp) = __pyx_f_5scipy_5stats_15vonmises_cython_von_mises_cdf_series((*__Pyx_BufPtrStrided1d(double *, __pyx_bstruct_temp_ks.buf, __pyx_t_20, __pyx_bstride_0_temp_ks)), (*__Pyx_BufPtrStrided1d(double *, __pyx_bstruct_temp_xs.buf, __pyx_t_21, __pyx_bstride_0_temp_xs)), __pyx_v_p);
    ...
    /* "/home/david/src/numeric/scipy/scipy-git/scipy/stats/vonmises_cython.pyx":66
 *         p = <int>(1+a1+a2*temp_ks[i]-a3/(temp_ks[i]+a4))
 *         temp[i] = von_mises_cdf_series(temp_ks[i],temp_xs[i],p)
 *         if temp[i]<0:             # <<<<<<<<<<<<<<
 *             temp[i]=0
 ...
 */
    ...
    if (__pyx_t_4) {
      ...
      /* "/home/david/src/numeric/scipy/scipy-git/scipy/stats/vonmises_cython.pyx":67
 *         temp[i] = von_mises_cdf_series(temp_ks[i],temp_xs[i],p)
 *         if temp[i]<0:
 *             temp[i]=0             # <<<<<<<<<<<<<<
 *         elif temp[i]>1:
 ...
 */
    ...
    /* "/home/david/src/numeric/scipy/scipy-git/scipy/stats/vonmises_cython.pyx":68
 *         if temp[i]<0:
 *             temp[i]=0
 *         elif temp[i]>1:             # <<<<<<<<<<<<<<
 *             temp[i]=1
 ...
 */
    ...
    if (__pyx_t_4) {
      ...
      /* "/home/david/src/numeric/scipy/scipy-git/scipy/stats/vonmises_cython.pyx":69
 *             temp[i]=0
 *         elif temp[i]>1:
 *             temp[i]=1             # <<<<<<<<<<<<<<
 *     result[c_small_k] = temp
 ...
 */
  ...
  /* "/home/david/src/numeric/scipy/scipy-git/scipy/stats/vonmises_cython.pyx":70
 *         elif temp[i]>1:
 *             temp[i]=1
 *     result[c_small_k] = temp             # <<<<<<<<<<<<<<
 *     result[~c_small_k] = von_mises_cdf_normalapprox(bk[~c_small_k],bx[~c_small_k],C1)
 ...
 */
  ...
  /* "/home/david/src/numeric/scipy/scipy-git/scipy/stats/vonmises_cython.pyx":71
 *             temp[i]=1
 *     result[c_small_k] = temp
 *     result[~c_small_k] = von_mises_cdf_normalapprox(bk[~c_small_k],bx[~c_small_k],C1)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_10);
  __pyx_t_2 = PyNumber_Invert(__pyx_v_c_small_k); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 71; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_1 = PyObject_GetItem(__pyx_v_bk, __pyx_t_2); if (!__pyx_t_1) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 71; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_2 = PyNumber_Invert(__pyx_v_c_small_k); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 71; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_3 = PyObject_GetItem(__pyx_v_bx, __pyx_t_2); if (!__pyx_t_3) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 71; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_2 = PyFloat_FromDouble(__pyx_v_C1); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 71; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  ...
  __pyx_t_3 = 0;
  __pyx_t_2 = 0;
  __pyx_t_2 = PyObject_Call(__pyx_t_10, __pyx_t_9, NULL); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 71; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_10); __pyx_t_10 = 0;
  __Pyx_DECREF(__pyx_t_9); __pyx_t_9 = 0;
  ...
  __Pyx_GOTREF(__pyx_t_9);
  if (PyObject_SetItem(__pyx_v_result, __pyx_t_9, __pyx_t_2) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 71; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_9); __pyx_t_9 = 0;
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;

  /* "/home/david/src/numeric/scipy/scipy-git/scipy/stats/vonmises_cython.pyx":73
 *     result[~c_small_k] = von_mises_cdf_normalapprox(bk[~c_small_k],bx[~c_small_k],C1)
 * 
 *     if not zerodim:             # <<<<<<<<<<<<<<
 ...
 */
  ...
  if (__pyx_t_27) {
    ...
    /* "/home/david/src/numeric/scipy/scipy-git/scipy/stats/vonmises_cython.pyx":74
 * 
 *     if not zerodim:
 *         return result+(2*np.pi)*ix             # <<<<<<<<<<<<<<
 *     else:
 ...
 */
    ...
    __Pyx_GOTREF(__pyx_t_2);
    __pyx_t_9 = PyObject_GetAttr(__pyx_t_2, __pyx_n_s__pi); if (unlikely(!__pyx_t_9)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 74; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_9);
    __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
    __pyx_t_2 = PyNumber_Multiply(__pyx_int_2, __pyx_t_9); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 74; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_2);
    __Pyx_DECREF(__pyx_t_9); __pyx_t_9 = 0;
    __pyx_t_9 = PyNumber_Multiply(__pyx_t_2, __pyx_v_ix); if (unlikely(!__pyx_t_9)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 74; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_9);
    __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
    __pyx_t_2 = PyNumber_Add(__pyx_v_result, __pyx_t_9); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 74; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_2);
    __Pyx_DECREF(__pyx_t_9); __pyx_t_9 = 0;
    __pyx_r = __pyx_t_2;
    __pyx_t_2 = 0;
  ...
  /*else*/ {
    ...
    /* "/home/david/src/numeric/scipy/scipy-git/scipy/stats/vonmises_cython.pyx":76
 *         return result+(2*np.pi)*ix
 *     else:
 *         return (result+(2*np.pi)*ix)[0]             # <<<<<<<<<<<<<<
 */
    ...
    __Pyx_GOTREF(__pyx_t_2);
    __pyx_t_9 = PyObject_GetAttr(__pyx_t_2, __pyx_n_s__pi); if (unlikely(!__pyx_t_9)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 76; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_9);
    __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
    __pyx_t_2 = PyNumber_Multiply(__pyx_int_2, __pyx_t_9); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 76; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_2);
    __Pyx_DECREF(__pyx_t_9); __pyx_t_9 = 0;
    __pyx_t_9 = PyNumber_Multiply(__pyx_t_2, __pyx_v_ix); if (unlikely(!__pyx_t_9)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 76; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_9);
    __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
    __pyx_t_2 = PyNumber_Add(__pyx_v_result, __pyx_t_9); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 76; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_2);
    __Pyx_DECREF(__pyx_t_9); __pyx_t_9 = 0;
    __pyx_t_9 = __Pyx_GetItemInt(__pyx_t_2, 0, sizeof(long), PyInt_FromLong); if (!__pyx_t_9) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 76; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_9);
    __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
    __pyx_r = __pyx_t_9;
    __pyx_t_9 = 0;
...
#endif
{
  ...
  /* "/home/david/src/numeric/scipy/scipy-git/scipy/stats/vonmises_cython.pyx":1
 * import numpy as np             # <<<<<<<<<<<<<<
 * import scipy.stats
 ...
 */
  ...
  /* "/home/david/src/numeric/scipy/scipy-git/scipy/stats/vonmises_cython.pyx":2
 * import numpy as np
 * import scipy.stats             # <<<<<<<<<<<<<<
 * from scipy.special import i0
 ...
 */
  ...
  /* "/home/david/src/numeric/scipy/scipy-git/scipy/stats/vonmises_cython.pyx":3
 * import numpy as np
 * import scipy.stats
 * from scipy.special import i0             # <<<<<<<<<<<<<<
 * import numpy.testing
 ...
 */
  ...
  /* "/home/david/src/numeric/scipy/scipy-git/scipy/stats/vonmises_cython.pyx":4
 * import scipy.stats
 * from scipy.special import i0
 * import numpy.testing             # <<<<<<<<<<<<<<
 * cimport numpy as np
