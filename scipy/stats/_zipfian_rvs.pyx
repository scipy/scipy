...
cdef inline double g(double x, double a, int64_t n) noexcept nogil:
    # g is the dominating "hat" function.  It is the nonnormalized
...
cdef inline double g_rv(bitgen_t *bit_generator,
    ...
    # We save a few CPU cycles by computing it once outside of this function
...
cdef int zipfian_mrvs(bitgen_t *bit_generator,
    ...
    for i in range(m):
        ...
        while num_rejections <= max_rejections:
            ...
            # The dominating function g and the target function h coincide on the
...
def zipfian_rvs(bit_generator, *, a, n, size=None):
    ...
    # XXX Why does this cast work?  n is a Python object...
    n1 = <int64_t> n
    if n1 < 1:
