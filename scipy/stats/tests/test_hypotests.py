...
class TestBoschlooExact:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            # ([[100, 2], [1000, 5]], (0.1300759, 0.0953023)),
            ([[2, 7], [8, 2]], (0.01852173, 0.009886142)),
            ([[5, 1], [10, 10]], (0.9782609, 0.9450994)),
            # ([[5, 15], [20, 20]], (0.05625775, 0.03429378)),
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            # ([[100, 2], [1000, 5]], (0.9797904, 0.9645988)),
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            # ([[100, 2], [1000, 5]], (0.1300759, 0.1906046)),
            ...
            # ([[10, 24], [25, 37]], (0.2009359, 0.3025764)),
        ],
    )
