...
class TestBoschlooExact:
    ...
    @pytest.mark.parametrize(
        "input_sample,expected",
        [
            ([[43, 40], [10, 39]], (0.9999373994, 0.9998658832)),
            ([[100, 2], [1000, 5]], (0.1300759363, 0.09530231088)),
            ([[2, 7], [8, 2]], (0.01852172595, 0.009886150844)),
            ([[5, 1], [10, 10]], (0.9782608696, 0.9450994467)),
            ([[5, 15], [20, 20]], (0.05625775074, 0.03355903337)),
            ([[5, 16], [20, 25]], (0.08913822783, 0.0582734888)),
            ([[10, 5], [10, 1]], (0.1652173913, 0.0856561222)),
            ([[5, 0], [1, 4]], (1, 1)),
            ([[0, 1], [3, 2]], (0.5, 0.34375001)),
            ([[0, 2], [6, 4]], (0.2272727273, 0.0985098193)),
            ([[2, 7], [8, 2]], (0.01852172595, 0.009886150844)),
            ([[7, 12], [8, 3]], (0.06406796602, 0.03410916465)),
        ],
    )
    def test_precise_less(self, input_sample, expected):
        """The expected values have been generated by R, using a resolution
    ...
    @pytest.mark.parametrize(
        "input_sample,expected",
        [
            ([[43, 40], [10, 39]], (0.0002875543662, 0.000161565233)),
            ([[100, 2], [1000, 5]], (0.9797904453, 0.9645988606)),
            ([[2, 7], [8, 2]], (0.999014917, 0.991832692)),
            ([[5, 1], [10, 10]], (0.1652173913, 0.09008535115)),
            ([[5, 15], [20, 20]], (0.9849086665, 0.9706996859)),
            ([[5, 16], [20, 25]], (0.9723490196, 0.9524124316)),
            ([[10, 5], [10, 1]], (0.9782608696, 0.9325748005)),
            ([[5, 0], [1, 4]], (0.02380952381, 0.006865375885)),
            ([[0, 1], [3, 2]], (1, 1)),
            ([[0, 2], [6, 4]], (1, 1)),
            ([[2, 7], [8, 2]], (0.999014917, 0.991832692)),
            ([[7, 12], [8, 3]], (0.9895302349, 0.9771215448)),
        ],
    )
    def test_precise_greater(self, input_sample, expected):
        """The expected values have been generated by R, using a resolution
        for the nuisance parameter of 1e-8 :
        ```R
        library(Exact)
