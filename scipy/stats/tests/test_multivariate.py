...
class TestSpecialOrthoGroup:
    def test_reproducibility(self):
        ...
        x = special_ortho_group.rvs(3, random_state=rng)
    ...
    def test_haar(self):
        ...
        ks_prob = .05
        rng = np.random.RandomState(514)
        xs = special_ortho_group.rvs(dim, size=samples, random_state=rng)
...
class TestUnitaryGroup:
    ...
    def test_haar(self):
        ...
        dim = 5
        samples = 1000  # Not too many, or the test takes too long
        rng = np.random.RandomState(514)  # Note that the test is sensitive to seed too
        xs = unitary_group.rvs(dim, size=samples, random_state=rng)
