...
def binned_statistic_2d(x, y, values, statistic='mean',
    ...
    Note that the returned linearized bin indices are used for an array that
    in an array with extra bins on the outer binedges to capture values outside
    of the defined bin bounds.
