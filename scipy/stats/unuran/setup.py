...
def configuration(parent_package="", top_path=None):
    ...
    config = Configuration("unuran", parent_package, top_path)
    ...
    UNURAN_SOURCE_DIRS = [UNURAN_DIR / dir_ for dir_ in UNURAN_DIRS[1:]]

    sources = _get_sources(UNURAN_SOURCE_DIRS)
