/* Generated by Cython 0.11.3 on Tue Dec 15 14:47:02 2009 */
...
static  size_t __pyx_f_5scipy_2io_6matlab_9mio_utils_cproduct(PyObject *__pyx_v_tup, int __pyx_skip_dispatch) {
  ...
  /* "/Users/mb312/scipybuild/scipy/scipy/io/matlab/mio_utils.pyx":11
 * 
 * cpdef size_t cproduct(tup):
 *     cdef size_t res = 1             # <<<<<<<<<<<<<<
 *     cdef int i
 ...
 */
  ...
  /* "/Users/mb312/scipybuild/scipy/scipy/io/matlab/mio_utils.pyx":15
 *     for i in range(len(tup)):
 *         res *= tup[i]
 *     return res             # <<<<<<<<<<<<<<
 * 
...
/* "/Users/mb312/scipybuild/scipy/scipy/io/matlab/mio_utils.pyx":19
 * 
 * cdef class FileReadOpts:
 *     def __new__(self,             # <<<<<<<<<<<<<<
 *                 chars_as_strings,
...
static int __pyx_pf_5scipy_2io_6matlab_9mio_utils_12FileReadOpts___new__(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  /* "/Users/mb312/scipybuild/scipy/scipy/io/matlab/mio_utils.pyx":23
 *                 mat_dtype,
 *                 squeeze_me):
 ...
 */
  ...
  if (__pyx_t_5) {
    ...
    /* "/Users/mb312/scipybuild/scipy/scipy/io/matlab/mio_utils.pyx":34
 *         int i
 *     if file_read_opts.chars_as_strings and arr.dtype.kind == 'U':
 *         arr = chars_to_strings(arr)             # <<<<<<<<<<<<<<
 *     if file_read_opts.mat_dtype:
 ...
 */
  ...
  /* "/Users/mb312/scipybuild/scipy/scipy/io/matlab/mio_utils.pyx":35
 *     if file_read_opts.chars_as_strings and arr.dtype.kind == 'U':
 *         arr = chars_to_strings(arr)
 *     if file_read_opts.mat_dtype:             # <<<<<<<<<<<<<<
 *         # Apply options to replicate matlab datatype on load
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "/Users/mb312/scipybuild/scipy/scipy/io/matlab/mio_utils.pyx":37
 *     if file_read_opts.mat_dtype:
 *         # Apply options to replicate matlab datatype on load
 *         if mat_dtype is not None:             # <<<<<<<<<<<<<<
 ...
 */
    ...
    if (__pyx_t_5) {
      ...
      /* "/Users/mb312/scipybuild/scipy/scipy/io/matlab/mio_utils.pyx":38
 *         # Apply options to replicate matlab datatype on load
 *         if mat_dtype is not None:
 *             arr = arr.astype(mat_dtype)             # <<<<<<<<<<<<<<
 *     if file_read_opts.squeeze_me:
 ...
 */
  ...
  /* "/Users/mb312/scipybuild/scipy/scipy/io/matlab/mio_utils.pyx":39
 *         if mat_dtype is not None:
 *             arr = arr.astype(mat_dtype)
 *     if file_read_opts.squeeze_me:             # <<<<<<<<<<<<<<
 *         if not arr.size:
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "/Users/mb312/scipybuild/scipy/scipy/io/matlab/mio_utils.pyx":40
 *             arr = arr.astype(mat_dtype)
 *     if file_read_opts.squeeze_me:
 *         if not arr.size:             # <<<<<<<<<<<<<<
 *             arr = np.array([])
 ...
 */
    ...
    if (__pyx_t_4) {
      ...
      /* "/Users/mb312/scipybuild/scipy/scipy/io/matlab/mio_utils.pyx":41
 *     if file_read_opts.squeeze_me:
 *         if not arr.size:
 *             arr = np.array([])             # <<<<<<<<<<<<<<
 *         else:
 ...
 */
    ...
    /*else*/ {
      ...
      /* "/Users/mb312/scipybuild/scipy/scipy/io/matlab/mio_utils.pyx":43
 *             arr = np.array([])
 *         else:
 *             arr = np.squeeze(arr)             # <<<<<<<<<<<<<<
 ...
 */
      ...
      /* "/Users/mb312/scipybuild/scipy/scipy/io/matlab/mio_utils.pyx":44
 *         else:
 *             arr = np.squeeze(arr)
 *             if not arr.shape and arr.dtype.isbuiltin: # 0d coverted to scalar             # <<<<<<<<<<<<<<
 *                 arr = arr.item()
 ...
 */
      ...
      if (__pyx_t_7) {
        ...
        /* "/Users/mb312/scipybuild/scipy/scipy/io/matlab/mio_utils.pyx":45
 *             arr = np.squeeze(arr)
 *             if not arr.shape and arr.dtype.isbuiltin: # 0d coverted to scalar
 *                 arr = arr.item()             # <<<<<<<<<<<<<<
 *     return arr
 ...
 */
  ...
  /* "/Users/mb312/scipybuild/scipy/scipy/io/matlab/mio_utils.pyx":46
 *             if not arr.shape and arr.dtype.isbuiltin: # 0d coverted to scalar
 *                 arr = arr.item()
 *     return arr             # <<<<<<<<<<<<<<
 * 
...
/* "/Users/mb312/scipybuild/scipy/scipy/io/matlab/mio_utils.pyx":49
 * 
 * 
...
static  PyArrayObject *__pyx_f_5scipy_2io_6matlab_9mio_utils_chars_to_strings(PyObject *__pyx_v_in_arr, int __pyx_skip_dispatch) {
  ...
  /* "/Users/mb312/scipybuild/scipy/scipy/io/matlab/mio_utils.pyx":63
 *        ``arr``
 *     '''
 ...
 */
  if (!(__Pyx_TypeTest(__pyx_v_in_arr, __pyx_ptype_5numpy_ndarray))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 63; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_INCREF(__pyx_v_in_arr);
  __pyx_v_arr = ((PyArrayObject *)__pyx_v_in_arr);

  /* "/Users/mb312/scipybuild/scipy/scipy/io/matlab/mio_utils.pyx":64
 *     '''
 *     cdef cnp.ndarray arr = in_arr
 *     cdef int ndim = arr.ndim             # <<<<<<<<<<<<<<
 *     cdef cnp.npy_intp *dims = arr.shape
 ...
 */
  ...
  /* "/Users/mb312/scipybuild/scipy/scipy/io/matlab/mio_utils.pyx":65
 *     cdef cnp.ndarray arr = in_arr
 *     cdef int ndim = arr.ndim
 *     cdef cnp.npy_intp *dims = arr.shape             # <<<<<<<<<<<<<<
 *     cdef cnp.npy_intp last_dim = dims[ndim-1]
 ...
 */
  ...
  /* "/Users/mb312/scipybuild/scipy/scipy/io/matlab/mio_utils.pyx":66
 *     cdef int ndim = arr.ndim
 *     cdef cnp.npy_intp *dims = arr.shape
 *     cdef cnp.npy_intp last_dim = dims[ndim-1]             # <<<<<<<<<<<<<<
 *     cdef object new_dt_str
 ...
 */
  ...
  /* "/Users/mb312/scipybuild/scipy/scipy/io/matlab/mio_utils.pyx":68
 *     cdef cnp.npy_intp last_dim = dims[ndim-1]
 *     cdef object new_dt_str
 *     if last_dim == 0: # deal with empty array case             # <<<<<<<<<<<<<<
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "/Users/mb312/scipybuild/scipy/scipy/io/matlab/mio_utils.pyx":69
 *     cdef object new_dt_str
 *     if last_dim == 0: # deal with empty array case
 *         new_dt_str = arr.dtype.str             # <<<<<<<<<<<<<<
 *     else: # make new dtype string with N appended
 ...
 */
    __pyx_t_2 = PyObject_GetAttr(((PyObject *)__pyx_v_arr), __pyx_kp_dtype); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 69; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_2);
    __pyx_t_3 = PyObject_GetAttr(__pyx_t_2, __pyx_kp_str); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 69; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_3);
    __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  ...
  /*else*/ {
    ...
    /* "/Users/mb312/scipybuild/scipy/scipy/io/matlab/mio_utils.pyx":71
 *         new_dt_str = arr.dtype.str
 *     else: # make new dtype string with N appended
 *         new_dt_str = arr.dtype.str[:-1] + str(last_dim)             # <<<<<<<<<<<<<<
 ...
 */
    __pyx_t_3 = PyObject_GetAttr(((PyObject *)__pyx_v_arr), __pyx_kp_dtype); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 71; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_3);
    __pyx_t_2 = PyObject_GetAttr(__pyx_t_3, __pyx_kp_str); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 71; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_2);
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
    __pyx_1 = PySequence_GetSlice(__pyx_t_2, 0, -1); if (unlikely(!__pyx_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 71; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_1);
    __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
    __pyx_t_2 = __Pyx_PyInt_to_py_npy_intp(__pyx_v_last_dim); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 71; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_2);
    ...
    __Pyx_GOTREF(__pyx_t_2);
    __Pyx_DECREF(((PyObject *)__pyx_t_3)); __pyx_t_3 = 0;
    __pyx_t_3 = PyNumber_Add(__pyx_1, __pyx_t_2); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 71; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_3);
    __Pyx_DECREF(__pyx_1); __pyx_1 = 0;
    __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
    __Pyx_DECREF(__pyx_v_new_dt_str);
  ...
  /* "/Users/mb312/scipybuild/scipy/scipy/io/matlab/mio_utils.pyx":73
 *         new_dt_str = arr.dtype.str[:-1] + str(last_dim)
 *     # Copy to deal with F ordered arrays
 *     arr = np.ascontiguousarray(arr)             # <<<<<<<<<<<<<<
 ...
 */
  __pyx_1 = __Pyx_GetName(__pyx_m, __pyx_kp_np); if (unlikely(!__pyx_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 73; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_1);
  __pyx_t_3 = PyObject_GetAttr(__pyx_1, __pyx_kp_ascontiguousarray); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 73; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_1); __pyx_1 = 0;
  ...
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __Pyx_DECREF(((PyObject *)__pyx_t_2)); __pyx_t_2 = 0;
  if (!(__Pyx_TypeTest(__pyx_t_4, __pyx_ptype_5numpy_ndarray))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 73; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(((PyObject *)__pyx_v_arr));
  __pyx_v_arr = ((PyArrayObject *)__pyx_t_4);
  __pyx_t_4 = 0;

  /* "/Users/mb312/scipybuild/scipy/scipy/io/matlab/mio_utils.pyx":74
 *     # Copy to deal with F ordered arrays
 *     arr = np.ascontiguousarray(arr)
 *     arr = arr.view(new_dt_str)             # <<<<<<<<<<<<<<
 *     return arr.reshape(in_arr.shape[:-1])
 */
  __pyx_t_4 = PyObject_GetAttr(((PyObject *)__pyx_v_arr), __pyx_kp_view); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 74; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_4);
  ...
  __pyx_t_3 = PyObject_Call(__pyx_t_4, ((PyObject *)__pyx_t_2), NULL); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 74; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_3);
  ...
  /* "/Users/mb312/scipybuild/scipy/scipy/io/matlab/mio_utils.pyx":75
 *     arr = np.ascontiguousarray(arr)
 *     arr = arr.view(new_dt_str)
 *     return arr.reshape(in_arr.shape[:-1])             # <<<<<<<<<<<<<<
 */
  __Pyx_XDECREF(((PyObject *)__pyx_r));
  __pyx_t_3 = PyObject_GetAttr(((PyObject *)__pyx_v_arr), __pyx_kp_reshape); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 75; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_2 = PyObject_GetAttr(__pyx_v_in_arr, __pyx_kp_shape); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 75; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_1 = PySequence_GetSlice(__pyx_t_2, 0, -1); if (unlikely(!__pyx_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 75; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_1);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  ...
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __Pyx_DECREF(((PyObject *)__pyx_t_2)); __pyx_t_2 = 0;
  if (!(__Pyx_TypeTest(__pyx_t_4, __pyx_ptype_5numpy_ndarray))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 75; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
