...
from sf_error cimport sf_error_t as error_t
from sf_error cimport (
    OK, SINGULAR, UNDERFLOW, OVERFLOW, SLOW, LOSS, NO_RESULT, DOMAIN,
    ARG, OTHER
)

cpdef error_t get_errno() nogil
cdef sf_errno
cdef int _error_test_function(int code) nogil
