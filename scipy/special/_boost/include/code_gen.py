'''Generate Cython PYX wrappers for Boost special distributions.'''
...
def _ufunc_gen(scipy_dist: str, types: list, ctor_args: tuple,
    ...
    with open(filename, 'w') as fp:
        ...
        fp.write(dedent(f'''\
            ...
            # This file was generated by special/_boost/include/code_gen.py
        ...
        if has_NPY_FLOAT16:
            warn('Boost special NPY_FLOAT16 ufunc generation not '
