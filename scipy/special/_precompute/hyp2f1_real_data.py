...
def main(
    ...
    for _ in range(5):
        a, b, c = tuple(-10 + 20*random_state.random() for i in range(3))
        params.append( (a,b,c,1) )
    ...
    for _ in range(5):
        a, b, c = tuple(-10 + 20*random_state.random() for i in range(3))
        b = a + round(b-a)
        params.append( (a,b,c,2) )
        perturbations = (10**-(4 + 16*random_state.random(31))) * np.sign(random_state.randn(31))
        params.extend( (a,x,c,2) for x in np.unique(b+perturbations) )
    ...
    for _ in range(5):
        a, b, c = tuple(-10 + 20*random_state.random() for i in range(3))
        c = a + round(c-a)
        params.append( (a,b,c,3) )
        perturbations = (10**-(4 + 16*random_state.random(31))) * np.sign(random_state.randn(31))
        params.extend( (a,b,x,3) for x in np.unique(c+perturbations) )
    ...
    for _ in range(5):
        a, b, c = tuple(-10 + 20*random_state.random() for i in range(3))
        c = b + round(c-b)
        params.append( (a,b,c,4) )
        perturbations = (10**-(4 + 16*random_state.random(31))) * np.sign(random_state.randn(31))
        params.extend( (a,b,x,4) for x in np.unique(c+perturbations) )
    ...
    for _ in range(5):
        a, b, c = tuple(-10 + 20*random_state.random() for i in range(3))
        c = b + round(c-a-b)
        params.append( (a,b,c,5) )
        perturbations = (10**-(4 + 16*random_state.random(31))) * np.sign(random_state.randn(31))
        params.extend( (a,b,x,5) for x in np.unique(c+perturbations) )
    ...
    for _ in range(5):
        a, b, c = tuple(-10 + 20*random_state.random() for i in range(3))
        a = round(a)
        params.append( (a,b,c,6) )
        perturbations = (10**-(4 + 16*random_state.random(31))) * np.sign(random_state.randn(31))
        params.extend( (x,b,c,6) for x in np.unique(a+perturbations) )
    ...
    for _ in range(5):
        a, b, c = tuple(-10 + 20*random_state.random() for i in range(3))
        b = round(b)
        params.append( (a,b,c,7) )
        perturbations = (10**-(4 + 16*random_state.random(31))) * np.sign(random_state.randn(31))
        params.extend( (a,x,c,7) for x in np.unique(b*perturbations) )
    ...
    for _ in range(5):
        a, b, c = tuple(-10 + 20*random_state.random() for i in range(3))
        c = round(c)
        params.append( (a,b,c,8) )
        perturbations = (10**-(4 + 16*random_state.random(31))) * np.sign(random_state.randn(31))
        params.extend( (a,b,x,8) for x in np.unique(c+perturbations) )
