...
PyMODINIT_FUNC PyInit__gufuncs() {
    ...
    PyObject *assoc_legendre_p_all = Py_BuildValue(
        ...
        xsf::numpy::gufunc({[](double z, long long int branch_cut, xsf::numpy::autodiff0_double_2d res) {
                                ::assoc_legendre_p_all(assoc_legendre_norm, z, branch_cut, res);
                            },
                            [](float z, long long int branch_cut, xsf::numpy::autodiff0_float_2d res) {
                                ::assoc_legendre_p_all(assoc_legendre_norm, z, branch_cut, res);
                            },
                            [](xsf::numpy::cdouble z, long long int branch_cut, xsf::numpy::autodiff0_cdouble_2d res) {
                                ::assoc_legendre_p_all(assoc_legendre_norm, z, branch_cut, res);
                            },
                            [](xsf::numpy::cfloat z, long long int branch_cut, xsf::numpy::autodiff0_cfloat_2d res) {
                                ::assoc_legendre_p_all(assoc_legendre_norm, z, branch_cut, res);
                            }},
                           1, "assoc_legendre_p_all", nullptr, "(),()->(np1,mpmp1,1)", assoc_legendre_map_dims<1>),
        Py_True, 1,
        xsf::numpy::gufunc({[](double z, long long int branch_cut, xsf::numpy::autodiff1_double_2d res) {
                                ::assoc_legendre_p_all(assoc_legendre_norm, z, branch_cut, res);
                            },
                            [](float z, long long int branch_cut, xsf::numpy::autodiff1_float_2d res) {
                                ::assoc_legendre_p_all(assoc_legendre_norm, z, branch_cut, res);
                            },
                            [](xsf::numpy::cdouble z, long long int branch_cut, xsf::numpy::autodiff1_cdouble_2d res) {
                                ::assoc_legendre_p_all(assoc_legendre_norm, z, branch_cut, res);
                            },
                            [](xsf::numpy::cfloat z, long long int branch_cut, xsf::numpy::autodiff1_cfloat_2d res) {
                                ::assoc_legendre_p_all(assoc_legendre_norm, z, branch_cut, res);
                            }},
                           1, "assoc_legendre_p_all", nullptr, "(),()->(np1,mpmp1,2)", assoc_legendre_map_dims<1>),
        Py_True, 2,
        xsf::numpy::gufunc({[](double z, long long int branch_cut, xsf::numpy::autodiff2_double_2d res) {
                                ::assoc_legendre_p_all(assoc_legendre_norm, z, branch_cut, res);
                            },
                            [](float z, long long int branch_cut, xsf::numpy::autodiff2_float_2d res) {
                                ::assoc_legendre_p_all(assoc_legendre_norm, z, branch_cut, res);
                            },
                            [](xsf::numpy::cdouble z, long long int branch_cut, xsf::numpy::autodiff2_cdouble_2d res) {
                                ::assoc_legendre_p_all(assoc_legendre_norm, z, branch_cut, res);
                            },
                            [](xsf::numpy::cfloat z, long long int branch_cut, xsf::numpy::autodiff2_cfloat_2d res) {
                                ::assoc_legendre_p_all(assoc_legendre_norm, z, branch_cut, res);
                            }},
