...
PyMODINIT_FUNC PyInit__gufuncs() {
    ...
    PyObject *legendre_p_all = Py_BuildValue(
        "(N, N, N)",
        xsf::numpy::gufunc({static_cast<func_d_d1_t>(::legendre_p_all), static_cast<func_f_f1_t>(::legendre_p_all),
        ...
        xsf::numpy::gufunc({static_cast<func_d_d1d1_t>(::legendre_p_all), static_cast<func_f_f1f1_t>(::legendre_p_all),
    ...
    PyObject *_lqn = xsf::numpy::gufunc({static_cast<func_d_d1d1_t>(xsf::lqn), static_cast<func_f_f1f1_t>(xsf::lqn),
    ...
    PyObject *_lqmn = xsf::numpy::gufunc({static_cast<func_d_d2d2_t>(xsf::lqmn), static_cast<func_f_f2f2_t>(xsf::lqmn),
    ...
    PyObject *sph_harm_y_all = Py_BuildValue(
        "(N,N,N)",
        xsf::numpy::gufunc({static_cast<func_dd_D2_t>(::sph_harm_y_all), static_cast<func_ff_F2_t>(::sph_harm_y_all)},
                           1, "sph_harm_y_all", nullptr, "(),()->(np1,mpmp1)", sph_harm_map_dims<1>),
        xsf::numpy::gufunc(
    ...
    PyObject *_rctj = xsf::numpy::gufunc({static_cast<func_d_d1d1_t>(xsf::rctj), static_cast<func_f_f1f1_t>(xsf::rctj)},
                                         2, "_rctj", rctj_doc, "()->(np1),(np1)", legendre_map_dims<2>);
    PyModule_AddObjectRef(_gufuncs, "_rctj", _rctj);

    PyObject *_rcty = xsf::numpy::gufunc({static_cast<func_d_d1d1_t>(xsf::rcty), static_cast<func_f_f1f1_t>(xsf::rcty)},
