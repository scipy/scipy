...
npy_cdouble cellint_RG(npy_cdouble x, npy_cdouble y, npy_cdouble z) {
    ...
    status = static_cast<sf_error_t>(ellint_carlson::rg(xx, yy, zz, ellip_rerr, res));
...
double fellint_RJ(double x, double y, double z, double p) {
    ...
    status = static_cast<sf_error_t>(ellint_carlson::rj(x, y, z, p, ellip_rerr, res));
...
npy_cdouble cellint_RJ(npy_cdouble x, npy_cdouble y, npy_cdouble z, npy_cdouble p) {
    ...
    status = static_cast<sf_error_t>(ellint_carlson::rj(xx, yy, zz, pp, ellip_rerr, res));
