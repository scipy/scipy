...
def _backend_from_arg(backend):
    ...
    if backend.__ua_domain__ != 'numpy.scipy.special':
        raise ValueError('Backend does not implement "numpy.scipy.special"')
