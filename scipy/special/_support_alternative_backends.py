...
class _FuncInfo:
    ...
    # should not be applied to these. If func is a ufunc wrapper which exposes
    # its underlying ufunc through a ._ufunc attribute, one can still set
    # is_ufunc=True, and the wrapper generated by _FuncInfo will behave like
    # a ufunc, preserving ufunc kwargs, attributes, and the resolve_dtypes
    # method.
    is_ufunc: bool = True
    ...
    @property
    def ufunc(self):
        # underlying ufunc for func, in case func is a wrapper that exposes
        # its underlying ufunc through the _ufunc attribute.
        if not self.is_ufunc:
            return None
        return self.func._ufunc if hasattr(self.func, "_ufunc") else self.func
    ...
    def _wrapper_for(self, xp):
        ...
        if is_jax(xp) and self.is_ufunc:
            ...
            def f(*args, _f=_f, xp=xp, out=None, **kwargs):
                ...
                dtypes = self.ufunc.resolve_dtypes(dtypes)
