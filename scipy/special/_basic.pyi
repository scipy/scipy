...
@overload
def assoc_laguerre(x: _FloatingType, n: int, k: float = ...) -> float: ...
...
def lpmn(m: _FloatingType, n: _FloatingType, z: ArrayLike) -> _PointsDerivate: ...
def clpmn(
    m: _FloatingType, n: _FloatingType, z: ArrayLike, type: Literal[2, 3] = ...
) -> _PointsDerivate: ...
def lqmn(m: _IntegerType, n: _IntegerType, z: ArrayLike) -> _PointsDerivate: ...
def bernoulli(n: int) -> NDArray: ...
def euler(n: int) -> NDArray: ...
def lpn(n: int, z: _FloatingType) -> _PointsDerivate: ...
def lqn(n: int, z: _FloatingType) -> _PointsDerivate: ...
def ai_zeros(nt: int) -> _ZerosOrder: ...
def bi_zeros(nt: int) -> _ZerosOrder: ...
def lmbda(v: int, x: int) -> _PointsDerivate: ...
def pbdv_seq(v: _FloatingType, x: _FloatingType) -> _PointsDerivate: ...
def pbvv_seq(v: _FloatingType, x: _FloatingType) -> _PointsDerivate: ...
def pbdn_seq(n: int, z: _ComplexNumber) -> _PointsDerivate: ...
def ber_zeros(nt: _FloatingType) -> NDArray: ...
def bei_zeros(nt: _FloatingType) -> NDArray: ...
def ker_zeros(nt: _FloatingType) -> NDArray: ...
def kei_zeros(nt: _FloatingType) -> NDArray: ...
def berp_zeros(nt: _FloatingType) -> NDArray: ...
def beip_zeros(nt: _FloatingType) -> NDArray: ...
def kerp_zeros(nt: _FloatingType) -> NDArray: ...
def keip_zeros(nt: _FloatingType) -> NDArray: ...
def kelvin_zeros(
    nt: _FloatingType,
) -> tuple[
    NDArray,
...
@overload
def perm(N: _FloatingType, k: _FloatingType, exact: bool = ...) -> _IntegerType: ...
@overload
def perm(N: ArrayLike, k: ArrayLike, exact: bool = ...) -> NDArray: ...
@overload
def factorial(n: ArrayLike, exact: bool = ...) -> NDArray: ...
@overload
def factorial(n: _FloatingType, exact: bool = ...) -> _FloatingType: ...
@overload
