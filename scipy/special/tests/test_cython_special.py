...
PARAMS: List[Tuple[Callable, Callable, Tuple[str, ...], Optional[str]]] = [
    ...
    (
        special.eval_chebys,
        cython_special.eval_chebys,
        ("dd", "dD", "ld"),
        "d and l differ for negative int",
    ),
    (
        special.eval_chebyt,
        cython_special.eval_chebyt,
        ("dd", "dD", "ld"),
        "d and l differ for negative int",
    ),
    (
        special.eval_chebyu,
        cython_special.eval_chebyu,
        ("dd", "dD", "ld"),
        "d and l differ for negative int",
    ),
    (
        special.eval_gegenbauer,
        cython_special.eval_gegenbauer,
        ("ddd", "ddD", "ldd"),
        "d and l differ for negative int",
    ),
    (
        special.eval_genlaguerre,
        cython_special.eval_genlaguerre,
        ("ddd", "ddD", "ldd"),
        "d and l differ for negative int",
    ),
    ...
    (
        special.eval_jacobi,
        cython_special.eval_jacobi,
        ("dddd", "dddD", "lddd"),
        "d and l differ for negative int",
    ),
    (
        special.eval_laguerre,
        cython_special.eval_laguerre,
        ("dd", "dD", "ld"),
        "d and l differ for negative int",
    ),
    ...
    (
        ...
        cython_special.eval_sh_chebyu,
        ("dd", "dD", "ld"),
        "d and l differ for negative int",
    ),
    (
        special.eval_sh_jacobi,
        cython_special.eval_sh_jacobi,
        ("dddd", "dddD", "lddd"),
        "d and l differ for negative int",
    ),
    (
        special.eval_sh_legendre,
        cython_special.eval_sh_legendre,
        ("dd", "dD", "ld"),
        None,
    ),
    ...
    (
        special.obl_rad1_cv,
        cython_special._obl_rad1_cv_pywrap,
        ("ddddd",),
        "see gh-6211",
    ),
    ...
    (
        special.obl_rad2_cv,
        cython_special._obl_rad2_cv_pywrap,
        ("ddddd",),
        "see gh-6211",
    ),
    ...
    (
        special.pro_rad1_cv,
        cython_special._pro_rad1_cv_pywrap,
        ("ddddd",),
        "see gh-6211",
    ),
    ...
    (
        special.pro_rad2_cv,
        cython_special._pro_rad2_cv_pywrap,
        ("ddddd",),
        "see gh-6211",
    ),
    ...
    (
        ...
        cython_special.spherical_jn,
        ("ld", "ldb", "lD", "lDb"),
        None,
    ),
    (
        special.spherical_yn,
        cython_special.spherical_yn,
        ("ld", "ldb", "lD", "lDb"),
        None,
    ),
    (
        special.spherical_in,
        cython_special.spherical_in,
        ("ld", "ldb", "lD", "lDb"),
        None,
    ),
    (
        special.spherical_kn,
        cython_special.spherical_kn,
        ("ld", "ldb", "lD", "lDb"),
        None,
    ),
...
def test_cython_api(param):
    ...
    for typecodes in specializations:
        ...
        for pt in pts:
            ...
            assert_allclose(
                cyval, pyval, err_msg="{} {} {}".format(pt, typecodes, signature)
            )
