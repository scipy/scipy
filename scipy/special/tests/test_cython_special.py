...
def test_cython_api():
    params = [
        ...
        (special.weight_chebyc, cython_special.weight_chebyc, ('d',), None),
        (special.weight_chebys, cython_special.weight_chebys, ('d',), None),
        (special.weight_chebyt, cython_special.weight_chebyt, ('d',), None),
        (special.weight_chebyu, cython_special.weight_chebyu, ('d',), None),
        (special.weight_gegenbauer, cython_special.weight_gegenbauer, ('dd',), None),
        (special.weight_genlaguerre, cython_special.weight_genlaguerre, ('dd',), None),
        (special.weight_hermite, cython_special.weight_hermite, ('d',), None),
        (special.weight_hermitenorm, cython_special.weight_hermitenorm, ('d',), None),
        (special.weight_jacobi, cython_special.weight_jacobi, ('ddd',), None),
        (special.weight_laguerre, cython_special.weight_laguerre, ('d',), None),
        (special.weight_legendre, cython_special.weight_legendre, ('d',), None),
        (special.weight_sh_chebyt, cython_special.weight_sh_chebyt, ('d',), None),
        (special.weight_sh_chebyu, cython_special.weight_sh_chebyu, ('d',), None),
        (special.weight_sh_jacobi, cython_special.weight_sh_jacobi, ('ddd',), None),
        (special.weight_sh_legendre, cython_special.weight_sh_legendre, ('d',), None),
