...
PARAMS: list[tuple[Callable, Callable, tuple[str, ...], str | None]] = [
    ...
    (special.stirling2_dp, cython_special.stirling2_dp, ('ii',), None),
    (special.stirling2_temme, cython_special.stirling2_temme, ('ii',), None),
    (special.stirling2_inexact, cython_special.stirling2_inexact, ('ii',), None),
