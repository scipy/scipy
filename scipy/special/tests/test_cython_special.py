...
PARAMS = [
    ...
    (special.kolmogp, cython_special.kolmogp, ('d',), None),
    (special.kolmogc, cython_special.kolmogc, ('d',), None),
    (special.kolmogci, cython_special.kolmogci, ('d',), None),
    ...
    (special.smirnovc, cython_special.smirnovc, ('ld', 'dd'), None),
    (special.smirnovci, cython_special.smirnovci, ('ld', 'dd'), None),
