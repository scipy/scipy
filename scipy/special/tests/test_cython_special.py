...
PARAMS: list[tuple[Callable, Callable, tuple[str, ...], str | None]] = [
    ...
    (special.erfinv, cython_special.erfinv, ('f', 'd'), None),
    ...
    (special.mathieu_ce, cython_special._mathieu_ce_pywrap, ('ddd',), None),
    ...
    (special.mathieu_se, cython_special._mathieu_se_pywrap, ('ddd',), None),
