...
def test_cython_api():
    params = [
        ...
        (special.weightfun_chebyc, cython_special.weightfun_chebyc, ('d',), None),
        (special.weightfun_chebys, cython_special.weightfun_chebys, ('d',), None),
        (special.weightfun_chebyt, cython_special.weightfun_chebyt, ('d',), None),
        (special.weightfun_chebyu, cython_special.weightfun_chebyu, ('d',), None),
        (special.weightfun_gegenbauer, cython_special.weightfun_gegenbauer, ('dd',), None),
        (special.weightfun_genlaguerre, cython_special.weightfun_genlaguerre, ('dd',), None),
        (special.weightfun_hermite, cython_special.weightfun_hermite, ('d',), None),
        (special.weightfun_hermitenorm, cython_special.weightfun_hermitenorm, ('d',), None),
        (special.weightfun_jacobi, cython_special.weightfun_jacobi, ('ddd',), None),
        (special.weightfun_laguerre, cython_special.weightfun_laguerre, ('d',), None),
        (special.weightfun_legendre, cython_special.weightfun_legendre, ('d',), None),
        (special.weightfun_sh_chebyt, cython_special.weightfun_sh_chebyt, ('d',), None),
        (special.weightfun_sh_chebyu, cython_special.weightfun_sh_chebyu, ('d',), None),
        (special.weightfun_sh_jacobi, cython_special.weightfun_sh_jacobi, ('ddd',), None),
        (special.weightfun_sh_legendre, cython_special.weightfun_sh_legendre, ('d',), None),
