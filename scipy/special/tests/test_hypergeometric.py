...
class TestHyperu:
    ...
    @pytest.mark.parametrize(
        ...
        [(1e-15, 1.0, 1e-15, 1.0000000000000346),
         (1e-15, 1.0, 4.6415888336127916e-11, 1.0000000000000238),
         (1e-15, 1.0, 2.1544346900318865e-06, 1.000000000000013),
         (1e-15, 1.0, 0.1, 1.0000000000000022),
         (4.6415888336127916e-11, 1.0, 1e-15, 1.000000001603148),
         (4.6415888336127916e-11, 1.0, 4.6415888336127916e-11, 1.0000000011043908),
         (4.6415888336127916e-11, 1.0, 2.1544346900318865e-06, 1.0000000006056338),
         (4.6415888336127916e-11, 1.0, 0.1, 1.0000000001068765),
         (2.1544346900318865e-06, 1.0, 1e-15, 1.0000744116183264),
         (2.1544346900318865e-06, 1.0, 4.6415888336127916e-11, 1.0000512613332657),
         (2.1544346900318865e-06, 1.0, 2.1544346900318865e-06, 1.0000281110482052),
         (2.1544346900318865e-06, 1.0, 0.1, 1.0000049607649177),
         (0.1, 1.0, 1e-15, 4.6048315083246285),
         (0.1, 1.0, 4.6415888336127916e-11, 3.475343054552083),
         (0.1, 1.0, 2.1544346900318865e-06, 2.345854924985846),
         (0.1, 1.0, 0.1, 1.2202292433349389)]
    )
    def test_gh_15650(self, a, b, x, expected):
        ...
        #
        # cases = []
        # for a, x in it.product(np.logspace(-15, -1, 4), repeat=2):
        #     with mp.workdps(100):
        #         cases.append((a, 1.0, x, float(mp.hyperu(a, 1.0, x))))
