...
namespace special {
    ...
    namespace detail {
        ...
        inline std::complex<double> digamma_forward_recurrence(std::complex<double> z, std::complex<double> psiz,
                                                               int n) {
        ...
        inline std::complex<double> digamma_backward_recurrence(std::complex<double> z, std::complex<double> psiz,
                                                                int n) {
