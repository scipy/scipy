...
inline int cem_wrap(double m, double q, double x, double *csf, double *csd);
inline double sem_cva_wrap(double m, double q);
inline int sem_wrap(double m, double q, double x, double *csf, double *csd);

inline std::complex<double> chyp2f1_wrap(double a, double b, double c, std::complex<double> z) {
...
inline std::complex<double> chyp1f1_wrap(double a, double b, std::complex<double> z) {
    std::complex<double> outz;
    std::complex<double> outz99;
...
inline double hypU_wrap(double a, double b, double x) {
    double out;
...
inline double hyp1f1_wrap(double a, double b, double x) {
    double outy;
...
inline int itairy_wrap(double x, double *apt, double *bpt, double *ant, double *bnt) {
    double tmp;
    int flag = 0;
...
inline double exp1_wrap(double x) {
    double out;
...
inline std::complex<double> cexp1_wrap(std::complex<double> z) {
    std::complex<double> outz;
    std::complex<double> z99(z.real(), z.imag());
...
inline double expi_wrap(double x) {
    double out;
...
inline std::complex<double> cexpi_wrap(std::complex<double> z) {
    std::complex<double> outz;
    std::complex<double> z99(z.real(), z.imag());
...
inline std::complex<double> cerf_wrap(std::complex<double> z) {
    std::complex<double> outz;
    std::complex<double> z99(z.real(), z.imag());
...
inline double itstruve0_wrap(double x) {
    double out;
...
inline double it2struve0_wrap(double x) {
    double out;
    int flag = 0;
...
inline double itmodstruve0_wrap(double x) {
    double out;
...
inline double ber_wrap(double x) {
...
inline double bei_wrap(double x) {
    std::complex<double> Be;
    double ber, bei, ger, gei, der, dei, her, hei;
...
inline double ker_wrap(double x) {
...
inline double kei_wrap(double x) {
    std::complex<double> Ke;
    double ber, bei, ger, gei, der, dei, her, hei;
    if (x < 0) {
        return NAN;
...
inline double berp_wrap(double x) {
...
inline double beip_wrap(double x) {
    std::complex<double> Bep;
    double ber, bei, ger, gei, der, dei, her, hei;
    int flag = 0;
...
inline double kerp_wrap(double x) {
...
inline double keip_wrap(double x) {
    std::complex<double> Kep;
    double ber, bei, ger, gei, der, dei, her, hei;
...
inline int kelvin_wrap(double x, std::complex<double> *Be, std::complex<double> *Ke, std::complex<double> *Bep,
                       std::complex<double> *Kep) {
    int flag = 0;
    double ber, bei, ger, gei, der, dei, her, hei;
    if (x < 0) {
...
inline int it1j0y0_wrap(double x, double *j0int, double *y0int) {
    int flag = 0;
...
inline int it2j0y0_wrap(double x, double *j0int, double *y0int) {
    int flag = 0;
...
inline int it1i0k0_wrap(double x, double *i0int, double *k0int) {
    int flag = 0;
...
inline int it2i0k0_wrap(double x, double *i0int, double *k0int) {
    int flag = 0;
...
inline int cfresnl_wrap(std::complex<double> z, std::complex<double> *zfs, std::complex<double> *zfc) {
    std::complex<double> z99(z.real(), z.imag());
...
inline double cem_cva_wrap(double m, double q) {
    int int_m, kd = 1;
    double out;
...
inline int mcm1_wrap(double m, double q, double x, double *f1r, double *d1r) {
    int int_m, kf = 1, kc = 1;
...
inline int msm1_wrap(double m, double q, double x, double *f1r, double *d1r) {
    int int_m, kf = 2, kc = 1;
    double f2r = 0.0, d2r = 0.0;
...
inline int mcm2_wrap(double m, double q, double x, double *f2r, double *d2r) {
    int int_m, kf = 1, kc = 2;
...
inline int msm2_wrap(double m, double q, double x, double *f2r, double *d2r) {
    int int_m, kf = 2, kc = 2;
    double f1r = 0.0, d1r = 0.0;
...
inline double pmv_wrap(double m, double v, double x) {
    int int_m;
    double out;
 ...
 * w2f and -w2d.
 */
inline int pbwa_wrap(double a, double x, double *wf, double *wd) {
    int flag = 0;
...
inline int pbdv_wrap(double v, double x, double *pdf, double *pdd) {
    double *dv;
    double *dp;
    int num;
...
inline int pbvv_wrap(double v, double x, double *pvf, double *pvd) {
    double *vv;
    double *vp;
    int num;
...
inline double prolate_segv_wrap(double m, double n, double c) {
    int kd = 1;
    int int_m, int_n;
    double cv = 0.0, *eg;
...
inline double oblate_segv_wrap(double m, double n, double c) {
    int kd = -1;
    int int_m, int_n;
    double cv = 0.0, *eg;
...
inline int prolate_aswfa_wrap(double m, double n, double c, double cv, double x, double *s1f, double *s1d) {
    int kd = 1;
    int int_m, int_n;
...
inline int oblate_aswfa_wrap(double m, double n, double c, double cv, double x, double *s1f, double *s1d) {
    int kd = -1;
    int int_m, int_n;
...
inline int prolate_radial1_wrap(double m, double n, double c, double cv, double x, double *r1f, double *r1d) {
    int kf = 1;
...
inline int prolate_radial2_wrap(double m, double n, double c, double cv, double x, double *r2f, double *r2d) {
    int kf = 2;
...
inline int oblate_radial1_wrap(double m, double n, double c, double cv, double x, double *r1f, double *r1d) {
    int kf = 1;
    double r2f = 0.0, r2d = 0.0;
    int int_m, int_n;
...
inline int oblate_radial2_wrap(double m, double n, double c, double cv, double x, double *r2f, double *r2d) {
    int kf = 2;
    double r1f = 0.0, r1d = 0.0;
    int int_m, int_n;
...
inline int modified_fresnel_plus_wrap(double x, std::complex<double> *Fplus, std::complex<double> *Kplus) {
    int ks = 0;
...
inline int modified_fresnel_minus_wrap(double x, std::complex<double> *Fminus, std::complex<double> *Kminus) {
    int ks = 1;
    double fr = 0.0, gr = 0.0, fi = 0.0, gi = 0.0, fa = 0.0, ga = 0.0, fm = 0.0, gm = 0.0;
