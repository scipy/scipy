...
namespace detail {
            ...
            if (order <= 2) {
                ...
                if (order >= 4) {
                    ...
                    if (order >= 5) {
                        ...
                        X[5] = x * (x * (x * (x * (x + 10) + 25) + 15) + 1);
                        B[5] = ((((-dg * dg + 10 * pg1) * dg - 10 * pg2) * dg - 15 * pg1 * pg1 + 5 * pg3) * dg +
                                10 * pg1 * pg2 - pg4);
    ...
    SPECFUN_HOST_DEVICE inline double wb_asymptotic(double a, double b, double x) {
        ...
        C[5] *= (1741824 * B[10] - 2903040 * B[9] * (11 * a - 5) + 2177280 * B[8] * (110 * A[2] - 121 * a + 14) -
                 ...
                 2016 * B[4] *
                     (710248 * A[6] - 8878716 * A[5] + 17928834 * A[4] - 3333407 * A[3] - 4339566 * A[2] + 287364 * a +
                      89128) -
                 1344 * B[3] *
                     (87824 * A[7] - 7150220 * A[6] + 29202756 * A[5] - 15113527 * A[4] - 14223011 * A[3] +
                      3462492 * A[2] + 1137092 * a - 18896) -
                 84 * B[2] *
        ...
        C[8] *= (2149908480. * B[16] - 5733089280. * B[15] * (17 * a - 11) +
                 ...
                 266872320 * B[8] *
                     (33133136 * A[8] - 564264544 * A[7] + 2618606424. * A[6] - 4491310104. * A[5] +
                      2853943765. * A[4] - 374694552 * A[3] - 135365288 * A[2] + 17623968 * a + 696912) -
                 2156544 * B[7] *
                 ...
                 13824 * B[5] *
                     (156356794976. * A[11] + 1180898077328. * A[10] - 90615270907936. * A[9] +
                      609258947056248. * A[8] - 1312655191366722. * A[7] + 885900509321745. * A[6] +
                      112162151855265. * A[5] - 212803071513258. * A[4] + 6805217831352. * A[3] +
                      10051742651296. * A[2] - 55035924848. * a - 52946379296.) -
                 576 * B[4] *
                 ...
                 384 * B[3] *
                     (2038525473856. * A[13] + 16057322146112. * A[12] - 502133360559024. * A[11] -
                      ...
                      5117272758337156. * A[4] + 933703210750480. * A[3] + 234855186762000. * A[2] -
    ...
    SPECFUN_HOST_DEVICE inline double wright_bessel_integral(double a, double b, double x) {
        ...
        double eps = (wb_A[0] * b * std::exp(-0.5 * a) +
                      std::exp(wb_A[1] + 1 / (1 + a) * std::log(x) - wb_A[2] * std::exp(-wb_A[3] * a) +
