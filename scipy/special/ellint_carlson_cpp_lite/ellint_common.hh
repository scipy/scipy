...
namespace constants {
    ...
    static constexpr double RF_C1[4] = {0.0, -24024.0, 10010.0, -5775.0};
    ...
    static constexpr double RDJ_C1[4] = {0.0, -875160.0, 417690.0, -255255.0};
...
inline static constexpr bool is_horrible(ExitStatus n) {
    return (
        (n == ExitStatus::no_result) || (n == ExitStatus::bad_args) || (n == ExitStatus::bad_rerr) ||
        (n == ExitStatus::other)
    );
}

inline static constexpr bool is_troublesome(ExitStatus n) { return (!((n == ExitStatus::success) || is_horrible(n))); }
