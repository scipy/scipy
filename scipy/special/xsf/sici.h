...
namespace detail {
    ...
    sici_power_series(int sgn, std::complex<double> z, std::complex<double> *s, std::complex<double> *c) {
...
XSF_HOST_DEVICE inline int sici(std::complex<double> z, std::complex<double> *si, std::complex<double> *ci) {
...
XSF_HOST_DEVICE inline int sici(std::complex<float> z, std::complex<float> *si_f, std::complex<float> *ci_f) {
...
XSF_HOST_DEVICE inline int shichi(std::complex<double> z, std::complex<double> *shi, std::complex<double> *chi) {
...
XSF_HOST_DEVICE inline int shichi(std::complex<float> z, std::complex<float> *shi_f, std::complex<float> *chi_f) {
