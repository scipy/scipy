...
double faddeeva_erfc(double x) { return Faddeeva::erfc(x); }
...
double faddeeva_erfcx(double x) { return Faddeeva::erfcx(x); }
...
double faddeeva_erfi(double x) { return Faddeeva::erfi(x); }
...
double faddeeva_dawsn(double x) { return Faddeeva::Dawson(x); }
