...
if __SCIPY_SETUP__:
    ...
    if (_pep440.parse(__numpy_version__) < _pep440.Version('1.16.5') or
            _pep440.parse(__numpy_version__) >= _pep440.Version('1.21.0')):
        import warnings
        warnings.warn("A NumPy version >=1.16.5 or <1.21.0 is required for this "
