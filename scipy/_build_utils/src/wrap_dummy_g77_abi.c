...
float_complex BLAS_FUNC(cdotc)(CBLAS_INT *n, float_complex *cx,
...
double_complex BLAS_FUNC(zdotc)(CBLAS_INT *n, double_complex *zx,
...
float_complex BLAS_FUNC(cdotu)(CBLAS_INT *n, float_complex *cx,
    CBLAS_INT *incx, float_complex *cy, CBLAS_INT *incy);
...
double_complex BLAS_FUNC(zdotu)(CBLAS_INT *n, double_complex *zx,
    CBLAS_INT *incx, double_complex *zy, CBLAS_INT *incy);
