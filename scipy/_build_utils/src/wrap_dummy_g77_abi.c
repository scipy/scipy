...
float_complex BLAS_FUNC(cdotc)(CBLAS_INT *n, float_complex *cx, CBLAS_INT *incx, float_complex *cy, CBLAS_INT *incy);
float_complex
...
double_complex BLAS_FUNC(zdotc)(CBLAS_INT *n, double_complex *zx, CBLAS_INT *incx, double_complex *zy, CBLAS_INT *incy);
double_complex
...
float_complex BLAS_FUNC(cdotu)(CBLAS_INT *n, float_complex *cx, CBLAS_INT *incx, float_complex *cy, CBLAS_INT *incy);
float_complex
...
double_complex BLAS_FUNC(zdotu)(CBLAS_INT *n, double_complex *zx, CBLAS_INT *incx, double_complex *zy, CBLAS_INT *incy);
double_complex
...
float_complex F_FUNC(wcladiv, WCLADIV)(float_complex *x, float_complex *y) { return BLAS_FUNC(cladiv)(x, y); }

double_complex BLAS_FUNC(zladiv)(double_complex *x, double_complex *y);
double_complex F_FUNC(wzladiv, WZLADIV)(double_complex *x, double_complex *y) { return BLAS_FUNC(zladiv)(x, y); }
