...
float_complex
F_FUNC(wcdotc, WCDOTC)(CBLAS_INT *n, float_complex *cx, CBLAS_INT *incx, float_complex *cy, CBLAS_INT *incy) {
    float_complex ret;
...
double_complex
F_FUNC(wzdotc, WZDOTC)(CBLAS_INT *n, double_complex *zx, CBLAS_INT *incx, double_complex *zy, CBLAS_INT *incy) {
    double_complex ret;
    /* Prototype in npy_cblas_base.h which is included in npy_cblas.h */
...
float_complex
F_FUNC(wcdotu, WCDOTU)(CBLAS_INT *n, float_complex *cx, CBLAS_INT *incx, float_complex *cy, CBLAS_INT *incy) {
    float_complex ret;
    /* Prototype in npy_cblas_base.h which is included in npy_cblas.h */
...
double_complex
F_FUNC(wzdotu, WZDOTU)(CBLAS_INT *n, double_complex *zx, CBLAS_INT *incx, double_complex *zy, CBLAS_INT *incy) {
    double_complex ret;
    /* Prototype in npy_cblas_base.h which is included in npy_cblas.h */
...
float_complex F_FUNC(wcladiv, WCLADIV)(float_complex *x, float_complex *y) {
    ...
    BLAS_FUNC(sladiv)
    ((float *) (x), (float *) (x) + 1, (float *) (y), (float *) (y) + 1, (float *) (&ret), (float *) (&ret) + 1);
    return ret;
}
...
double_complex F_FUNC(wzladiv, WZLADIV)(double_complex *x, double_complex *y) {
    ...
    /* double_complex has the same memory layout as double[2], so we can
       cast and use pointer arithmetic to get the real and imaginary parts */
    BLAS_FUNC(dladiv)
    ((double *) (x), (double *) (x) + 1, (double *) (y), (double *) (y) + 1, (double *) (&ret), (double *) (&ret) + 1);
    return ret;
}

void F_FUNC(cdotcwrp, WCDOTCWRP)(
    float_complex *ret, CBLAS_INT *n, float_complex *cx, CBLAS_INT *incx, float_complex *cy, CBLAS_INT *incy
) {
    *ret = F_FUNC(wcdotc, WCDOTC)(n, cx, incx, cy, incy);
}

void F_FUNC(zdotcwrp, WZDOTCWRP)(
    double_complex *ret, CBLAS_INT *n, double_complex *zx, CBLAS_INT *incx, double_complex *zy, CBLAS_INT *incy
) {
    *ret = F_FUNC(wzdotc, WZDOTC)(n, zx, incx, zy, incy);
}

void F_FUNC(cdotuwrp, CDOTUWRP)(
    float_complex *ret, CBLAS_INT *n, float_complex *cx, CBLAS_INT *incx, float_complex *cy, CBLAS_INT *incy
) {
    *ret = F_FUNC(wcdotu, WCDOTU)(n, cx, incx, cy, incy);
}

void F_FUNC(zdotuwrp, ZDOTUWRP)(
    double_complex *ret, CBLAS_INT *n, double_complex *zx, CBLAS_INT *incx, double_complex *zy, CBLAS_INT *incy
) {
