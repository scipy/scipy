...
__all__ = ['expm','expm2','expm3','cosm','sinm','tanm','coshm','sinhm',
           ...
           'expm_frechet', 'logm_new', 'fractional_matrix_power']
...
#from ._matfuncs_inv_ssq import logm_new, fractional_matrix_power
import warnings
...
def logm_new(A):
    ...
    return scipy.linalg._matfuncs_inv_ssq.logm_new(A)
