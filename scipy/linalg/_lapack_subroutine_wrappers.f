...
c     Do not edit this file directly.
      ...
      subroutine chla_transtypewrp(ret, trans)
        external chla_transtype
        character chla_transtype
        character ret
        integer trans
        ret = chla_transtype(trans)
      end
      ...
      subroutine clanhfwrp(ret, norm, transr, uplo, n, a, work)
        external wclanhf
        real wclanhf
        real ret
        character norm
        ...
        complex a(*)
        real work(*)
        ret = wclanhf(norm, transr, uplo, n, a, work)
      end
      ...
      subroutine dlansfwrp(ret, norm, transr, uplo, n, a, work)
        external dlansf
        ...
        double precision a(*)
        double precision work(*)
        ret = dlansf(norm, transr, uplo, n, a, work)
      end
      ...
      subroutine ilaclcwrp(ret, m, n, a, lda)
        external ilaclc
        integer ilaclc
        integer ret
        integer m
        ...
        complex a(lda,*)
        integer lda
        ret = ilaclc(m, n, a, lda)
      end

      subroutine ilaclrwrp(ret, m, n, a, lda)
        external ilaclr
        integer ilaclr
        integer ret
        integer m
        ...
        complex a(lda,*)
        integer lda
        ret = ilaclr(m, n, a, lda)
      end

      subroutine iladiagwrp(ret, diag)
        external iladiag
        integer iladiag
        integer ret
        character diag
      ...
      subroutine iladlcwrp(ret, m, n, a, lda)
        external iladlc
        integer iladlc
        integer ret
        integer m
        ...
        double precision a(lda,*)
        integer lda
        ret = iladlc(m, n, a, lda)
      end

      subroutine iladlrwrp(ret, m, n, a, lda)
        external iladlr
        integer iladlr
        integer ret
        integer m
        ...
        double precision a(lda,*)
        integer lda
        ret = iladlr(m, n, a, lda)
      end

      subroutine ilaprecwrp(ret, prec)
        external ilaprec
        integer ilaprec
        integer ret
        character prec
      ...
      subroutine ilaslcwrp(ret, m, n, a, lda)
        external ilaslc
        integer ilaslc
        integer ret
        integer m
        ...
        real a(lda,*)
        integer lda
        ret = ilaslc(m, n, a, lda)
      end

      subroutine ilaslrwrp(ret, m, n, a, lda)
        external ilaslr
        integer ilaslr
        integer ret
        integer m
        ...
        real a(lda,*)
        integer lda
        ret = ilaslr(m, n, a, lda)
      end

      subroutine ilatranswrp(ret, trans)
        external ilatrans
        integer ilatrans
        integer ret
        character trans
      ...
      subroutine ilauplowrp(ret, uplo)
        external ilauplo
        integer ilauplo
        integer ret
        character uplo
      ...
      subroutine ilazlcwrp(ret, m, n, a, lda)
        external ilazlc
        integer ilazlc
        integer ret
        integer m
        ...
        complex*16 a(lda,*)
        integer lda
        ret = ilazlc(m, n, a, lda)
      end

      subroutine ilazlrwrp(ret, m, n, a, lda)
        external ilazlr
        integer ilazlr
        integer ret
        integer m
      ...
      subroutine slansfwrp(ret, norm, transr, uplo, n, a, work)
        external wslansf
        real wslansf
        real ret
        character norm
        ...
        real a(*)
        real work(*)
        ret = wslansf(norm, transr, uplo, n, a, work)
      end
      ...
      subroutine zlanhfwrp(ret, norm, transr, uplo, n, a, work)
        external zlanhf
        ...
        complex*16 a(*)
        double precision work(*)
        ret = zlanhf(norm, transr, uplo, n, a, work)
      end
