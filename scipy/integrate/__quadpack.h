...
void DQAGSE(quadpack_f_t f, double *a, double *b, double *epsabs, double *epsrel, INT_TYPE *limit, double *result,
            double *abserr, INT_TYPE *neval, INT_TYPE *ier, double *alist, double *blist, double *rlist, double *elist,
            INT_TYPE *iord, INT_TYPE *last);
void DQAGIE(quadpack_f_t f, double *bound, INT_TYPE *inf, double *epsabs, double *epsrel, INT_TYPE *limit,
            double *result, double *abserr, INT_TYPE *neval, INT_TYPE *ier, double *alist, double *blist,
            double *rlist, double *elist, INT_TYPE *iord, INT_TYPE *last);
void DQAGPE(quadpack_f_t f, double *a, double *b, INT_TYPE *npts2, double *points, double *epsabs,
            double *epsrel, INT_TYPE *limit, double *result, double *abserr, INT_TYPE *neval, INT_TYPE *ier,
            double *alist, double *blist, double *rlist, double *elist, double *pts, INT_TYPE *iord,
            INT_TYPE *level, INT_TYPE *ndin, INT_TYPE *last);
void DQAWOE(quadpack_f_t f, double *a, double *b, double *omega, INT_TYPE *integr, double *epsabs, double *epsrel,
            INT_TYPE *limit, INT_TYPE *icall,  INT_TYPE *maxp1, double *result, double *abserr, INT_TYPE *neval,
            INT_TYPE *ier, INT_TYPE *last, double *alist, double *blist, double *rlist, double *elist,
            INT_TYPE *iord,  INT_TYPE *nnlog, INT_TYPE *momcom, double *chebmo);
void DQAWFE(quadpack_f_t f, double *a, double *omega, INT_TYPE *integr, double *epsabs, INT_TYPE *limlst,
            INT_TYPE *limit, INT_TYPE *maxp1, double *result, double *abserr, INT_TYPE *neval, INT_TYPE *ier,
            double *rslst, double *erlst, INT_TYPE *ierlst, INT_TYPE *lst, double *alist, double *blist,
            double *rlist, double *elist, INT_TYPE *iord, INT_TYPE *nnlog, double *chebmo);
void DQAWSE(quadpack_f_t f, double *a, double *b, double *alfa, double *beta, INT_TYPE *integr, double *epsabs,
            double *epsrel, INT_TYPE *limit, double *result, double *abserr, INT_TYPE *neval, INT_TYPE *ier,
            double *alist, double *blist, double *rlist, double *elist, INT_TYPE *iord, INT_TYPE *last);
void DQAWCE(quadpack_f_t f, double *a, double *b, double *c, double *epsabs, double *epsrel, INT_TYPE *limit,
            double *result, double *abserr, INT_TYPE *neval, INT_TYPE *ier, double *alist, double *blist,
            double *rlist, double *elist, INT_TYPE *iord, INT_TYPE *last);
...
static PyObject *quadpack_qagse(PyObject *dummy, PyObject *args) {
  ...
  INT_TYPE neval=0, ier=6, last=0, *iord;
  double   result=0.0, abserr=0.0;
  double   *alist, *blist, *rlist, *elist;
  int      ret;
  ccallback_t callback;

  if (!PyArg_ParseTuple(args, ("Odd|Oidd" INT_TYPE_PYFMT), &fcn, &a, &b, &extra_args, &full_output, &epsabs, &epsrel, &limit)) return NULL;
  limit_shape[0] = limit;

  /* Need to check that limit is greater than 1 */
  if (limit < 1)
      return Py_BuildValue(("dd" INT_TYPE_PYFMT),result,abserr,ier);
  ...
  ap_iord = (PyArrayObject *)PyArray_SimpleNew(1,limit_shape,INT_TYPE_NPY);
  ...
  if (full_output) {
      return Py_BuildValue(("dd{s:" INT_TYPE_PYFMT ",s:" INT_TYPE_PYFMT ",s:N,s:N,s:N,s:N,s:N}" INT_TYPE_PYFMT), result, abserr, "neval", neval, "last", last, "iord", PyArray_Return(ap_iord), "alist", PyArray_Return(ap_alist), "blist", PyArray_Return(ap_blist), "rlist", PyArray_Return(ap_rlist), "elist", PyArray_Return(ap_elist),ier);
  }
  else {
    Py_DECREF(ap_alist);
    Py_DECREF(ap_blist);
...
static PyObject *quadpack_qagie(PyObject *dummy, PyObject *args) {
  ...
  INT_TYPE inf, neval=0, ier=6, last=0, *iord;
  double   result=0.0, abserr=0.0;
  double   *alist, *blist, *rlist, *elist;
  int ret;
  ccallback_t callback;

  if (!PyArg_ParseTuple(args, ("Od" INT_TYPE_PYFMT "|Oidd" INT_TYPE_PYFMT), &fcn, &bound, &inf, &extra_args,
...
static PyObject *quadpack_qagpe(PyObject *dummy, PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args, ("OddO|Oidd" INT_TYPE_PYFMT), &fcn, &a, &b, &o_points, &extra_args, &full_output, &epsabs, &epsrel, &limit)) return NULL;
  limit_shape[0] = limit;
  ...
  ap_level = (PyArrayObject *)PyArray_SimpleNew(1,limit_shape,INT_TYPE_NPY);
  ap_ndin = (PyArrayObject *)PyArray_SimpleNew(1,npts2_shape,INT_TYPE_NPY);
  ...
  level = (INT_TYPE *)ap_level->data;
  ndin = (INT_TYPE *)ap_ndin->data;
  ...
  if (full_output) {
      return Py_BuildValue(("dd{s:" INT_TYPE_PYFMT ",s:" INT_TYPE_PYFMT ",s:N,s:N,s:N,s:N,s:N,s:N,s:N,s:N}" INT_TYPE_PYFMT), result, abserr, "neval", neval, "last", last, "iord", PyArray_Return(ap_iord), "alist", PyArray_Return(ap_alist), "blist", PyArray_Return(ap_blist), "rlist", PyArray_Return(ap_rlist), "elist", PyArray_Return(ap_elist), "pts", PyArray_Return(ap_pts), "level", PyArray_Return(ap_level), "ndin", PyArray_Return(ap_ndin),ier);
  }
  else {
    Py_DECREF(ap_alist);
    Py_DECREF(ap_blist);
...
static PyObject *quadpack_qawoe(PyObject *dummy, PyObject *args) {
  ...
  int      full_output = 0;
  INT_TYPE maxp1=50, icall=1;
  double   a, b, epsabs=1.49e-8, epsrel=1.49e-8;
  INT_TYPE neval=0, ier=6, integr=1, last=0, momcom=0, *iord;
  INT_TYPE *nnlog;
  ...
  if (!PyArg_ParseTuple(args,
                        ("Oddd" INT_TYPE_PYFMT "|Oidd" INT_TYPE_PYFMT
                         INT_TYPE_PYFMT INT_TYPE_PYFMT INT_TYPE_PYFMT "O"),
  ...
  /* Set up iwork and work arrays */
  ap_iord = (PyArrayObject *)PyArray_SimpleNew(1,limit_shape,INT_TYPE_NPY);
  ap_nnlog = (PyArrayObject *)PyArray_SimpleNew(1,limit_shape,INT_TYPE_NPY);
  ap_alist = (PyArrayObject *)PyArray_SimpleNew(1,limit_shape,NPY_DOUBLE);
  ap_blist = (PyArrayObject *)PyArray_SimpleNew(1,limit_shape,NPY_DOUBLE);
  ap_rlist = (PyArrayObject *)PyArray_SimpleNew(1,limit_shape,NPY_DOUBLE);
  ap_elist = (PyArrayObject *)PyArray_SimpleNew(1,limit_shape,NPY_DOUBLE);
  ...
  if (full_output) {
      return Py_BuildValue(("dd{s:" INT_TYPE_PYFMT ",s:" INT_TYPE_PYFMT ",s:N,s:N,s:N,s:N,s:N,s:N,s:" INT_TYPE_PYFMT ",s:N}" INT_TYPE_PYFMT ""), result, abserr, "neval", neval, "last", last, "iord", PyArray_Return(ap_iord), "alist", PyArray_Return(ap_alist), "blist", PyArray_Return(ap_blist), "rlist", PyArray_Return(ap_rlist), "elist", PyArray_Return(ap_elist), "nnlog", PyArray_Return(ap_nnlog), "momcom", momcom, "chebmo", PyArray_Return(ap_chebmo),ier);
  }
  else {
    Py_DECREF(ap_alist);
    Py_DECREF(ap_blist);
...
static PyObject *quadpack_qawfe(PyObject *dummy, PyObject *args) {
  ...
  INT_TYPE limlst = 50, limit=50;
  npy_intp limlst_shape[1], limit_shape[1], sz[2];
  int      full_output = 0;
  INT_TYPE maxp1=50;
  double   a, epsabs=1.49e-8;
  INT_TYPE neval=0, ier=6, integr=1, *iord;
  INT_TYPE lst, *nnlog, *ierlst;
  ...
  if (!PyArg_ParseTuple(args,
                        ("Odd" INT_TYPE_PYFMT "|Oid" INT_TYPE_PYFMT
                         INT_TYPE_PYFMT INT_TYPE_PYFMT),
  ...
  ap_ierlst = (PyArrayObject *)PyArray_SimpleNew(1,limlst_shape,INT_TYPE_NPY);
  ...
  ierlst = (INT_TYPE *)ap_ierlst->data;
  ...
  if (full_output) {
      return Py_BuildValue(("dd{s:" INT_TYPE_PYFMT ",s:" INT_TYPE_PYFMT ",s:N,s:N,s:N}" INT_TYPE_PYFMT), result, abserr, "neval", neval, "lst", lst, "rslst", PyArray_Return(ap_rslst), "erlst", PyArray_Return(ap_erlst), "ierlst", PyArray_Return(ap_ierlst), ier);
  }
  else {
    Py_DECREF(ap_rslst);
    Py_DECREF(ap_erlst);
...
static PyObject *quadpack_qawce(PyObject *dummy, PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args, ("Oddd|Oidd" INT_TYPE_PYFMT), &fcn, &a, &b, &c, &extra_args, &full_output, &epsabs, &epsrel, &limit)) return NULL;
  limit_shape[0] = limit;
...
static PyObject *quadpack_qawse(PyObject *dummy, PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args, ("Odd(dd)" INT_TYPE_PYFMT "|Oidd" INT_TYPE_PYFMT),
