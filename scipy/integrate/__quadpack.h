...
void DQAGSE(
    quadpack_f_t f, double *a, double *b, double *epsabs, double *epsrel, F_INT *limit, double *result, double *abserr,
    F_INT *neval, F_INT *ier, double *alist, double *blist, double *rlist, double *elist, F_INT *iord, F_INT *last
);
void DQAGIE(
    quadpack_f_t f, double *bound, F_INT *inf, double *epsabs, double *epsrel, F_INT *limit, double *result,
    double *abserr, F_INT *neval, F_INT *ier, double *alist, double *blist, double *rlist, double *elist, F_INT *iord,
    F_INT *last
);
void DQAGPE(
    quadpack_f_t f, double *a, double *b, F_INT *npts2, double *points, double *epsabs, double *epsrel, F_INT *limit,
    double *result, double *abserr, F_INT *neval, F_INT *ier, double *alist, double *blist, double *rlist,
    double *elist, double *pts, F_INT *iord, F_INT *level, F_INT *ndin, F_INT *last
);
void DQAWOE(
    quadpack_f_t f, double *a, double *b, double *omega, F_INT *integr, double *epsabs, double *epsrel, F_INT *limit,
    F_INT *icall, F_INT *maxp1, double *result, double *abserr, F_INT *neval, F_INT *ier, F_INT *last, double *alist,
    double *blist, double *rlist, double *elist, F_INT *iord, F_INT *nnlog, F_INT *momcom, double *chebmo
);
void DQAWFE(
    quadpack_f_t f, double *a, double *omega, F_INT *integr, double *epsabs, F_INT *limlst, F_INT *limit, F_INT *maxp1,
    double *result, double *abserr, F_INT *neval, F_INT *ier, double *rslst, double *erlst, F_INT *ierlst, F_INT *lst,
    double *alist, double *blist, double *rlist, double *elist, F_INT *iord, F_INT *nnlog, double *chebmo
);
void DQAWSE(
    quadpack_f_t f, double *a, double *b, double *alfa, double *beta, F_INT *integr, double *epsabs, double *epsrel,
    F_INT *limit, double *result, double *abserr, F_INT *neval, F_INT *ier, double *alist, double *blist, double *rlist,
    double *elist, F_INT *iord, F_INT *last
);
void DQAWCE(
    quadpack_f_t f, double *a, double *b, double *c, double *epsabs, double *epsrel, F_INT *limit, double *result,
    double *abserr, F_INT *neval, F_INT *ier, double *alist, double *blist, double *rlist, double *elist, F_INT *iord,
    F_INT *last
);

typedef enum { CB_1D_USER = 0, CB_ND_USER = 1, CB_1D = 2, CB_ND = 3 } quadpack_signature_t;
...
static int init_multivariate_data(ccallback_t *callback, int ndim, PyObject *extra_arguments) {
    double *p;
    Py_ssize_t i, size;
...
static int init_callback(ccallback_t *callback, PyObject *func, PyObject *extra_arguments) {
...
static int free_callback(ccallback_t *callback) {
    if (callback->signature && (callback->signature->value == CB_ND || callback->signature->value == CB_ND_USER)) {
...
double quad_thunk(double *x) {
    ...
    if (callback->py_function) {
        ...
        case CB_ND_USER:
            ...
            result = ((double (*)(int, double *, void *)
            ) callback->c_function)((int) callback->info, (double *) callback->info_p, callback->user_data);
            break;
        case CB_ND:
            ((double *) callback->info_p)[0] = *x;
            result =
                ((double (*)(int, double *)) callback->c_function)((int) callback->info, (double *) callback->info_p);
            break;
        default:
            error = 1;
...
static PyObject *quadpack_qagse(PyObject *dummy, PyObject *args) {
    ...
    if (!PyArg_ParseTuple(
            args, ("Odd|Oidd" F_INT_PYFMT), &fcn, &a, &b, &extra_args, &full_output, &epsabs, &epsrel, &limit
        ))
        return NULL;
    limit_shape[0] = limit;
    ...
    if (ap_iord == NULL || ap_alist == NULL || ap_blist == NULL || ap_rlist == NULL || ap_elist == NULL)
        goto fail;
    ...
    DQAGSE(
        quad_thunk, &a, &b, &epsabs, &epsrel, &limit, &result, &abserr, &neval, &ier, alist, blist, rlist, elist, iord,
        &last
    );
    ...
    if (full_output) {
        return Py_BuildValue(
            ("dd{s:" F_INT_PYFMT ",s:" F_INT_PYFMT ",s:N,s:N,s:N,s:N,s:N}" F_INT_PYFMT), result, abserr, "neval", neval,
            "last", last, "iord", PyArray_Return(ap_iord), "alist", PyArray_Return(ap_alist), "blist",
            PyArray_Return(ap_blist), "rlist", PyArray_Return(ap_rlist), "elist", PyArray_Return(ap_elist), ier
        );
    } else {
        Py_DECREF(ap_alist);
        Py_DECREF(ap_blist);
...
static PyObject *quadpack_qagie(PyObject *dummy, PyObject *args) {
    ...
    if (!PyArg_ParseTuple(
            args, ("Od" F_INT_PYFMT "|Oidd" F_INT_PYFMT), &fcn, &bound, &inf, &extra_args, &full_output, &epsabs,
            &epsrel, &limit
        ))
        return NULL;
    limit_shape[0] = limit;
    ...
    DQAGIE(
        quad_thunk, &bound, &inf, &epsabs, &epsrel, &limit, &result, &abserr, &neval, &ier, alist, blist, rlist, elist,
        iord, &last
    );
...
static PyObject *quadpack_qagpe(PyObject *dummy, PyObject *args) {
    ...
    if (!PyArg_ParseTuple(
            args, ("OddO|Oidd" F_INT_PYFMT), &fcn, &a, &b, &o_points, &extra_args, &full_output, &epsabs, &epsrel,
            &limit
        ))
        return NULL;
    limit_shape[0] = limit;
    ...
    if (ap_iord == NULL || ap_alist == NULL || ap_blist == NULL || ap_rlist == NULL || ap_elist == NULL ||
        ap_pts == NULL || ap_level == NULL || ap_ndin == NULL)
        goto fail;
    iord = (F_INT *) PyArray_DATA(ap_iord);
    alist = (double *) PyArray_DATA(ap_alist);
    blist = (double *) PyArray_DATA(ap_blist);
    ...
    DQAGPE(
        quad_thunk, &a, &b, &npts2, points, &epsabs, &epsrel, &limit, &result, &abserr, &neval, &ier, alist, blist,
        rlist, elist, pts, iord, level, ndin, &last
    );
    ...
    if (full_output) {
        return Py_BuildValue(
            ("dd{s:" F_INT_PYFMT ",s:" F_INT_PYFMT ",s:N,s:N,s:N,s:N,s:N,s:N,s:N,s:N}" F_INT_PYFMT), result, abserr,
            "neval", neval, "last", last, "iord", PyArray_Return(ap_iord), "alist", PyArray_Return(ap_alist), "blist",
            PyArray_Return(ap_blist), "rlist", PyArray_Return(ap_rlist), "elist", PyArray_Return(ap_elist), "pts",
            PyArray_Return(ap_pts), "level", PyArray_Return(ap_level), "ndin", PyArray_Return(ap_ndin), ier
        );
    } else {
        Py_DECREF(ap_alist);
        Py_DECREF(ap_blist);
...
static char doc_qawoe[] = "[result,abserr,infodict,ier] = _qawoe(fun, a, b, omega, integr, | args, full_output, "
                          "epsabs, epsrel, limit, maxp1, icall, momcom, chebmo)";
...
static PyObject *quadpack_qawoe(PyObject *dummy, PyObject *args) {
    ...
    if (!PyArg_ParseTuple(
            args, ("Oddd" F_INT_PYFMT "|Oidd" F_INT_PYFMT F_INT_PYFMT F_INT_PYFMT F_INT_PYFMT "O"), &fcn, &a, &b,
            &omega, &integr, &extra_args, &full_output, &epsabs, &epsrel, &limit, &maxp1, &icall, &momcom, &o_chebmo
        ))
        return NULL;
    limit_shape[0] = limit;
    ...
    ap_rlist = (PyArrayObject *) PyArray_SimpleNew(1, limit_shape, NPY_DOUBLE);
    ap_elist = (PyArrayObject *) PyArray_SimpleNew(1, limit_shape, NPY_DOUBLE);
    if (ap_iord == NULL || ap_nnlog == NULL || ap_alist == NULL || ap_blist == NULL || ap_rlist == NULL ||
        ap_elist == NULL)
        goto fail;
    iord = (F_INT *) PyArray_DATA(ap_iord);
    ...
    DQAWOE(
        quad_thunk, &a, &b, &omega, &integr, &epsabs, &epsrel, &limit, &icall, &maxp1, &result, &abserr, &neval, &ier,
    ...
    if (full_output) {
        return Py_BuildValue(
            ("dd{s:" F_INT_PYFMT ",s:" F_INT_PYFMT ",s:N,s:N,s:N,s:N,s:N,s:N,s:" F_INT_PYFMT ",s:N}" F_INT_PYFMT ""),
            result, abserr, "neval", neval, "last", last, "iord", PyArray_Return(ap_iord), "alist",
            PyArray_Return(ap_alist), "blist", PyArray_Return(ap_blist), "rlist", PyArray_Return(ap_rlist), "elist",
            PyArray_Return(ap_elist), "nnlog", PyArray_Return(ap_nnlog), "momcom", momcom, "chebmo",
            PyArray_Return(ap_chebmo), ier
        );
    } else {
        Py_DECREF(ap_alist);
        Py_DECREF(ap_blist);
...
static PyObject *quadpack_qawfe(PyObject *dummy, PyObject *args) {
    ...
    if (!PyArg_ParseTuple(
            args, ("Odd" F_INT_PYFMT "|Oid" F_INT_PYFMT F_INT_PYFMT F_INT_PYFMT), &fcn, &a, &omega, &integr,
            &extra_args, &full_output, &epsabs, &limlst, &limit, &maxp1
        ))
        return NULL;
    limit_shape[0] = limit;
    ...
    if (ap_iord == NULL || ap_nnlog == NULL || ap_alist == NULL || ap_blist == NULL || ap_rlist == NULL ||
        ap_elist == NULL || ap_rslst == NULL || ap_erlst == NULL || ap_ierlst == NULL)
        goto fail;
    iord = (F_INT *) PyArray_DATA(ap_iord);
    nnlog = (F_INT *) PyArray_DATA(ap_nnlog);
    alist = (double *) PyArray_DATA(ap_alist);
    ...
    DQAWFE(
        quad_thunk, &a, &omega, &integr, &epsabs, &limlst, &limit, &maxp1, &result, &abserr, &neval, &ier, rslst, erlst,
        ierlst, &lst, alist, blist, rlist, elist, iord, nnlog, chebmo
    );
    ...
    if (full_output) {
        return Py_BuildValue(
            ("dd{s:" F_INT_PYFMT ",s:" F_INT_PYFMT ",s:N,s:N,s:N}" F_INT_PYFMT), result, abserr, "neval", neval, "lst",
            lst, "rslst", PyArray_Return(ap_rslst), "erlst", PyArray_Return(ap_erlst), "ierlst",
            PyArray_Return(ap_ierlst), ier
        );
    } else {
        Py_DECREF(ap_rslst);
        Py_DECREF(ap_erlst);
...
static PyObject *quadpack_qawce(PyObject *dummy, PyObject *args) {
    ...
    if (!PyArg_ParseTuple(
            args, ("Oddd|Oidd" F_INT_PYFMT), &fcn, &a, &b, &c, &extra_args, &full_output, &epsabs, &epsrel, &limit
        ))
        return NULL;
    limit_shape[0] = limit;
    ...
    DQAWCE(
        quad_thunk, &a, &b, &c, &epsabs, &epsrel, &limit, &result, &abserr, &neval, &ier, alist, blist, rlist, elist,
        iord, &last
    );
...
static char doc_qawse[] = "[result,abserr,infodict,ier] = _qawse(fun, a, b, (alfa, beta), integr, | args, full_output, "
                          "epsabs, epsrel, limit)";
...
static PyObject *quadpack_qawse(PyObject *dummy, PyObject *args) {
    ...
    if (!PyArg_ParseTuple(
            args, ("Odd(dd)" F_INT_PYFMT "|Oidd" F_INT_PYFMT), &fcn, &a, &b, &alfa, &beta, &integr, &extra_args,
    ...
    DQAWSE(
        quad_thunk, &a, &b, &alfa, &beta, &integr, &epsabs, &epsrel, &limit, &result, &abserr, &neval, &ier, alist,
