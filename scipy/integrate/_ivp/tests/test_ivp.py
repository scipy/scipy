...
from scipy.integrate import (solve_ivp, RK23, RK45, DOP853, Verner87,
                             Radau, BDF, LSODA)
...
def test_integration():
    ...
    for vectorized, method, t_span, jac in product(
            [False, True],
            ['RK23', 'RK45', 'DOP853', 'Verner87', 'Radau', 'BDF', 'LSODA'],
            [[5, 9], [5, 1]],
        ...
        if method in ['RK23', 'RK45', 'DOP853', 'Verner87', 'LSODA']:
...
def test_integration_complex():
    ...
    for method, jac in product(['RK23', 'RK45', 'DOP853', 'Verner87', 'BDF'],
...
def test_events():
    ...
    for method in ['RK23', 'RK45', 'DOP853', 'Verner87',
                   'Radau', 'BDF', 'LSODA']:
...
def test_max_step():
    ...
    atol = 1e-6
    y0 = [1/3, 2/9]
    for method in [RK23, RK45, DOP853, Verner87, Radau, BDF, LSODA]:
...
def test_classes():
    y0 = [1 / 3, 2 / 9]
    for cls in [RK23, RK45, DOP853, Verner87, Radau, BDF, LSODA]:
...
@pytest.mark.parametrize('method', ['RK23', 'RK45', 'DOP853', 'Verner87',
                                    'Radau', 'BDF', 'LSODA'])
