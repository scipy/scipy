...
def tplquad(func, a, b, gfun, hfun, qfun, rfun, args=(), epsabs=1.49e-8,
    ...
    That is, :math:`\\int^{x=2}_{x=1} \\int^{y=3}_{y=2} \\int^{z=1}_{z=0} x y z dz dy dx`.
    ...
    Calculate :math:`\\int^{x=1}_{x=0} \\int^{y=1-2x}_{y=0} \\int^{z=1-x-2y}_{z=0} x y z dz dy dx`.
    Note: qfun/rfun takes arguments in the order (x, y), even though f takes arguments in the order (z, y, x).
