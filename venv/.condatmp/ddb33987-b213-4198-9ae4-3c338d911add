...
#define CONFIGURE_ARGS " '--prefix=/workspaces/scipy/venv' '--with-readline' '--with-libraries=/workspaces/scipy/venv/lib' '--with-includes=/workspaces/scipy/venv/include' '--with-openssl' '--with-uuid=e2fs' '--with-libxml' '--with-libxslt' '--with-gssapi' '--with-system-tzdata=/workspaces/scipy/venv/share/zoneinfo' 'PG_SYSROOT=undefined' 'build_alias=x86_64-conda-linux-gnu' 'host_alias=x86_64-conda-linux-gnu' 'CC=x86_64-conda-linux-gnu-cc' 'CFLAGS=-march=nocona -mtune=haswell -ftree-vectorize -fPIC -fstack-protector-strong -fno-plt -O2 -ffunction-sections -pipe -isystem /workspaces/scipy/venv/include -fdebug-prefix-map=/home/conda/feedstock_root/build_artifacts/postgresql-split_1684451506652/work=/usr/local/src/conda/postgresql-split-15.3 -fdebug-prefix-map=/workspaces/scipy/venv=/usr/local/src/conda-prefix' 'LDFLAGS=-Wl,-O2 -Wl,--sort-common -Wl,--as-needed -Wl,-z,relro -Wl,-z,now -Wl,--disable-new-dtags -Wl,--gc-sections -Wl,--allow-shlib-undefined -Wl,-rpath,/workspaces/scipy/venv/lib -Wl,-rpath-link,/workspaces/scipy/venv/lib -L/workspaces/scipy/venv/lib' 'CPPFLAGS=-DNDEBUG -D_FORTIFY_SOURCE=2 -O2 -isystem /workspaces/scipy/venv/include' 'CXX=x86_64-conda-linux-gnu-c++' 'CXXFLAGS=-fvisibility-inlines-hidden -fmessage-length=0 -march=nocona -mtune=haswell -ftree-vectorize -fPIC -fstack-protector-strong -fno-plt -O2 -ffunction-sections -pipe -isystem /workspaces/scipy/venv/include -fdebug-prefix-map=/home/conda/feedstock_root/build_artifacts/postgresql-split_1684451506652/work=/usr/local/src/conda/postgresql-split-15.3 -fdebug-prefix-map=/workspaces/scipy/venv=/usr/local/src/conda-prefix' 'CPP=/home/conda/feedstock_root/build_artifacts/postgresql-split_1684451506652/_build_env/bin/x86_64-conda-linux-gnu-cpp' 'PKG_CONFIG_PATH=/workspaces/scipy/venv/lib/pkgconfig'"
...
#define PACKAGE_STRING "PostgreSQL 15.3"
...
#define PG_VERSION "15.3"

/* PostgreSQL version as a number */
#define PG_VERSION_NUM 150003

/* A string containing the version number, platform, and C compiler */
#define PG_VERSION_STR "PostgreSQL 15.3 on x86_64-conda-linux-gnu, compiled by x86_64-conda-linux-gnu-cc (conda-forge gcc 12.2.0-19) 12.2.0, 64-bit"
