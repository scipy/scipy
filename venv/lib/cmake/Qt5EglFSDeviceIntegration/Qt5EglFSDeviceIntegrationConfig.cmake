...
set(Qt5EglFSDeviceIntegration_VERSION_STRING 5.15.8)
...
if (NOT TARGET Qt5::EglFSDeviceIntegration)
    ...
    set(Qt5EglFSDeviceIntegration_PRIVATE_INCLUDE_DIRS
        "${_qt5EglFSDeviceIntegration_install_prefix}/include/qt/QtEglFSDeviceIntegration/5.15.8"
        "${_qt5EglFSDeviceIntegration_install_prefix}/include/qt/QtEglFSDeviceIntegration/5.15.8/QtEglFSDeviceIntegration"
    )
    ...
    foreach(_module_dep ${_Qt5EglFSDeviceIntegration_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.8 ${_Qt5EglFSDeviceIntegration_FIND_VERSION_EXACT}
    ...
    _populate_EglFSDeviceIntegration_target_properties(RELEASE "libQt5EglFSDeviceIntegration.so.5.15.8" "" FALSE)
