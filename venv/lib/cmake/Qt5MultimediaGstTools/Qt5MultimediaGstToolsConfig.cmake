...
set(Qt5MultimediaGstTools_VERSION_STRING 5.15.8)
...
if (NOT TARGET Qt5::MultimediaGstTools)
    ...
    set(_Qt5MultimediaGstTools_OWN_INCLUDE_DIRS "${_qt5MultimediaGstTools_install_prefix}/include/qt/" "${_qt5MultimediaGstTools_install_prefix}/include/qt/QtMultimediaGstTools")
    set(Qt5MultimediaGstTools_PRIVATE_INCLUDE_DIRS
        "${_qt5MultimediaGstTools_install_prefix}/include/qt/QtMultimediaGstTools/5.15.8"
        "${_qt5MultimediaGstTools_install_prefix}/include/qt/QtMultimediaGstTools/5.15.8/QtMultimediaGstTools"
    )
    ...
    foreach(_module_dep ${_Qt5MultimediaGstTools_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.8 ${_Qt5MultimediaGstTools_FIND_VERSION_EXACT}
    ...
    _populate_MultimediaGstTools_target_properties(RELEASE "libQt5MultimediaGstTools.so.5.15.8" "" FALSE)
...
# Add a versionless target, for compatibility with Qt6.
if(NOT "${QT_NO_CREATE_VERSIONLESS_TARGETS}" AND TARGET Qt5::MultimediaGstTools AND NOT TARGET Qt::MultimediaGstTools)
