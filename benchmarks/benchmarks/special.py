...
class AbsSq(Benchmark):
    ...
    def setup(self):
        ...
        self.z32 = rng.random((500, 500), np.float32) + 1j * rng.random((500, 500), np.float32)
        self.z64 = rng.random((500, 500)) + 1j * rng.random((500, 500))
        self.z128 = self.z64.astype(np.complex128)
