...
class QuadraticAssignment(Benchmark):
    ...
    "chr20a","chr20b","chr20c","chr22a","chr22b","chr25a",
    "els19",
    "esc16a","esc16b","esc16c","esc16d","esc16e","esc16f","esc16g","esc16h",
    "esc16i","esc16j","esc32e","esc32g","esc128",
    "had12","had14","had16","had18","had20",
    "kra30a","kra30b","kra32",
    "lipa20a","lipa20b","lipa30a","lipa30b","lipa40a","lipa40b","lipa50a",
    "lipa50b","lipa60a","lipa60b","lipa70a","lipa70b","lipa80a","lipa90a", "lipa90b",
      ...
      "sko100c", "sko100d", "sko100e", "sko100f",
      "ste36b", "ste36c",
    ...
    def track_score(self,qap_prob):
        ...
        return self.opt_solution, int(np.trace(np.transpose(self.cost_matrix) @ self.dist_matrix[np.ix_(col, col)]))
