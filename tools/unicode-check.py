...
if __name__ == "__main__":
    descr = (
        "Check for disallowed Unicode characters in the SciPy Python and "
        " Cython source code."
    )
    ...
    parser.add_argument(
        "--showall",
        action="store_true",
        help="Show non-ASCII Unicode characters from all files.",
    )
