...
as soon as they are accessed, so that the following is possible:
...
integers) and ``nan_policy`` ('raise', 'omit', or 'propagate') arguments.
...
size zero, are handled consistently. Documentation for all these standard
features is available here (to be linked).
...
an issue if this change turns out problematic for you.
...
* `#354 <https://github.com/scipy/scipy/pull/354>`__: Faster expm
* `#8110 <https://github.com/scipy/scipy/pull/8110>`__: BUG: special.hyp2f1 now allows neg int c value
...
* `#14013 <https://github.com/scipy/scipy/pull/14013>`__: [WIP] MAINT: Update optimize.shgo
* `#14036 <https://github.com/scipy/scipy/pull/14036>`__: ENH: fix numerical issues in roots_jacobi and related special...
* `#14138 <https://github.com/scipy/scipy/pull/14138>`__: DOC: show how to use solve_ivp with one arg
...
* `#15164 <https://github.com/scipy/scipy/pull/15164>`__: remove 'del fft'
...
* `#15346 <https://github.com/scipy/scipy/pull/15346>`__: CI: update CircleCI config for \`master\` to \`main\` branch...
