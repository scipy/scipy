...
Generalized Simulating annealing method has been implemented in the function
`scipy.optimize.gensa`. This method in the generalized version of the
simulating annealing approach. It is efficient and reliable, especially for high
dimension problems with a very large number of optima.
