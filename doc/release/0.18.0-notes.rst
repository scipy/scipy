...
Generalized Simulated annealing method has been implemented in the function
`scipy.optimize.gensa`. This method in the generalized version of the
simulated annealing approach. It is efficient and reliable, especially for high
