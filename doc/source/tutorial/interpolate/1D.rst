...
b-splines (see also the section on :ref:`piecewise polynomials <tutorial-interpolate_ppoly>`
for details on internals of b-splines):
...
.. plot ::
    ...
    >>> u_cord = np.r_[0, u_cord]      # the first point is parametrized at zero
