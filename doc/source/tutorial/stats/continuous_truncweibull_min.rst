...
.. math::
   :nowrap:
    ...
    \begin{eqnarray*}
        ...
        G\left(q;c,a,b\right) & = & \left[-\log\left(\left(1-q\right)\exp\left(-a^{c}\right)+q\exp\left(-b^{c}\right)\right)\right]^{1/c}    \end{eqnarray*}
    \end{eqnarray*}
...
where :math:`\gamma\left(\right)` is lower incomplete gamma function.
