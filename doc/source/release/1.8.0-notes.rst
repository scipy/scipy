...
adaptive step size adjustment in ``basinhopping``.
...
* `#14122 <https://github.com/scipy/scipy/issues/14122>`__: Item assignment for spatial.transform.Rotation objects
...
* `#12146 <https://github.com/scipy/scipy/pull/12146>`__: DOC: add docs to explain behaviour of newton's method on arrays
...
* `#14210 <https://github.com/scipy/scipy/pull/14210>`__: BUG: Fix Nelder-Mead logic when using a non-1D x0 and adaptive
...
* `#14326 <https://github.com/scipy/scipy/pull/14326>`__: MAINT: Removed redefinition of trace1 in spatial/qhull
