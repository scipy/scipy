...
- A new ``method="pchip"`` mode was added to
...
* `#12211 <https://github.com/scipy/scipy/pull/12211>`__: DOC: Dice similarity index
...
* `#16629 <https://github.com/scipy/scipy/pull/16629>`__: DOC: Modify the scipy.stats.mode example to be nontrivial.
