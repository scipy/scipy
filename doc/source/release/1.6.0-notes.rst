...
- `scipy.ndimage` improvements: Fixes and enhancements to boundary extension 
...
* `#5396 <https://github.com/scipy/scipy/issues/5396>`__: scipy.spatial.distance.pdist documentation bug
...
* `#12411 <https://github.com/scipy/scipy/issues/12411>`__: scipy.stats.spearmanr mishandles nan variables with "propagate"
...
* `#12206 <https://github.com/scipy/scipy/pull/12206>`__: MAINT:lstsq: Switch to transposed problem if the array is tall
