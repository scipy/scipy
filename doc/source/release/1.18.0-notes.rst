...
- Added :func:`scipy.integrate.solve_ivp_osc`, a Riccati-based solver for
  oscillatory second-order ODEs with specialized ``omega_fun``/``gamma_fun``
  callbacks and dense output support.
