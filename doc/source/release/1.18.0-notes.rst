...
- Support for MArrays has been added to: `scipy.stats.cramervonmises`,
  `scipy.stats.ks_1samp`, `scipy.stats.ks_2samp`, and `scipy.stats.mode`.
- Array API support has been added to: `scipy.stats.quantile_test` and
  `scipy.stats.kendalltau` (via NumPy conversion).
