...
As per the responsibilities section, a human contributor must be responsible for
any code submitted.
...
Acknowledgements
================
We thank the SymPy developers for their AI policy, upon which this document is largely
based.