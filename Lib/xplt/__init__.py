#
# xplt - Plotting routines based on Gist (requires X server)
#
"""
  ...
  xplt.ghelp('plsys')
    ...
    imagesc   -- Draw a palette-lookup image.
    imagesc_cb -- Draw an image with a colorbar.
    chpal     -- Change the current palette.
    list_palettes -- List the available named palettes.
