        SUBROUTINE UMC2SL (NLU, NPIV, N, LUP, LUI, LUX, X, W)
...
C=======================================================================
C
C       called by subroutine:   UMC2S2
C       subroutines called:     CTRSV, CGEMV
...
C             ----------------------------------------------------------
              ...
              CALL CTRSV ('L', 'N', 'U', LUK,
     $           LUX (LUXP), LUDEGC + LUK, X (K+1), 1)
              DO 20 I = 1, LUDEGC 
                 ROW = LUI (LUCP+I-1)
                 W (I) = X (ROW)
20            CONTINUE 
              CALL CGEMV ('N', LUDEGC, LUK, -ONE,
