        SUBROUTINE UMZ2OF (W, N, RPERM, CPERM, NZOFF,
     $          OFFP, OFFI, OFFX, PR,
...
C       who:            who called (1: UMZ2FA, 2: UMZ2RF)
C
...
C=======================================================================
C
C       called by subroutine:   UMZ2F0, UMZ2RA, UMZ2R0
C       subroutines called:     UMZ2P2
...
C  pr3:     true if printing entries below diagonal blocks (UMZ2RF)
...
C                      This can only occur if who = 2 (UMZ2RF).
                       IF (PR3) THEN 
C                         print the original row and column indices:
                          CALL UMZ2P2 (2, 96, MI (P), COL, MX (P), IO)
                       ENDIF 
                       NBELOW = NBELOW + 1
                    ENDIF 
30               CONTINUE 
