        SUBROUTINE UMC2ER (WHO, ICNTL, INFO, ERROR, S)
...
C                       See UMC2P2 for a description.
...
C=======================================================================
C
C       called by subroutines:  UMC2CO, UMC2FA, UMC2F0, UMC2F1, UMC2F2,
C                               UMC2RF, UMC2R0, UMC2R2, UMC2SO, UMC2S2
C       subroutines called:     UMC2P2
...
C             (out of real memory)
           ...
           ENDIF 
           IF (PRL .GE. 1) THEN 
              CALL UMC2P2 (WHO, ERROR, S, 0, IGNORE, IOERR)
           ENDIF 
