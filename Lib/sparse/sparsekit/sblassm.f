...
c----------------------------------------------------------------------c
       subroutine samub (nrow,ncol,job,a,ja,ia,b,jb,ib,
...
c-----------------------------------------------------------------------
      subroutine saplb (nrow,ncol,job,a,ja,ia,b,jb,ib,
     *     c,jc,ic,nzmax,iw,ierr)
      real*4 a(*), b(*), c(*) 
...
c-----------------------------------------------------------------------
      subroutine saplb1 (nrow,ncol,job,a,ja,ia,b,jb,ib,c,jc,ic,nzmax,
     *                   ierr)
      real*4 a(*), b(*), c(*) 
      integer ja(*),jb(*),jc(*),ia(nrow+1),ib(nrow+1),ic(nrow+1)
c-----------------------------------------------------------------------
...
c----------------------------------------------------------------------- 
      subroutine saplsb (nrow,ncol,a,ja,ia,s,b,jb,ib,c,jc,ic,
     *     nzmax,ierr)
      real*4 a(*), b(*), c(*), s
      integer ja(*),jb(*),jc(*),ia(nrow+1),ib(nrow+1),ic(nrow+1)
c-----------------------------------------------------------------------
...
c-----------------------------------------------------------------------
      subroutine saplsb1 (nrow,ncol,a,ja,ia,s,b,jb,ib,c,jc,ic,
     *     nzmax,ierr)
      real*4 a(*), b(*), c(*), s
      integer ja(*),jb(*),jc(*),ia(nrow+1),ib(nrow+1),ic(nrow+1)
c-----------------------------------------------------------------------
...
c-----------------------------------------------------------------------
      subroutine sapmbt (nrow,ncol,job,a,ja,ia,b,jb,ib,
     *     c,jc,ic,nzmax,iw,ierr)
      real*4 a(*), b(*), c(*) 
...
c-----------------------------------------------------------------------
      subroutine saplsbt(nrow,ncol,a,ja,ia,s,b,jb,ib,
     *     c,jc,ic,nzmax,iw,ierr)
      real*4 a(*), b(*), c(*), s
      integer ja(*),jb(*),jc(*),ia(nrow+1),ib(ncol+1),ic(*),iw(*)
c-----------------------------------------------------------------------
...
c-----------------------------------------------------------------------
      subroutine sdiamua (nrow,job, a, ja, ia, diag, b, jb, ib)
      real*4 a(*), b(*), diag(nrow), scal
...
c----------------------------------------------------------------------- 
      subroutine samudia (nrow,job, a, ja, ia, diag, b, jb, ib)
...
c----------------------------------------------------------------------- 
      subroutine saplsca (nrow, a, ja, ia, scal,iw) 
      real*4 a(*), scal
...
c-----------------------------------------------------------------------
      subroutine sapldia (nrow, job, a, ja, ia, diag, b, jb, ib, iw) 
      real*4 a(*), b(*), diag(nrow) 
