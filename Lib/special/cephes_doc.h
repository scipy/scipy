...
#define mathieu_modcem1_doc "mathieu_modcem1(m,q,x) evaluates the even Matheiu function of the first \nkind, Mc1m(x,q), and its derivative at x for order m and parameter q"
#define mathieu_modcem2_doc "mathieu_modcem2(m,q,x) evaluates the even Matheiu function of the second\nkind, Mc2m(x,q), and its derivative at x for order m and parameter q"
#define mathieu_modsem1_doc "mathieu_modsem1(m,q,x) evaluates the odd Matheiu function of the first \nkind, Ms1m(x,q), and its derivative at x for order m and parameter q"
#define mathieu_modsem2_doc "mathieu_modsem2(m,q,x) evaluates the odd Matheiu function of the second\nkind, Ms2m(x,q), and its derivative at x for order m and parameter q"
