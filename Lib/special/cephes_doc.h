...
#define chdtr_doc "Returns the area under the left hand tail (from 0 to x) of the Chi\nsquare probability density function with v degrees of freedom:\n1/(2**(v/2) * gamma(v/2)) * integral(t**(v/2-1) * exp(-t/2), t=0..x)"
...
#define hyp1f2_doc "hyp1f2 returns the hypergeometric function 1F2 in y and an error\nestimate in err."
#define hyp2f0_doc "hyp2f0 returns the hypergeometric function 2F0 in y and an error\nestimate in err.  The input type determines a convergence factor and\ncan be either 1 or 2."
#define hyp2f1_doc "hyp2f1(a,b,c,x) returns the gauss hypergeometric function\n( 2F1(a,b;c;x) )."
#define hyp3f0_doc "hyp3f0 returns the hypergeometric function 3F0 in y and an error\nestimate in err."
