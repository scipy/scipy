...
#define hyperg_doc "hyperg(a,b,x) returns the confluent hypergeometeric function\n( 1F1(a,b;x) ) evaluated at the values a, b, and x."
...
#define threef0_doc "threef0 returns the hypergeometric function 3F0 in y and an error\nestimate in err."
