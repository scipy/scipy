...
class test_r1array(unittest.TestCase):
    def check_basic(self):
        assert(r1array(3).shape == (1,))
        assert(r1array(3j).shape == (1,))
        assert(r1array(3L).shape == (1,))
        assert(r1array(3.0).shape == (1,))
        assert(r1array([[2,3],[4,5]]).shape == (2,2))
